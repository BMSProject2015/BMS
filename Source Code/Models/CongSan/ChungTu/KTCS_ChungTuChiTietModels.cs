...
{
    public class KTCS_ChungTuChiTietModels
    {
        public static NameValueCollection LayThongTin(String iID_MaChungTuChiTiet)
        {
        ...
        /// <summary>
        /// Thêm dữ liệu vào bảng KTCS_ChungTuChiTiet
        /// </summary>
        ...
        public static void ThemChiTiet(String iID_MaChungTu, String MaND, String IPSua)
        {
            ...
            Bang bang = new Bang("KTCS_ChungTuChiTiet");
        ...
        /// <summary>
        /// Thêm dữ liệu vào bảng KTTM_DuyetChungTu
        /// </summary>
        /// <param name="iID_MaChungTu"></param>
        ...
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTCS_ChungTuChiTiet WHERE iTrangThai=1 AND iID_MaChungTuChiTiet=@iID_MaChungTuChiTiet");
        ...
        public static DataTable Get_dtChungTuChiTietTuChoi(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND)
        {
            ...
            SQL = String.Format("SELECT * FROM KTCS_ChungTuChiTiet WHERE {0} ORDER BY sSoChungTuGhiSo, iSTT, dNgayTao", DK);
            cmd.CommandText = SQL;
        ...
        public static int Get_iID_MaTrangThaiDuyet_TuChoi(String MaND, String iID_MaChungTu)
        {
            ...
            dt.Dispose();
            if (LuongCongViecModel.NguoiDung_DuocSuaChungTu(CongSanModels.iID_MaPhanHe, MaND, iID_MaTrangThaiDuyet))
            {
                int iID_MaTrangThaiDuyet_TuChoi = LuongCongViecModel.Luong_iID_MaTrangThaiDuyet_TuChoi(iID_MaTrangThaiDuyet);
                if (iID_MaTrangThaiDuyet_TuChoi > 0)
                {
                    SqlCommand cmd = new SqlCommand("SELECT Count(*) FROM KTCS_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu AND bDongY=0");
        ...
        /// <summary>
        /// Lấy danh sách dữ liệu từ bảng KTCS_ChungTuChiTiet theo mã chứng từ
        /// </summary>
        /// <param name="iID_MaChungTu"></param>
        /// <returns></returns>
        public static DataTable Get_dtChungTuChiTiet(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND)
        {
            ...
            SQL = String.Format("SELECT * FROM KTCS_ChungTuChiTiet WHERE {0} ORDER BY iSTT, dNgayTao", DK);
            cmd.CommandText = SQL;
        ...
        /// <summary>
        /// Lấy chi tiết một bản ghi trong bảng chi tiết chứng từ
        /// </summary>
        /// <param name="iID_MaChungTuChiTiet"></param>
        /// <returns></returns>
        ...
        {
            DataTable vR = null;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTCS_ChungTuChiTiet WHERE iID_MaChungTuChiTiet=@iID_MaChungTuChiTiet");
            cmd.Parameters.AddWithValue("@iID_MaChungTuChiTiet", iID_MaChungTuChiTiet);
            vR = Connection.GetDataTable(cmd);
            cmd.Dispose();
            return vR;
        ...
        /// <summary>
        /// Lấy danh sách chi tiết chứng từ theo tham số tìm
        /// </summary>
        /// <param name="MaND"></param>
            ...
            String sDonViNo, String sDonViCo, int Trang = 1, int SoBanGhi = 0)
        {
            ...
            String SQL = String.Format("SELECT * FROM KTCS_ChungTuChiTiet WHERE {0}", DK);
            cmd.CommandText = SQL;
        ...
        /// <summary>
        /// Đếm danh sách chứng từ chi tiết theo tham số tìm
        /// </summary>
        /// <param name="MaND"></param>
        /// <param name="SoChungTu"></param>
        /// <param name="iNgayCT"></param>
            ...
            String sDonViNo, String sDonViCo)
        {
            ...
            String SQL = String.Format("SELECT Count(*) FROM KTCS_ChungTuChiTiet WHERE {0}", DK);
            cmd.CommandText = SQL;
        ...
        public static Boolean KiemTraCoDuocCapNhapBang(Bang bang)
        {
            ...
            if (bang.DuLieuMoi)
            {
                if (Convert.ToDouble(bang.CmdParams.Parameters["@rSoTien"].Value) == 0)
                {
