...
{
    public class QLDA_TongDuToan_BangDuLieu : BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public QLDA_TongDuToan_BangDuLieu(String sSoPheDuyet, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            _dtChiTiet = QLDA_TongDuToanModels.Get_dtTongDuToan(_iID_Ma, arrGiaTriTimKiem);
            ThemHangTongCong();
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaTongDuToan"]);
        ...
        {
            String[] arrDSTruong = "sTenDuAn,sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa,sTenLoaiDieuChinh,rSoTienDauTu,rNgoaiTe_DauTu,sTenNgoaiTe_DauTu,rSoTien,rNgoaiTe_SoTien,sTenNgoaiTe_SoTien,rNgoaiTe,sTenNgoaiTe,rTyGia".Split(',');
            String[] arrDSTruongTieuDe = "Thông tin dự án,LNS,L,K,M,TM,TTM,NG,TNG,Nội dung,Loại điều chỉnh,Tổng số tiền đầu tư,Ngoại tệ đầu tư,Loại NT,Số tiền,Trong đó ngoại tệ có,Loại NT,Ngoại tệ,Loại NT,Tỷ giá".Split(',');
            String[] arrDSTruongDoRong = "450,60,30,30,30,30,30,30,30,300,150,150,150,150,150,150,100,150,80,150".Split(',');
        ...
        protected void CapNhap_arrCotDuocPhepNhap()
        {
            ...
            for (int j = 0; j < _arrDSMaCot.Count; j++)
            {
                ...
                if (_ChiDoc == false)
                {
                    if (_arrDSMaCot[j] == "rSoTienDauTu" || _arrDSMaCot[j] == "rNgoaiTe_DauTu" || _arrDSMaCot[j] == "sTenNgoaiTe_DauTu")
                    {
