...
{
    public class QLDA_QuyetToanHoanThanh_BangDuLieu : BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public QLDA_QuyetToanHoanThanh_BangDuLieu(String iID_MaQuyetToanHoanThanh_SoPhieu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._iID_Ma = iID_MaQuyetToanHoanThanh_SoPhieu;
            this._MaND = MaND;
            this._IPSua = IPSua;
            ...
            _dtChiTiet = QLDA_QuyetToanHoanThanhModels.Get_Grid_dtQuyetToanHoanThanh(_iID_Ma, arrGiaTriTimKiem);
            ThemHangTongCong();
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaQuyetToanHoanThanh"]);
        ...
        {
            String[] arrDSTruong = "sTenDuAn,sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa,rSoTienCap,rSoTienQuyetToan,rSoTienChuDauTuDeNghi,rSoTienPheDuyet".Split(',');
            String[] arrDSTruongTieuDe = "Thông tin dự án,LNS,L,K,M,TM,TTM,NG,TNG,Nội dung,Số tiền cấp phát, Số tiền quyết toán,Số tiền chủ đầu tư đề nghị,Số tiền phê duyệt".Split(',');
            String[] arrDSTruongDoRong = "450,60,30,30,30,30,30,30,30,350,200,200,200,200".Split(',');
        ...
        {
            String[] arrDSTruong = "iID_MaDanhMucDuAn,iID_MaMucLucNganSach,sXauNoiMa,sMauSac,sFontColor,sFontBold".Split(',');
            for (int j = 0; j < arrDSTruong.Length; j++)
            {
                _arrDSMaCot.Add(arrDSTruong[j]);
        ...
        protected void CapNhap_arrCotDuocPhepNhap()
        {
            ...
            for (int j = 0; j < _arrDSMaCot.Count; j++)
            {
                ...
                if (_ChiDoc == false)
                {
                    if (_arrDSMaCot[j] == "rSoTienDauTu" || _arrDSMaCot[j] == "rNgoaiTe_DauTu" || _arrDSMaCot[j] == "sTenNgoaiTe_DauTu" || _arrDSMaCot[j] == "rSoTienCap" || _arrDSMaCot[j] == "rSoTienQuyetToan")
                    {
        ...
        {
            String[] arrDSTruongAutocomplete = "sTenDuAn,sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG".Split(',');
