...
{
    public class KeToanTongHop_ChungTuChiTietTuChoi_BangDuLieu: BangDuLieu
    {
        /// /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public KeToanTongHop_ChungTuChiTietTuChoi_BangDuLieu(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._MaND = MaND;
            this._IPSua = IPSua;
            _CoCotDuyet = true;
            _dtChiTiet = KeToanTongHop_ChungTuChiTietModels.Get_dtChungTuChiTietTuChoi(iThang, iNam, arrGiaTriTimKiem, _MaND);
            DienDuLieu();
        }
        ...
        {
            String[] arrDSTruong = "sSoChungTuGhiSo,iNgay,iThang,sSoChungTuChiTiet,sNoiDung,rSoTien,sTenTaiKhoan_Co,sTenTaiKhoanGiaiThich_Co,sTenPhongBan_Co,sTenDonVi_Co,sTenTaiKhoan_No,sTenTaiKhoanGiaiThich_No,sTenPhongBan_No,sTenDonVi_No,sGhiChu".Split(',');
            String[] arrDSTruongTieuDe = "SCT Ghi Sổ,Ngày,Tháng,Số ChTu,Nội dung,Số tiền,Tài khoản có,Chi tiết TK có,B có,Đơn vị có,Tài khoản nợ,Chi tiết TK nợ,B nợ,Đơn vị nợ,Ghi chú".Split(',');
            String[] arrDSTruongDoRong = "80,40,40,60,200,100,200,200,200,200,200,200,200,200,300".Split(',');
        ...
        {
            String strDSTruong = "iSTT,iID_MaChungTu,iID_MaChungTuChiTiet";
