...
namespace VIETTEL.Models
{
    ...
    /// </summary>
    public class DuToan_BangDuLieu : BangDuLieu
    {
        ...
        public DuToan_BangDuLieu(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua, String sLNS, String MaLoai, String iLoai)
        {
            ...
            {
                SQL = "SELECT * FROM DT_ChungTuChiTiet WHERE iID_MaChungTuChiTiet=@iID_MaChungTu AND iTrangThai=1";
                sLNS = "1040100";
            }

            else
            {
                SQL = "SELECT * FROM DT_ChungTu WHERE iID_MaChungTu=@iID_MaChungTu AND iTrangThai=1";
            }
            cmd = new SqlCommand();
            ...
            DienDuLieu(sLNS, MaLoai, iLoai, iKyThuat);
        }
        protected void CapNhapHangTongCong(String iLoai="")
        {
        ...
        /// </summary>
        protected void DienDuLieu(String sLNS, String MaLoai, String iLoai, String iKyThuat)
        {
            ...
            if (_arrDuLieu == null)
            {
                ...
                CapNhapDanhSachMaCot_Slide(sLNS, MaLoai, iLoai, iKyThuat);
                CapNhapDanhSachMaCot_Them(sLNS);
                CapNhap_arrEdit(sLNS,iLoai);
                CapNhap_arrDuLieu(MaLoai);
                CapNhap_arrThayDoi();
        ...
        /// </summary>
        protected void CapNhapDanhSachMaCot_Slide(String sLNS, String MaLoai,String iLoai,String iKyThuat)
        {
            String strDSTruong = "";
        ...
        /// </summary>
        protected void CapNhap_arrDuLieu(String MaLoai)
        {
