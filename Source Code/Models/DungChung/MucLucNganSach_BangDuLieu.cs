...
namespace VIETTEL.Models
{
    public class MucLucNganSach_BangDuLieu:BangDuLieu
    {
        ...
        public MucLucNganSach_BangDuLieu(Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._iID_Ma = "";
            this._MaND = MaND;
            this._IPSua = IPSua;
            ...
            _dtChiTiet = MucLucNganSachModels.Get_dtDanhSachMucLucNganSach(arrGiaTriTimKiem);
