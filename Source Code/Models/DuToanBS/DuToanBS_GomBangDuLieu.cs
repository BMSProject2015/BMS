...
namespace VIETTEL.Models.DuToanBS
{
    ...
    /// </summary>
    public class DuToanBS_GomBangDuLieu : BangDuLieu
    {
        ...
        public DuToanBS_GomBangDuLieu(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua, String sLNS,String MaLoai)
        {
