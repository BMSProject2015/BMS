...
{
    public class TCDN_ChiTieuThuNop_BangDuLieu:BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public TCDN_ChiTieuThuNop_BangDuLieu(String iID_MaDoanhNghiep, String iQuy, String iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            _dtChiTiet = TCDN_ChiTieuThuNopModels.Get_dtChungTuChiTiet(_iID_Ma,iQuy,iNam, arrGiaTriTimKiem);
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaChiTieuTHuNop"]);
        ...
        protected void CapNhapDanhSachMaCot_Fixed()
        {
            ...
            String strDSTruongTienTieuDe = "Kỳ trước chuyển sang,Phải nộp,Đã nộp,Còn nợ cuối kỳ";
            String strDSTruongTien = "rKyTruocChuyenSang,rTrongKyPhaiNop,rTrongKyDaNop,rSoConNoCuoiKy";
            String strDSTruongTienDoRong = "150,150,150,150";
            String strDSTruongTieuDe = "Chỉ tiêu";
            String strDSTruong = "sTen";
            ...
            String[] arrDSNhom_TieuDe = ",Phát sinh trong kỳ,Phát sinh trong kỳ,".Split(',');
            String[] arrDSNhom_SoCot = "1,2,2,1".Split(',');
        ...
        protected void CapNhap_arrEdit()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                for (int j = 0; j < _arrDSMaCot.Count; j++)
                {
                    ...
                    //if (_arrDSMaCot[j] == "rSoConNoCuoiKy" || _arrDSMaCot[j] == "rKyTruocChuyenSang")
                    //{
                    //    okOChiDoc = true;
                    //}
