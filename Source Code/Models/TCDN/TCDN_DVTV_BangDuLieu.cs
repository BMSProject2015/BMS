...
{
    public class TCDN_DVTV_BangDuLieu:BangDuLieu
    {
        private static string dsTruong = "sTenDocLap,sTenPhuThuoc";
        private static string dsTruongTieuDe = "Tên đơn vị thành viên độc lập,Tên đơn vị thành viên phụ thuộc";
        private static string dsTruongDoRong = "200,200";
        ...
        // Hàm khởi tạo
        public TCDN_DVTV_BangDuLieu(string iID_MaDoanhNghiep)
        {
            ...
            _dtChiTiet = TCDN_HoSo_DoanhNghepModels.GetDonViThanhVien(iID_MaDoanhNghiep);
       ...
       /// </summary>
        ...
        private void CapNhapDanhSachMaHang()
        {
            ...
            {
                DataRow R = _dtChiTiet.Rows[i];
                String MaHang = Convert.ToString(R["iID_MaDV"]);
