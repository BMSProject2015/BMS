...
{
    public class CapThu_BangDuLieu : BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public CapThu_BangDuLieu(String iID_MaChungTu_Duyet, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            _dtChiTiet = CapThuModels.Get_Grid_dtChungTu_ChiTiet_Duyet(_iID_Ma, arrGiaTriTimKiem);
            ThemHangTongCong();
        ...
        {
            String[] arrDSTruong = "bRutDuToan,bLoai,sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa,iNgay,iThang,sTenPhongBan,sTenDonVi,sTinhChatCapThu,rSoTien,rSoTienDuyet,sNoiDung".Split(',');
            String[] arrDSTruongTieuDe = "<input type=\"checkbox\" id=\"checkAll\" onclick=\"ChonRDT(this.checked)\">&nbsp;Rút dự toán,<input type=\"checkbox\" id=\"checkAll\" onclick=\"ChonUNC(this.checked)\">&nbsp;Thu,LNS,L,K,M,TM,TTM,NG,TNG,Nội dung,Ngày,Tháng,Phòng ban,Đơn vị,Tính chất,Số tiền,Số tiền duyệt,Nội dung".Split(',');
            String[] arrDSTruongDoRong = "90,40,60,30,30,30,30,30,30,30,350,50,50,150,150,200,150,150,350".Split(',');
