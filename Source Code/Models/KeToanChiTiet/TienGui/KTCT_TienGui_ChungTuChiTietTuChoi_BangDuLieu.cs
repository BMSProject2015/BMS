...
{
    public class KTCT_TienGui_ChungTuChiTietTuChoi_BangDuLieu : BangDuLieu
    {
        /// /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public KTCT_TienGui_ChungTuChiTietTuChoi_BangDuLieu(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._MaND = MaND;
            this._IPSua = IPSua;
            _CoCotDuyet = true;
            _dtChiTiet = KTCT_TienGui_ChungTuChiTietModels.Get_dtChungTuChiTietTuChoi(iThang, iNam, arrGiaTriTimKiem, _MaND);
            DienDuLieu();
        }
        ...
        {
            String[] arrDSTruong = "iDot,iNgay,iThang,sSoChungTuChiTiet,sTenNhanVien_ThuChi,sNoiDung,rSoTien,sTenDonVi_Co,sTenDonVi_Nhan,sTenDonVi_No,sTenTaiKhoan_No,sTenTaiKhoan_Co".Split(',');
            String[] arrDSTruongTieuDe = "Đợt,Ngày,Tháng,Số UNC,Người nhận,Nội dung thanh toán / chuyển tiền,Số tiền,ĐV Có/Tên đơn vị trả tiền,ĐV Nhận Tiền/Tên đơn vị nhận UNC,ĐV Nợ/Tên đơn vị nhận nợ,Tài khoản nợ,Tài khoản có".Split(',');
            String[] arrDSTruongDoRong = "40,40,40,60,150,450,150,200,200,200,250,250".Split(',');
