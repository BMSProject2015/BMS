...
namespace VIETTEL.Models
{
    ...
    /// </summary>
    public class QuyetToan_GiaiThichBangLoi_BangDuLieu : BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public QuyetToan_GiaiThichBangLoi_BangDuLieu(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            _dtChiTiet = QuyetToan_ChungTuChiTietModels.Get_dtGiaiThichBangLoi(iID_MaChungTu);
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaGiaiThichBangLoi"]);
        ...
        {
            String strDSTruongTien = "sGiaiThich,sKienNghi";
            String strDSTruongTienTieuDe = "Tình hình bảo hiểm,Kiến nghị";
            String strDSTruongTienDoRong = "400,400";
