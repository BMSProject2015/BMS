...
namespace VIETTEL.Models.CapPhat
{
    public class CapPhat_ReportModels
    {
       ...
       /// <returns></returns>
        ...
        public static DataTable LayDtLoaiThongTri_LNS(String iNamCapPhat, String sMaND,
                                                  String LoaiThongTri, String iID_MaPhongBan)
        {
            ...
            DKPhongBan = ThuNopModels.DKPhongBan_QuyetToan(sMaND, cmd);
        ...
        public static DataTable LayDtLNS_DonVi(String iNamCapPhat, String LoaiThongTri, String MaND,
