...
<body>
    <%
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptTongHopChiTieu", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, DotPhanBo = iID_MaDotPhanBo, TruongTien = TruongTien });
        using (Html.BeginForm("EditSubmit", "rptTongHopChiTieu", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">                           
                            <tr>
                                ...
                                <td width="10%" >                                                               
                                     ...
                                     <%rptTongHopChiTieuController rptTH= new rptTongHopChiTieuController(); %>
...
<td>
     ...
     <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptTongHopChiTieu", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, DotPhanBo = iID_MaDotPhanBo, TruongTien = TruongTien }), "Xuất ra Excel")%>
    ...
    <script type="text/javascript">
        function ChonNLV() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDotPhanBo?ParentID=#0&iID_MaTrangThaiDuyet=#1&sLNS=#2&iID_MaDotPhanBo=#3&MaND=#4", "rptTongHopChiTieu") %>');
