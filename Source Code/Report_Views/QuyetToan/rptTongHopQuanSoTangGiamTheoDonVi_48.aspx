...
<body>
    ...
    String urlReport = "";
    if (pageload == "1")
        urlReport = Url.Action("ViewPDF", "rptTongHopQuanSoTangGiamTheoDonVi_48", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet });
    dtThang.Dispose();
    String URL = Url.Action("Index", "QuyetToan_QuanSo_Report");
    using (Html.BeginForm("EditSubmit", "rptTongHopQuanSoTangGiamTheoDonVi_48", new { ParentID = ParentID }))
    {
    %>   
     <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo quân số tăng giảm theo đơn vị</span>
                    </td>
                </tr>
            </table>
        </div>        
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptTongHopQuanSoTangGiamTheoDonVi_48", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "ExportToExcel")%>
