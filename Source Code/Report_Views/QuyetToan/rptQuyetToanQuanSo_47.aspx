...
<body>
    ...
    dtTrangThai.Dispose();      
    // Đơn Vị
    DataTable dtDonVi = rptQuyetToanQuanSo_47Controller.GetDonvi(iThang, iID_MaTrangThaiDuyet,MaND);    
    ...
    String urlReport = "";
    if (pageload == "1")
        urlReport = Url.Action("ViewPDF", "rptQuyetToanQuanSo_47", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iAll = iAll, iMaDV = iID_MaDonVi });
    dtThang.Dispose();
    String URL = Url.Action("Index", "QuyetToan_QuanSo_Report");
    using (Html.BeginForm("EditSubmit", "rptQuyetToanQuanSo_47", new { ParentID = ParentID }))
    {
    %>   
     <div class="box_tong">
                        ...
                        <div style="float:left; width:300px;">
                            ...
                            <div class="div-label" style="width:150px; text-align:center;float:left;">                    
                                <p class="p" id="<%=ParentID %>_divDonvi">                                   
                                    <%rptQuyetToanQuanSo_47Controller rpt = new rptQuyetToanQuanSo_47Controller();%>
    ...
    <script type="text/javascript">
        ...
        function ChonDonvi() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDonvi?ParentID=#0&iThang=#1&iID_MaTrangThaiDuyet=#2&iMaDV=#3", "rptQuyetToanQuanSo_47") %>');
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToanQuanSo_47", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iAll = iAll, iMaDV = iID_MaDonVi }), "ExportToExcel")%>
