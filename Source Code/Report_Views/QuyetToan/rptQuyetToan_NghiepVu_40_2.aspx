...
<body>
    <%        
        ...
        {
            urlReport = Url.Action("ViewPDF", "rptQuyetToan_NghiepVu_40_2", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, Thang_Quy = Thang_Quy, TruongTien = TruongTien, RutGon = RutGon, KhoGiay = KhoGiay,MaND=MaND,ToSo=ToSo });
        }
        String ToDaXem = "";
        ToDaXem = Convert.ToString(Request.QueryString["ToDaXem"]);
        ToDaXem += ToSo + ",";
        if (ToDaXem == ",") ToDaXem = "";
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_nghiepvu_40_2", new { ParentID = ParentID,ToDaXem=ToDaXem }))
        {
        %>
        <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                     <td width="47.9%">
                        <span>Báo cáo tổng hợp quyết toán quý theo đơn vị</span>
                    </td>
            ...
            <div id="rptMain">
                <div id="Div2">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    	<tr>
                    		<td style="width: 50%;"><div id="<%=ParentID %>_divDonVi">
                                 <% rptQuyetToan_NghiepVu_40_2Controller rpt = new rptQuyetToan_NghiepVu_40_2Controller(); %>
                    ...
                    <td class="style1">&nbsp;</td>
                         <td colspan="2">
                            <table cellpadding="0" cellspacing="0" border="0" align="left" style="margin-left: 200px;margin-top:10px;margin-bottom:10px;" width="100%">
                                <tr>
    ...
    <script type="text/javascript">
        function ChoniThang() {
            ...
            var url = unescape('<%= Url.Action("DS_To?ParentID=#0&iID_MaTrangThaiDuyet=#1&Thang_Quy=#2&RutGon=#3&MaND=#4&KhoGiay=#5&ToSo=#6&sLNS=#7&TruongTien=#8", "rptQuyetToan_NghiepVu_40_2") %>');
        ...
        <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_NghiepVu_40_2", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, Thang_Quy = Thang_Quy, TruongTien = TruongTien, RutGon = RutGon, KhoGiay = KhoGiay, MaND = MaND, ToSo = ToSo }), "Xuất ra Excels")%>
