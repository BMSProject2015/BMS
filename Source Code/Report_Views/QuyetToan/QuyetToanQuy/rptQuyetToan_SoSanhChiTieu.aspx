...
<body>
    <%
        ...
        if (PageLoad == "1")
        {
            ...
            {
                arrView[i] =
                    String.Format(@"/rptQuyetToan_Sosanhchitieu/viewpdf?sLNS={0}&iThang_Quy={1}&iID_MaDonVi={2}&MaND={3}&iID_MaPhongBan={4}",
        ...
        String urlExport = Url.Action("ExportToExcel", "rptQuyetToan_Sosanhchitieu", new { });
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_Sosanhchitieu", new { ParentID = ParentID,MaND = MaND }))
        {
    %>
    <div class="box_tong">
...
for (int i = 0; i < dtLNS.Rows.Count; i = i + SoCot)
{
                    ...
                    <tr>
                        ...
                        <td style="width: 10%">
                            <div id="<%= ParentID %>_tdDonVi">
                                <%rptQuyetToan_SosanhchitieuController rpt = new rptQuyetToan_SosanhchitieuController();%>
        ...
        <script type="text/javascript">
            ...
            function Chon() {
                ...
                var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&Thang_Quy=#1&iID_MaDonVi=#2&iID_MaPhongBan=#3&MaND=#4", "rptQuyetToan_Sosanhchitieu") %>');
