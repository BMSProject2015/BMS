...
<body>
      <%
        ...
        {
            urlReport = Url.Action("ViewPDF", "rptQuyetToanNghiepVu_5b_TongHop", new { Thang_Quy = Thang_Quy, sLNS = sLNS, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, MaND = MaND });
        }
        String urlExport = Url.Action("ExportToExcel", "rptQuyetToanNghiepVu_5b_TongHop", new { Thang_Quy = Thang_Quy, sLNS = sLNS, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, MaND = MaND });
        using (Html.BeginForm("EditSubmit", "rptQuyetToanNghiepVu_5b_TongHop", new { ParentID = ParentID}))
        {
    %>
    ...
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo Quyết toán thông tri 5b tổng hợp</span>
                    </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 93px">
  <tr>
  <td width="1%"></td>
    <td rowspan="18" width="5%" align="right"><b>LNS : </b> </td>
     <td style="width: 25%;" rowspan="18">
    ...
    <td class="style2" width="7%">
                                <%=MyHtmlHelper.DropDownList(ParentID, slThang, Thang_Quy, "iThangQuy", "", "class=\"input1_2\" style=\"width:100%;\"onchange=Chon() ")%>
    
     </td>    
    <td rowspan="18" width="5%" align="right" valign="top"><b>Đơn vị :</b> </td>
    <td rowspan="18" width="43%" valign="top">
        <div id="<%= ParentID %>_tdDonVi" style="height:300px; overflow:scroll;" >
  ...
  <tr>
  <td></td>
    <td align="right" class="style4"><b> </b></td>
    <td class="style2" > &nbsp;
    ...
    <td colspan="6" align="center">  <table cellpadding="0" cellspacing="0" border="0" align="center">
      ...
      <script type="text/javascript">
          ...
          function Chon() {
              ...
              var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&Thang_Quy=#1&sLNS=#2&iID_MaDonVi=#3&iID_MaTrangThaiDuyet=#4", "rptQuyetToanNghiepVu_5b_TongHop") %>');
