...
<body>
    <%        
        ...
        {
            urlReport = Url.Action("ViewPDF", "rptQuyetToan_NghiepVu_40_3", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, Thang_Quy = Thang_Quy, TruongTien = TruongTien, RutGon = RutGon, KhoGiay = KhoGiay,MaND=MaND,ToSo=ToSo });
        } 
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_nghiepvu_40_3", new { ParentID = ParentID,ToDaXem=ToDaXem }))
        {
        %>
        <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo tổng hợp quyết toán quý theo nhóm đơn vị</span>
                    </td>
            ...
            <div id="rptMain">
                <div id="Div2">
                    ...
                    <% rptQuyetToan_NghiepVu_40_3Controller rpt = new rptQuyetToan_NghiepVu_40_3Controller(); %>
    ...
    <script type="text/javascript">
        function ChoniThang() {
            ...
            var url = unescape('<%= Url.Action("DS_To?ParentID=#0&iID_MaTrangThaiDuyet=#1&Thang_Quy=#2&RutGon=#3&MaND=#4&KhoGiay=#5&ToSo=#6&sLNS=#7&TruongTien=#8", "rptQuyetToan_NghiepVu_40_3") %>');
        ...
        <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_NghiepVu_40_3", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, Thang_Quy = Thang_Quy, TruongTien = TruongTien, RutGon = RutGon, KhoGiay = KhoGiay, MaND = MaND, ToSo = ToSo }), "Xuất ra Excels")%>
