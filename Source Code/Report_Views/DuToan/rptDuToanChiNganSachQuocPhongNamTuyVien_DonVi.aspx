...
<%  
    ...
    SelectOptionList slNam = new SelectOptionList(dtNam, "MaNam", "TenNam");
     ...
     DataTable dtNguonDonVi = rptDuToanChiNganSachQuocPhongNamTuyVien_DonViController.DanhSachDonVi(MaND,iID_MaTrangThaiDuyet);
    ...
    using (Html.BeginForm("EditSubmit", "rptDuToanChiNganSachQuocPhongNamTuyVien_DonVi", new { ParentID = ParentID, MaND = MaND, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo dự toán chi ngân sách quốc phòng năm tùy viên theo đơn vị
                        </span>
                    </td>
                </tr>
            </table>
                     ...
                     <tr>
                        ...
                        <td style="width: 15%;">
                            <div id="<%=ParentID %>_divDonVi">
                                     <%rptDuToanChiNganSachQuocPhongNamTuyVien_DonViController rptTB1 = new rptDuToanChiNganSachQuocPhongNamTuyVien_DonViController();%>                                    
...
<td>
 ...
 <script type="text/javascript">
  ...
  <script type="text/javascript">
      function ChonNamLamViec() {
          ...
          var url = unescape('<%= Url.Action("Get_dsDonVi?ParentID=#0&MaND=#1&iID_MaDonVi=#2&iID_MaTrangThaiDuyet=#3", "rptDuToanChiNganSachQuocPhongNamTuyVien_DonVi") %>');
 ...
 <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToanChiNganSachQuocPhongNamTuyVien_DonVi", new { MaND = MaND, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "Xuất ra file Excel")%>
   <iframe src="<%=Url.Action("ViewPDF","rptDuToanChiNganSachQuocPhongNamTuyVien_DonVi",new{MaND=MaND,iID_MaDonVi=iID_MaDonVi,iID_MaTrangThaiDuyet=iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
</body>
</html>
