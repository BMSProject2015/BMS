...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtPhongBan(MaND, "1050100");
         ...
         if (PageLoad == "1")
         {
                 arrView[0] =
                     String.Format(
                         @"/rptDuToan_1050100_TongHop/viewpdf?iID_MaPhongBan={0}&MaND={1}",
                         iID_MaPhongBan, MaND);
                 Chuoi += arrView[0];
         }
         String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai = "0" });
         using (Html.BeginForm("EditSubmit", "rptDuToan_1050100_TongHop", new {ParentID=ParentID}))
        {
    %>
