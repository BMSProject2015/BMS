...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtDonVi(MaND, "2");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_2_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}",
                         arrMaDonVi[i], MaND);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_2_TungDonVi", new {ParentID=ParentID}))
        {
    %>
