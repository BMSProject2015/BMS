...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_109_TongHop_2", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan });
    }  
    ...
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_109_TongHop_2", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
