...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_1020000_00_TongHop", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan });
    }  
    String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai="0"});
    DataTable dtPhongBan = DuToan_ReportModels.getDSPhongBan(iNamLamViec, MaND,"1020000");
    SelectOptionList slPhongBan = new SelectOptionList(dtPhongBan, "iID_MaPhongBan", "sTenPhongBan");
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_1020000_00_TongHop", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo Dự toán chi NSQP năm <%=iNamLamViec %> (Phần nghiệp vụ chung)</span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_1020000_00_TongHop", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan }), "Export to Excel")%>
