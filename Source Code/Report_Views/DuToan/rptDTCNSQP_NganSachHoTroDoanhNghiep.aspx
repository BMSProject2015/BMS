...
<body>
   ...
   String MaND=User.Identity.Name;
    ...
    using (Html.BeginForm("EditSubmit", "rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonVi", new { ParentID = ParentID,MaND=MaND, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }))
    {
    %>   
    <div class="box_tong">
                    ...
                    <tr>
                        ...
                        <td style="width: 15%;">
                            <div id="<%=ParentID %>_divDonVi">
                                     <%rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonViController rptTB1 = new rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonViController();%>                                    
...
<td>
 ...
 <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonVi", new { MaND = MaND, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "Xuất ra Excel")%>
   <iframe src="<%=Url.Action("ViewPDF","rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonVi",new{MaND=MaND,iID_MaDonVi=iID_MaDonVi,iID_MaTrangThaiDuyet=iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
</body>
</html>
