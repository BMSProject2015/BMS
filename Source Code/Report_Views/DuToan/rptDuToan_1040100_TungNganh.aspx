...
<body>
    ...
    %>
    <div>
        <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_1040100_TungNganh", new { MaND = MaND, Nganh = Nganh, ToSo = MaTo, iID_MaPhongBan = iID_MaPhongBan, sLNS = sLNS }), "Xuất ra Excels")%>
    </div>
</body>
</html>
