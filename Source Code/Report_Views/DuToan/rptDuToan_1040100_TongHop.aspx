...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_1040100_TongHop", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan });
    }  
    ...
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_1040100_TongHop", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_1040100_TongHop", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan }), "Export to Excel")%>
