...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtNganh(MaND,"2");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_2_Nganh_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}",
                         arrMaDonVi[i], MaND);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_2_Nganh_TungDonVi", new {ParentID=ParentID}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách nhà nước giao (phụ lục số 5a) năm <%=iNamLamViec %>
                           </span>
                    </td>
