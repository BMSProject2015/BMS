...
<body>
  <%
    ...
    DataTable dtTrangThai = rptDTCNSNhaNuoc_PhanChiNguoiCoCongController.tbTrangThai();
    ...
    DataTable dtNguonDonVi = rptDTCNSNhaNuoc_PhanChiNguoiCoCongController.HienThiDonViTheoNam(MaND, iID_MaTrangThaiDuyet);
    ...
    using (Html.BeginForm("EditSubmit", "rptDTCNSNhaNuoc_PhanChiNguoiCoCong", new { ParentID = ParentID}))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo DTCNS nhà nước phần chi người có công</span>
                    </td>
                </tr>
            </table>
        </div>
                       ...
                       <tr>
                        ...
                        <td style="width: 15%;">
                             <div id="<%=ParentID %>_divDonVi">
                                     <%rptDTCNSNhaNuoc_PhanChiNguoiCoCongController rptTB1 = new rptDTCNSNhaNuoc_PhanChiNguoiCoCongController();%>                                    
...
<td>
    ...
    <%} %> 
      ...
      <script type="text/javascript">
          function ChonNamLamViec() {
              ...
              var url = unescape('<%= Url.Action("Get_dsDonVi?ParentID=#0&MaND=#1&iID_MaDonVi=#2&iID_MaTrangThaiDuyet=#3", "rptDTCNSNhaNuoc_PhanChiNguoiCoCong") %>');
 ...
 <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDTCNSNhaNuoc_PhanChiNguoiCoCong", new { MaND = MaND, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "Xuất ra Excel")%>
   <iframe src="<%=Url.Action("ViewPDF","rptDTCNSNhaNuoc_PhanChiNguoiCoCong",new{MaND=MaND,iID_MaDonVi=iID_MaDonVi,iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
</body>
</html>
