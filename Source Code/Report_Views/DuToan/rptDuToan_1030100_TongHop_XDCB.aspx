...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_1030100_TongHop_XDCB", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan });
    }  
    ...
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_1030100_TongHop_XDCB", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo Dự toán chi ngân sách Quốc phòng ( phần ngân sách xây dựng cơ bản) năm <%=iNamLamViec %></span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_1030100_TongHop_XDCB", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan }), "Export to Excel")%>
