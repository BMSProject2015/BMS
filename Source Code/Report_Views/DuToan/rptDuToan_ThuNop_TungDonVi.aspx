...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtDonVi(MaND,"8");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_ThuNop_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}",
                         arrMaDonVi[i], MaND);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_ThuNop_TungDonVi", new {ParentID=ParentID}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán ngân sách năm <%=iNamLamViec %>- phần thu
                           </span>
                    </td>
