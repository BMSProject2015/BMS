...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_2_TongHop", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan });
    }  
    ...
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_2_TongHop", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo tổng hợp dự toán ngân sách nhà nước giao năm <%=iNamLamViec %></span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_2_TongHop", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan }), "Export to Excel")%>
