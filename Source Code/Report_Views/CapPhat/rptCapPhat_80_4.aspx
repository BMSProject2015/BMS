...
<body>
    <%         
        ...
        DataTable dtLoaiBaoCao = rptCapPhat_80_4Controller.DanhSach_LoaiBaoCao();
        ...
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptCapPhat_80_4", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iID_MaDonVi = iID_MaDonVi, dNgayCapPhat = dNgayCapPhat, LoaiBaoCao = LoaiBaoCao,LuyKe=LuyKe });
        using (Html.BeginForm("EditSubmit", "rptCapPhat_80_4", new { ParentID = ParentID}))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo tổng hợp chỉ tiêu -cấp- QT(MLNS)</span>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                    ...
                    <td width="10%"></td>
                        ...
                        <td id="<%= ParentID %>_tdNgayCapPhat" width="10%">
                            <%rptCapPhat_80_4Controller rptTB1 = new rptCapPhat_80_4Controller();
                              rptCapPhat_80_4Controller.NLVData _NLVData = new rptCapPhat_80_4Controller.NLVData();
                        ...
                        <td class="td_form2_td1" style="width: 8%;">
                            <div>
                                <%=NgonNgu.LayXau("Loại báo cáo:")%></div>
                        </td>
                        <td width="10%">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slLoaiBaoCao, LoaiBaoCao, "MaLoai", "", "class=\"input1_2\" style=\"width: 100%\"")%>
                            </div>
                        </td>
                        <td></td>
                    </tr>
    ...
    <script type="text/javascript">
        function ChonNLV(iID_MaTrangThaiDuyet) {
            ...
            var url = unescape('<%= Url.Action("ds_NgayCapPhat?ParentID=#0&iID_MaTrangThaiDuyet=#1&iID_MaDonVi=#2&dNgayCapPhat=#3&LuyKe=#4", "rptCapPhat_80_4") %>');
    ...
    <%} %>
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptCapPhat_80_4", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, dNgayCapPhat = dNgayCapPhat, iID_MaDonVi = iID_MaDonVi, LoaiBaoCao = LoaiBaoCao }), "Xuất ra Excel")%> 
