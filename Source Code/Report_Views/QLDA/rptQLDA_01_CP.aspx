...
<body>
    <%   
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptQLDA_01_CP", new {iID_MaDotCapPhat = iID_MaDotCapPhat,MaND=MaND,MaTien=MaTien});
        String URL = Url.Action("Index", "QLDA_Report");
        using (Html.BeginForm("EditSubmit", "rptQLDA_01_CP", new { ParentID = ParentID }))
        {
    %>
         ...
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo danh mục công trình cấp phát</span>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="100%" cellpadding="0"  cellspacing="0" border="0" class="table_form2">                
                        ...
                        <td width="30%"></td>
                         <td style="width: 10%;" class="td_form2_td1">
                            <div><%=NgonNgu.LayXau("Đợt cấp phát:")%></div>                        </td>
                        <td width="10%">
                              <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slDotCapPhat, iID_MaDotCapPhat, "iID_MaDotCapPhat", "", "class=\"input1_2\" style=\"width: 80%\" onchange=\"ChonDot()\"")%> </div>
                                 </td>  
                           <td style="width: 10%;" class="td_form2_td1">
                            <div><%=NgonNgu.LayXau("Chọn loại tiền:")%></div></td>
                        <td width="10%" id="<%= ParentID %>_LoaiTien">                            
                            <% rptQLDA_01_CPController rpt = new rptQLDA_01_CPController();%>                
     ...
     <script type="text/javascript">
      ...
      <script type="text/javascript">
          function ChonDot() {
              ...
              var url = unescape('<%= Url.Action("ds_QLDA?ParentID=#0&iID_MaDotCapPhat=#1&MaND=#2&MaTien=#3","rptQLDA_01_CP") %>');
