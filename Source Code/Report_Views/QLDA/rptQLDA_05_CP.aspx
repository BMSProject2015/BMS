...
<body>
    <%   
       ...
       // dtDotCapPhat.Dispose();
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptQLDA_05_CP", new { iID_MaDotCapPhat = iID_MaDotCapPhat, MaND = MaND, MaTien = MaTien });
        String URL = Url.Action("Index", "QLDA_Report");
        using (Html.BeginForm("EditSubmit", "rptQLDA_05_CP", new { ParentID = ParentID }))
        {
    %>
        ...
        <div id="Div1">
          <div id="Div2">
            <table style="width:100%;" cellpadding="0"  cellspacing="0" border="0" class="table_form2">                
                        <tr>
                        ...
                        <td style="width:10%" id="<%= ParentID %>_LoaiTien">                            
