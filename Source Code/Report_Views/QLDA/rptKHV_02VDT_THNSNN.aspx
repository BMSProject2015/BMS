...
<body>
    <% 
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptKHV_02VDT_THNSNN", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });

        String urlExport = Url.Action("ExportToExcel", "rptKHV_02VDT_THNSNN", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });
        using (Html.BeginForm("EditSubmit", "rptKHV_02VDT_THNSNN", new { ParentID = ParentID, vidDenNgay = dDenNgay }))
        {
    %>
    <div class="box_tong">
