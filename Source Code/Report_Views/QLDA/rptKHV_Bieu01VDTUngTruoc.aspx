...
<body>
    <% 
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptKHV_Bieu01VDTUngTruoc", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });
        String URL = Url.Action("Index", "QLDA_Report");
        String urlExport = Url.Action("ExportToExcel", "rptKHV_Bieu01VDTUngTruoc", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });
        using (Html.BeginForm("EditSubmit", "rptKHV_Bieu01VDTUngTruoc", new { ParentID = ParentID, vidDenNgay = dDenNgay }))
        {
    %>
    <div class="box_tong">
