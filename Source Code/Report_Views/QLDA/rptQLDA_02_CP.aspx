...
<body>
    <%   
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptQLDA_02_CPVDT", new { iID_MaDotCapPhat = iID_MaDotCapPhat, MaND = MaND, MaTien = MaTien });
        String URL = Url.Action("Index", "QLDA_Report");
        using (Html.BeginForm("EditSubmit", "rptQLDA_02_CPVDT", new { ParentID = ParentID }))
        {
    %>
