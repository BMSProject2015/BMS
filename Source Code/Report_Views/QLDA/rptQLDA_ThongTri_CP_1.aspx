...
<body>
    <%   String ParentID = "QLDA_CP";
         String PageLoad = "1";
         String sNoiDung = Convert.ToString(ViewData["sNoiDung"]);
         ...
         String UrlReport = "";
         if (PageLoad == "1")
             UrlReport = Url.Action("ViewPDF", "rptQLDAThongTri_1", new { iID_MaDotCapPhat = iID_MaDotCapPhat, iLoai = iLoai, sNoiDung = sNoiDung });
         String urlExport = Url.Action("ExportToExcel", "rptQLDAThongTri_1", new { iID_MaDotCapPhat = iID_MaDotCapPhat, iLoai = iLoai, sNoiDung = sNoiDung });
          %>
   <%
   {
    %>   
