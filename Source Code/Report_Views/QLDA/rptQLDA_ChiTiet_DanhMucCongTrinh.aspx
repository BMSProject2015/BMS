...
<body>
    <%   
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptQLDA_ChiTiet_DanhMucCongTrinh", new { dNgay = dNgay, sDeAn = sDeAn, MaTien = MaTien, iCapTongHop = iCapTongHop });
        String URL = Url.Action("Index", "QLDA_Report");
        using (Html.BeginForm("EditSubmit", "rptQLDA_ChiTiet_DanhMucCongTrinh", new { ParentID = ParentID }))
        {
    %>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQLDA_ChiTiet_DanhMucCongTrinh", new { dNgay = dNgay, sDeAn = sDeAn, MaTien = MaTien, iCapTongHop = iCapTongHop }), "Xuất ra Excels")%>
