...
<body>
    <% 
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptKHV_Bieu02VDT", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });
        String URL = Url.Action("Index", "QLDA_Report");
        String urlExport = Url.Action("ExportToExcel", "rptKHV_Bieu02VDT", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });
        using (Html.BeginForm("EditSubmit", "rptKHV_Bieu02VDT", new { ParentID = ParentID, vidDenNgay = dDenNgay }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo tổng hợp tình hình thực hiện tình hình nhà nước giao</span>
                    </td>
                </tr>
            </table>
        </div>
