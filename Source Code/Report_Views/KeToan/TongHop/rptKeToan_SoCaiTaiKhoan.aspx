...
<body>
    <% 
        ...
        {
            TuThang = Convert.ToString(dtND.Rows[0]["iThangLamViec"]);
        }
        String DenThang = Convert.ToString(ViewData["DenThang"]);
        if (String.IsNullOrEmpty(DenThang))
        {
            DenThang = Convert.ToString(dtND.Rows[0]["iThangLamViec"]);
        }
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptKeToan_SoCaiTaiKhoan", new { NamLamViec = NamLamViec, TuThang = TuThang, DenThang = DenThang, TrangThai = TrangThai });
        using (Html.BeginForm("EditSubmit", "rptKeToan_SoCaiTaiKhoan", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td width="47.9%">
                        <span>Báo cáo sổ cái tài khoản</span>
                    </td>
            ...
            <div id="rptMain" style="width: 100%; margin: 5px auto; padding: 0px 0px; overflow: visible;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                    <tr>
                        ...
                        <td class="td_form2_td1" width="100px" align="right">
                           <b>   Từ tháng:</b>
                        </td>
                        <td width="100px" align="right">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slThang, TuThang, "TuThang", "", "class=\"input1_2\" style=\"width: 100%\"")%>
                            </div>
                        </td>
                        <td class="td_form2_td1" width="100px" align="right">
                            <b>  Đến tháng:</b>
                        ...
                        <td width="100px" align="right">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slThang, DenThang, "DenThang", "", "class=\"input1_2\" style=\"width: 100%\"")%>
                            </div>
                        </td>
                        <td class="td_form2_td1" width="100px" align="right">
                            <b>  Trạng thái:</b>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptKeToan_SoCaiTaiKhoan", new { NamLamViec = NamLamViec, TuThang = TuThang, DenThang = DenThang }), "Xuất ra Excel")%>
    <%} %>
