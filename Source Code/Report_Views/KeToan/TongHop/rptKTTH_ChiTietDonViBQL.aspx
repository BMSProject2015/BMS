...
<body>
    <%
        ...
        {
            urlReport = Url.Action("ViewPDF", "rptKTTH_ChiTietDonViBQL", new { iID_MaDonVi = MaDonVi, iNamLamViec = iNamLamViec, iID_MaTaiKhoan = iID_MaTaiKhoan, iThang1 = iThang1, iThang2 = iThang2, iNgay1 = iNgay1, iNgay2 = iNgay2, LoaiBaoCao = LoaiBaoCao });
        }
        using (Html.BeginForm("EditSubmit", "rptKTTH_ChiTietDonViBQL", new { ParentID = ParentID, ChiSo = ChiSo }))
        {
    %>
    <div class="box_tong">
        ...
        <div id="confirmBox" title="Báo cáo chi tiết theo đơn vị" style="width: 660px; min-height: 200px;
            display: none;">
            <div>
                <div id="left" style="float: left; width: 305px; text-align: left; padding: 3px;">
                    <fieldset>
                        <legend>
                            <%=NgonNgu.LayXau("Tài khoản (Ký hiệu 62)")%></legend>
                ...
                <div id="right" style="float: right; width: 305px; text-align: left; padding: 3px;">
                    <fieldset>
                        <legend>
                            <%=NgonNgu.LayXau("Chọn đơn vị")%></legend>
                        <table class="mGrid">
                            <tr>
                        ...
                        <div id="divDonVi" style="width: 100%; height: 252px; overflow: scroll;">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptChiTietTheoDonVi_2", new { iID_MaDonVi = iID_MaDonVi, iNamLamViec = iNamLamViec, iID_MaTaiKhoan = iID_MaTaiKhoan, iThang1 = iThang1, iThang2 = iThang2, iNgay1 = iNgay1, iNgay2 = iNgay2, LoaiBaoCao = LoaiBaoCao }), "Xuất ra file Excel")%>
    <div>
