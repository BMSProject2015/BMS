...
<body>
     <%
        ...
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptNCC_TongHopNganSach_57", new { MaND = MaND, sLNS = sLNS, ThangQuy = ThangQuy, LoaiThang_Quy = LoaiThang_Quy, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, KhoGiay = KhoGiay, RutGon = RutGon, Solieu = Solieu, ToSo = ToSo });
        String BackURL = Url.Action("Index", "NguoiCoCong_Report", new { iLoai=1});
        String urlExport = Url.Action("ExportToExcel", "rptNCC_TongHopNganSach_57", new { MaND = MaND, sLNS = sLNS, ThangQuy = ThangQuy, LoaiThang_Quy = LoaiThang_Quy, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, KhoGiay = KhoGiay, RutGon = RutGon, Solieu = Solieu,ToSo=ToSo });
        using (Html.BeginForm("EditSubmit", "rptNCC_TongHopNganSach_57", new { ParentID = ParentID}))
        {
    %>
    <div class="box_tong">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 103px">
  ...
  <td align="right"></td>
    ...
    <td class="style4">
       <div id="<%=ParentID %>_divDonVi">
                                 <% rptNCC_TongHopNganSach_57Controller rpt = new rptNCC_TongHopNganSach_57Controller(); %>
  ...
  <script type="text/javascript">
      ...
      function ChonTo() {
          ...
          var url = unescape('<%= Url.Action("DS_To?ParentID=#0&iID_MaTrangThaiDuyet=#1&Thang_Quy=#2&LoaiThang_Quy=#3&RutGon=#4&MaND=#5&KhoGiay=#6&ToSo=#7&sLNS=#8", "rptNCC_TongHopNganSach_57") %>');
