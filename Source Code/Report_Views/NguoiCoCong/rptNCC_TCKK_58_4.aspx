...
<body>
    <% 
        ...
        DataTable dtDonVi = rptNCC_TCKK_58_4Controller.dtDanhsach_DonVi(sLNS, iID_MaTrangThaiDuyet, UserName);
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptNCC_TCKK_58_4", new { sLNS = sLNS, iID_MaDonVi = iID_MaDonVi, Loai = Loai, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, UserName = UserName ,KhoGiay=KhoGiay});
        String BackURL = Url.Action("Index", "NguoiCoCong_Report", new { iLoai=1});
        String urlExport = Url.Action("ExportToExcel", "rptNCC_TCKK_58_4", new { iID_MaDonVi = iID_MaDonVi, sLNS = sLNS, Loai = Loai, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, UserName = UserName, KhoGiay = KhoGiay });
        using (Html.BeginForm("EditSubmit", "rptNCC_TCKK_58_4", new { ParentID = ParentID}))
        {
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 105px">
  <tr>
    ...
    <td rowspan="3" align="center" valign="top" class="style8"><fieldset style="text-align:left;padding:3px 6px;font-size:11px;width:260px; -moz-border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;border-radius: 3px;border:1px #C0C0C0 solid;">
    ...
    <td align="right" class="style9"><b>Trạng thái duyệt : </b></td>
    ...
    <td rowspan="2" valign="top" align="center" class="style6"><fieldset style="text-align:left;padding:5px 5px 8px 8px;font-size:11px;width:140px; -moz-border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;border-radius: 3px;border:1px #C0C0C0 solid;">
    ...
    <td width="170" rowspan="2" valign="top" align="center"><fieldset style="text-align:left;padding:5px 5px 8px 8px;font-size:11px;width:140px; -moz-border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;border-radius: 3px;border:1px #C0C0C0 solid;">
  ...
  <tr>
    ...
    <td class="style5"><div id="<%= ParentID %>_tdDonVi"><%rptNCC_TCKK_58_4Controller rptTB1 = new rptNCC_TCKK_58_4Controller();                          
                            %>
                            <%=rptTB1.obj_DonVi(ParentID,sLNS, iID_MaDonVi,iID_MaTrangThaiDuyet,UserName)%>   </div></td>
  </tr>
  <tr>
    <td colspan="4"> <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin-top: 10px;margin-left:140px;">
                            <tr>
     ...
     <script type="text/javascript">
      ...
      <script type="text/javascript">
          function ChonLNS() {
              ...
              var url = unescape('<%= Url.Action("ds_DonVi?ParentID=#0&sLNS=#1&iID_MaDonVi=#2&iID_MaTrangThaiDuyet=#3&UserName=#4", "rptNCC_TCKK_58_4") %>');
