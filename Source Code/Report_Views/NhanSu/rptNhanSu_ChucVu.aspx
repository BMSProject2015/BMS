...
<body>
    <% 
        ...
        DataTable dtChucVu = CanBo_DanhMucNhanSuModels.getChucVu(true,"---Tất cả---");
        String ChucVu = Convert.ToString(ViewData["ChucVu"]);
        if (String.IsNullOrEmpty(ChucVu))
        {
            ChucVu = "0";
        }
        SelectOptionList slChucVu = new SelectOptionList(dtChucVu, "sID_MaChucVu", "sTen");
        dtChucVu.Dispose();
        ...
        if (PageLoad == "1")
        {
            //edit
            if (bBaoCaoTH)
                URLView = Url.Action("ViewPDF_TongHop", "rptNhanSu_ChucVu", new { ChucVu = ChucVu, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam });
            else
                URLView = Url.Action("ViewPDF", "rptNhanSu_ChucVu", new { ChucVu = ChucVu, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam });
        }
        String urlExport = Url.Action("ExportToExcel", "rptNhanSu_ChucVu", new { ChucVu = ChucVu, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam });
        using (Html.BeginForm("EditSubmit", "rptNhanSu_ChucVu", new { ParentID = ParentID, ChucVu = ChucVu, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam }))
        {
    %>
    ...
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Khai thác dữ liệu theo chức vụ</span>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                    <tr>
                        ...
                        <td class="td_form2_td1" style="width: 7%;">
                            <div>
                                <%=NgonNgu.LayXau("Chức vụ:")%></div>
                        </td>
                        <td width="20%" style="vertical-align: middle;">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slChucVu, ChucVu, "ChucVu", "", "class=\"input1_2\" style=\"width:100%;\" ")%>
                            </div>
                        </td>
                        <td class="td_form2_td1" style="width: 7%;">
                            <div>
