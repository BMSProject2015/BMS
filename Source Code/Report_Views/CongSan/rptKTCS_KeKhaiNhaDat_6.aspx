...
<body>
    <%
      ...
      //tai san
       DataTable dtTaiSan = rptKTCS_KeKhaiNhaDat_6Controller.DT_LoaiTS();
      ...
      String PageLoad=Convert.ToString(ViewData["PageLoad"]);
       String URL="";
        if(PageLoad=="1")
        {
            URL = Url.Action("ViewPDF", "rptKTCS_KeKhaiNhaDat_6", new { NamChungTu = NamChungTu, iID_MaLoaiTaiSan = iID_MaLoaiTaiSan, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, TongHopLTS = TongHopLTS, KhoGiay = KhoGiay });
        }
       String BackURL = Url.Action("Index", "CongSan_Report");
       String urlExport = Url.Action("ExportToExcel", "rptKTCS_KeKhaiNhaDat_6", new { NamChungTu = NamChungTu, iID_MaLoaiTaiSan = iID_MaLoaiTaiSan, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, TongHopLTS = TongHopLTS, KhoGiay = KhoGiay });
       using (Html.BeginForm("EditSubmit", "rptKTCS_KeKhaiNhaDat_6", new { ParentID = ParentID }))
    {
%>
<div class="box_tong" >
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                	<span>BÁO CÁO Kê Khai Nhà Đất</span>
                </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" 
        style="height: 138px; margin-left:140px;">
  <tr>
  ...
  <tr>
    ...
    <td align="right" class="style7"><b>Chọn năm :</b></td>
    <td class="style7"><%=MyHtmlHelper.DropDownList(ParentID, slNam, NamChungTu, "NamChungTu", "", "class=\"input1_2\" style=\"width: 30%\"")%></td>
  </tr>
  <tr>
    <td align="right" class="style8"><b>Khổ Giấy : </b></td>
    <td class="style8"><%=MyHtmlHelper.DropDownList(ParentID, slKhoGiay, KhoGiay, "KhoGiay", "", "class=\"input1_2\" style=\"width: 30%\"")%></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
