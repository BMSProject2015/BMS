...
<body>
  <%
      ...
      if (PageLoad == "1")
      {
          URL = Url.Action("ViewPDF", "rptCongSan_PhuLuc2", new { iNamLamViec = iNamLamViec, KhoGiay = KhoGiay });
      }
      
       String BackURL = Url.Action("Index", "CongSan_Report");
       String urlExport = Url.Action("ExportToExcel", "rptCongSan_PhuLuc2", new { iNamLamViec = iNamLamViec, KhoGiay = KhoGiay });
       using (Html.BeginForm("EditSubmit", "rptCongSan_PhuLuc2", new { ParentID = ParentID }))
    {
  %>
<div class="box_tong" >
