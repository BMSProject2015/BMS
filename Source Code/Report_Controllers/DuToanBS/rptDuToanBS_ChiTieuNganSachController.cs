...
namespace VIETTEL.Report_Controllers.DuToanBS
{
    public class rptDuToanBS_ChiTieuNganSachController : Controller
    {
        ...
        private const String sFilePath = "/Report_ExcelFrom/DuToanBS/rptDuToanBS_ChiTieuNganSach.xls";
        public ActionResult Index()
        {
            ViewData["path"] = "~/Report_Views/DuToanBS/rptDuToanBS_ChiTieuNganSach.aspx";
