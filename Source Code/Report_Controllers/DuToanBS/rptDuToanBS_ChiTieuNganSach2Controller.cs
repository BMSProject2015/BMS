...
namespace VIETTEL.Report_Controllers.DuToanBS
{
    public class rptDuToanBS_ChiTieuNganSach2Controller : Controller
    {
        ...
        private const String VIEW_PATH_DUTOANBS_CHITIEU_NS2 = "~/Report_Views/DuToanBS/rptDuToanBS_ChiTieuNganSach2.aspx";
        private const String sFilePath_ChiTieuNganSach2 = "/Report_ExcelFrom/DuToanBS/rptDuToanBS_ChiTieuNganSach2.xls";

        public ActionResult Index()
        {
            ViewData["path"] = VIEW_PATH_DUTOANBS_CHITIEU_NS2;
        ...
        public ActionResult ViewPDF(String MaND, String iID_MaDot, String sLNS, String iID_MaDonVi, String iID_MaPhongBan)
        {
            ...
            String sDuongDan = sFilePath_ChiTieuNganSach2;
