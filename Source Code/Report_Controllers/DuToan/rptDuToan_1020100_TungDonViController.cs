...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_1020100_TungDonViController : Controller
    {
        ...
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020100_TungDonVi.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020100_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1020100_TungDonVi(String MaND,String iID_MaDonVi)
        {
...
GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi
 ORDER BY sM,sTM,sTTM,sNG", DVT, DKPhongBan, DKDonVi);
            cmd.CommandText = SQL;
