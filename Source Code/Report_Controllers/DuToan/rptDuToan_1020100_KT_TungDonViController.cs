...
{
    public class rptDuToan_1020100_KT_TungDonViController : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020100_KT_TungDonVi.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020100_KT_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1020100_KT_TungDonVi(String MaND,String iID_MaDonVi)
        {
...
,rTonKho=SUM(rTonKho/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1020100' AND sM IN (6900,7000,7750,9050) AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec {1} {2}
