...
{
    public class rptDuToan_2_TungDonViController : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_2_TungDonVi.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_2_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public static DataTable DT_rptDuToan_2_TungDonVi(String MaND,String iID_MaDonVi)
        {
            ...
            int DVT = 1000;
            String SQL = String.Format(@"SELECT sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi,iID_MaPhongBan
,rTuChi=SUM(rTuChi/{3})
