...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_1030100_TongHop_XDCBController : Controller
    {
        ...
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1030100_TongHop_XDCB.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1030100_TongHop_XDCB.aspx";
            ViewData["PageLoad"] = "0";
...
,rDuPhong=SUM(rDuPhong/{3})
 ...
 WHERE iTrangThai=1  AND sLNS LIKE '1030100%' AND iNamLamViec=@iNamLamViec {0} {1} {2}
