...
{
    public class rptDuToan_1040100_TungNganhController : Controller
    {
        //
        ...
        public ExcelFile CreateReport(String path, String MaND, String Nganh, String ToSo, String sLNS, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1040100_TungNganh");
        ...
        public static dataDuLieu1 get_dtDuToan_1050000(String MaND, String Nganh, String ToSo, String sLNS, String iID_MaPhongBan)
        {
            ...
            SQLNganh += " FROM DT_ChungTuChiTiet_PhanCap WHERE sLNS='1020100' AND MaLoai<>'1' {1} AND iTrangThai=1 {2}  {0} {3}";
            ...
            SQL += " FROM DT_ChungTuChiTiet_PhanCap WHERE sLNS='1020100' AND MaLoai<>'1' {1}      AND iTrangThai=1 {2}   {0} {4}";
