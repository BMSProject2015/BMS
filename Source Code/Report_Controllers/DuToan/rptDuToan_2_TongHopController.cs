...
{
    public class rptDuToan_2_TongHopController : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_2_TongHop.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_2_TongHop.aspx";
            ViewData["PageLoad"] = "0";
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_2_TongHop(String MaND,String iID_MaPhongBan)
        {
...
,rDuPhong=SUM(rDuPhong/{3})
 ...
 WHERE iTrangThai=1  AND sLNS LIKE '2%' AND iNamLamViec=@iNamLamViec {0} {1} {2}
