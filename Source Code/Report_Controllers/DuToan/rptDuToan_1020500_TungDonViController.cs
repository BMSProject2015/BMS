...
,rChiTapTrung=SUM(rChiTapTrung/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1020500' AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec {1} {2}
...
,SUM(rTuChi/{3}) as rTuChi,sGhiChu
 ...
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi,sGhiChu", iID_MaDonVi, DKPhongBan, DKDonVi, DVT);
        ...
        private void LoadData(FlexCelReport fr, String MaND, String iID_MaDonVi)
        {
            ...
            DataTable dtMoTaGhiChu = HamChung.SelectDistinct("dtMoTaGhiChu", dataGhiChu, "sLNS,sL,sK,sM,sTM,sTTM,sNG", "sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa", "");
