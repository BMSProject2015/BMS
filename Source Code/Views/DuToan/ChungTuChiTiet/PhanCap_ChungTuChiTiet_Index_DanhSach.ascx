...
<div class="box_tong">
    <div id="nhapform">
        <div id="form2">
            ...
            <iframe id="ifrChiTietChungTu" width="100%" height="538px" src="<%= Url.Action("ChungTuChiTiet_Frame", "DuToan_PhanCapChungTuChiTiet", new {iID_MaChungTu=iID_MaChungTu, iID_MaDonVi=iID_MaDonVi, sLNS=sLNS})%>"></iframe>
        </div>
    </div>
</div>