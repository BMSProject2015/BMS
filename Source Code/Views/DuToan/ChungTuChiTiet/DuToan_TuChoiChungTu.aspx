...
<body>
    <%
        ...
        String idAction = "1";
        using (Html.BeginForm("TuChoi", "DuToan_ChungTuChiTiet", new { ParentID = ParentID, iID_MaChungTu = iID_MaChungTu, sLNS = sLNS, iLoai = 1, iID_MaChungTu_TLTH = iID_MaChungTu_TLTH }))
        {
    %>
