...
<%
    ...
    KTCT_KhoBac_ChungTuChiTiet_BangDuLieu bang = new KTCT_KhoBac_ChungTuChiTiet_BangDuLieu(iID_MaChungTu, iLoai, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTCT_KhoBac_ChungTuChiTiet", new{iLoai = iLoai})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        jsKTCT_CapThu_Duyet = '<%=Url.Action("get_ChungTuCapThu", "KTCT_KhoBac_ChungTuChiTiet")%>';
        jsKTCT_CapNS='<%=Url.Action("get_CapNS", "KTCT_KhoBac_ChungTuChiTiet")%>';
