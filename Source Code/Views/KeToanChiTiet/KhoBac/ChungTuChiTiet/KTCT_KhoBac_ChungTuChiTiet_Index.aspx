...
NameValueCollection data = KTCT_KhoBac_ChungTuModels.LayThongTin(iID_MaChungTu);
%>
    ...
    <tr>
        ...
        <td align="left">
            <div style="padding-bottom: 5px; color:#ec3237;">
                ...
                <%=MyHtmlHelper.ActionLink(Url.Action("Index", "KTCT_KhoBac_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu }), "Chi tiết chứng từ")%>
            </div>
        </td>
    </tr>
</table>
        ...
        <div class="box_tong">
            ...
            <div id="nhapform">
                <div id="form2">
                        ...
                        <tr>
                            ...
                            <td style="width: 50%;" valign="top">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form3">
                                    <tr>
                                        <td class="td_form2_td1">
                                            <div><b>Ngày tạo hệ thống chứng từ</b></div>
                                        </td>
                                        <td class="td_form2_td5"><div><b>
                    ...
                    <%Html.RenderPartial("~/Views/KeToanChiTiet/KhoBac/ChungTuChiTiet/KTCT_KhoBac_ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name }); %>
                </div>
            </div>
        </div>
    </div>
