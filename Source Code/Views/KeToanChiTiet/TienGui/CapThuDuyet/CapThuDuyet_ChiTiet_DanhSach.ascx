...
<%
    ...
    KTCT_TienGui_DuyetChungTu_ChiTiet_BangDuLieu bang = new KTCT_TienGui_DuyetChungTu_ChiTiet_BangDuLieu(iID_MaChungTu_Duyet,arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTCT_DuyetCapThu", new{iID_MaChungTu_Duyet=iID_MaChungTu_Duyet})%>" method="post">
    <%
    } %>
        ...
        <tr>
            <td align=center>
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="right">
                            <input type="button" id="btnLuu" class="button" onclick="javascript:return Bang_HamTruocKhiKetThuc();" value="<%=NgonNgu.LayXau("Bỏ duyệt")%>"/>
                        </td>
                        <td>&nbsp;</td>
