...
<%
    ...
    DataTable dtChungTu = KTCT_TienGui_ChungTuModels.GetChungTu(MaChungTu);
    DataRow R;
    ...
    if (ViewData["DuLieuMoi"] == "1")
    {
        ...
        iSoChungTu = KTCT_TienGui_ChungTuModels.GetMaxChungTu() + 1;
    }
    dtChungTu.Dispose();
    ...
    using (Html.BeginForm("EditSubmit", "KTCT_TienGui_ChungTu", new { ParentID = ParentID, MaChungTu = MaChungTu}))
    {
%>
