...
<%
    ...
    {
        %>
        <script src="<%= Url.Content("~/Scripts/KeToanChiTietTienGui/jsBang_KeToanChiTiet_TienGui_ChungTuChiTiet.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
        ...
        <%Html.RenderPartial("~/Views/KeToanChiTiet/TienGui/KeToanChiTiet_TienGui_ChungTuChiTiet_Frame_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name, iID_MaChungTu = iID_MaChungTu }); %>
        <%
    }
%>
</asp:Content>
