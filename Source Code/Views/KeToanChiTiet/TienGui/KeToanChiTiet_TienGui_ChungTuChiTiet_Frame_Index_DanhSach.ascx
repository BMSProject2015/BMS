...
<%
    ...
    KTCT_TienGui_ChungTuChiTiet_BangDuLieu bang = new KTCT_TienGui_ChungTuChiTiet_BangDuLieu(iID_MaChungTu, arrGiaTriTimKiem, MaND, IPSua);
...
%>
  <table class="gridBang" style="background:#DFF0FB;" width="100%">
    <tr>
        <td width="408px"  align="right"><b>Tổng cộng:</b></td>
        <td width="100px"> <span style="font-weight:bold" id="lblTongSo"></span></td>   
        <td>&nbsp;</td>     
    </tr>
  </table>
<div class="box_tong">
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTCT_TienGui_ChungTuChiTiet", new{iID_MaChungTu=iID_MaChungTu})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        jsKTCT_CapThu_Duyet = '<%=Url.Action("get_ChungTuCapThu", "KTCT_TienGui_ChungTuChiTiet")%>';
        jsKTCT_ThongTinDonViNhanUNC = '<%=Url.Action("get_ThongTinDonViNhanUyNhiemChi", "KTCT_TienGui_ChungTuChiTiet")%>';
