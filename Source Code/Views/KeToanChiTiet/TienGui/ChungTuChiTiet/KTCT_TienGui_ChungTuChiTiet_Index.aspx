...
NameValueCollection data = KTCT_TienGui_ChungTuModels.LayThongTin(iID_MaChungTu);
%>
        ...
        <div class="box_tong">
            ...
            <div id="nhapform">
                <div id="form2">
                    ...
                    <%Html.RenderPartial("~/Views/KeToanChiTiet/TienGui/ChungTuChiTiet/KTCT_TienGui_ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name }); %>
                </div>
            </div>
        </div>
    </div>
