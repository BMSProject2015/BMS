...
<%
    ...
    TinhChatCapThu_BangDuLieu bang = new TinhChatCapThu_BangDuLieu(arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTTG_TinhChatCapThu")%>" method="post">
    <%
    } %>
