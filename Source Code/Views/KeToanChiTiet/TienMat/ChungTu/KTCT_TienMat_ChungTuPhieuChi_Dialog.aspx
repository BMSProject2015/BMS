...
<body>
    <div>
        <%
            ...
            DataTable dtSo = rptKTTienMat_PhieuChiController.Lay_SoPT(iNamLamViec, iThang, iID_MaChungTu, UserID);
            ...
            DataTable dtLoaiBaoCao = rptKTTienMat_PhieuChiController.DanhSach_LoaiBaoCao();
            SelectOptionList slLoaiBaoCao = new SelectOptionList(dtLoaiBaoCao, "MaLoai", "TenLoai");
            dtLoaiBaoCao.Dispose();
            using (Html.BeginForm("EditSubmit", "rptKTTienMat_PhieuChi", new { ParentID = ParentID, UserID = UserID, iNamLamViec = iNamLamViec, iThang = iThang, ChiSo = 0 }))
            {
        %>
                                                        ...
                                                        <table class="mGrid">
                                                            <tr>
                                                                ...
                                                                <td class="td_form2_td1" style="width: 110px; text-align: center">
                                                                    <div><b><%=NgonNgu.LayXau("Chọn số PC")%></b></div>
                                                                </td>
                                                            </tr>
                                            ...
                                            <td width = "49%">
                                                <fieldset style="border-top-right-radius:5px; border-top-left-radius:5px; -moz-border-radius-topright:5px;-moz-border-radius-topleft:5px;border:1px solid #dedede; margin-left:5px;margin-right:5px; min-height: 450px;">
                                                    ...
                                                    <p style="Padding:4px;">
                                                     ...
                                                     <p style="Padding:4px;">
                                                        <%=MyHtmlHelper.Option(ParentID, "PC4", LoaiBaoCao, "LoaiBaoCao", "")%>
                                                                    <b> 1 Phiếu trên khổ A5</b>
                                                    </p>
                                                </fieldset>                                    
                                            </td>
                                        </tr>
