...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/KeToanChiTietTienMat/jsBang_KeToanChiTiet_TienMat_ChungTu.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
    ...
    <%
        ...
        KTCT_TienMat_ChungTu_BangDuLieu bang = new KTCT_TienMat_ChungTu_BangDuLieu(iThang, iNam, arrGiaTriTimKiem, MaND, IPSua);
            ...
            <div id="form2">
                ...
                <div style="display: none;">
                    ...
                    <%  
                        ...
                        {
                    %>
                    <form action="<%=Url.Action("DetailSubmit", "KTCT_TienMat_ChungTu", new{iNam = iNam, iThang = iThang})%>"
                    method="post">
                    <%
                        } %>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="right">
                                        <input type="button" class="button" value="<%=NgonNgu.LayXau("Thực hiện")%>" id="bntThucHien"
                                            onclick="javascript:return BangDuLieu_onKeypress_F10();" />
                                    </td>
                                    <%
...
//         if (Bang_nH ==1) {
//              document.getElementById("bntThucHien").style.display = 'none';
//              document.getElementById("bntThucHienNew").style.display = '';
//         }
//         else {

//             document.getElementById("bntThucHien").style.display = '';
//              document.getElementById("bntThucHienNew").style.display = 'none';
//         }
        Bang_keys.focus();
