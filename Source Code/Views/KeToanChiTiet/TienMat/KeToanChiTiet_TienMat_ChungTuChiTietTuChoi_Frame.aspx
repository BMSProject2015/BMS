...
<script src="<%= Url.Content("~/Scripts/KeToanChiTietTienMat/jsBang_KeToanChiTiet_TienMat_ChungTuChiTietTuChoi.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
...
<%
    ...
    KTCT_TienMat_ChungTuChiTietTuChoi_BangDuLieu bang = new KTCT_TienMat_ChungTuChiTietTuChoi_BangDuLieu(iThang, iNam, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTCT_TienMat_ChungTu", new{iNam = iNam, iThang = iThang})%>" method="post">
    <%
    } %>
