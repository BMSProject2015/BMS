...
<body><div>
    <%
        ...
        String iID_MaDanhMucGia_Cha = Convert.ToString(Request.QueryString["iID_MaDanhMucGia_Cha"]);
        ...
        using (Html.BeginForm("EditSubmit", "SanPham_DanhMucGia", new { ParentID = ParentID, iID_MaDanhMucGia = iID_MaDanhMucGia }, FormMethod.Post, new { }))
        {
    %>
