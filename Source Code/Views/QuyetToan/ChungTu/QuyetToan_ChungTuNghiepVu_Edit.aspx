                                ...
                                <div>
                                    ...
                                    <script language="javascript" type="text/javascript">
                                        function ChonPhongBanNhapLieu(jGiaTriPhongBan) {
                                            ...
                                            var url = unescape('<%= Url.Action("get_dtMucLucNganSach_NghiepVu?ParentID=#0&iID_MaPhongBan=#1&sLNS=#2", "QuyetToan_ChungTu")%>');
                            ...
                            <td class="td_form2_td5">
                                <div id="divDonVi" style="width: 100%; height: 400px; max-height:400px; min-height:0px; overflow: scroll;">
                                    <div id="<%= ParentID %>_divMucLucNganSach">
                                        <%=QuyetToan_ChungTuController.get_objMucLucNganSach_NghiepVu(ParentID, MaPhongBanNguoiDung, sLNS)%>
                                    </div>
