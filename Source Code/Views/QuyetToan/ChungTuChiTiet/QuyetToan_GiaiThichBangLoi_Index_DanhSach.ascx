...
<%
    ...
    String iID_MaChungTu = Convert.ToString(props["iID_MaChungTu"].GetValue(Model));    
    ...
    QuyetToan_GiaiThichBangLoi_BangDuLieu bang = new QuyetToan_GiaiThichBangLoi_BangDuLieu(iID_MaChungTu, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit_GTBL", "QuyetToan_ChungTuChiTiet", new{iID_MaChungTu=iID_MaChungTu})%>" method="post">
    <%
    } %>
...
%>
    <table cellpadding="0" cellspacing="0" border="0" align="center">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td align="left">
                <input class="button" type="button" value="<%=NgonNgu.LayXau("Quay lại")%>" onclick="parent.jsGTBL_Dialog_close_Reload()" />
            </td>
            <td>&nbsp;</td>
...
<script type="text/javascript">
    $(document).ready(function () {
        Bang_arrDSTruongTien = 'sKyHieuDoiTuong,iSTT,sHoTen,rSoNguoi,rLuongThang,iSoNgay,rLuongCoBan,rThamNien,rPhuCapChucVu,rPhuCapKhuVuc,rPhuCapKhac,rTongSo'.split(',');
        ...
        <%=bang.DuocSuaChiTiet?"":"Bang_keys.fnSetFocus(0, 1);"%>
    });
</script>
