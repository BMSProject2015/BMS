        ...
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
              ...
              <%--  <td align="center">
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("EditDetail", "PhongBanDonVi", new { Code = R["iID_MaPhongBan"], MaID = R["iID_MaPhongBanDonVi"] }).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("DeleteDetail", "PhongBanDonVi", new { Code = R["iID_MaPhongBanDonVi"], MaID = R["iID_MaPhongBan"] }).ToString(), "<img src='../Content/Themes/images/delete.gif' alt='' />", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
