                    ...
                    <table class="mGrid">
                        ...
                        <%
                            ...
                            for (i = 0; i < dt.Rows.Count; i++)
                            {
                                ...
                                {
                                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "TuLieu_HinhAnh", new { MaTaiLieu = dt.Rows[i]["iID_MaTaiLieu_Anh"] }).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "Edit", "");
                                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "TuLieu_HinhAnh", new { MaTaiLieu = dt.Rows[i]["iID_MaTaiLieu_Anh"] }).ToString(), "<img src='../Content/Themes/images/delete.gif' alt='' />", "Delete", "");
                                }
                        %>
                        <tr class="<%=strClass %>">
                            <td align="center">
