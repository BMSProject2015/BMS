    ...
    <%
        ...
        if (String.IsNullOrEmpty(MaTaiLieu) == false)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                sHieuLuc = Convert.ToString(dt.Rows[0]["iHieuLuc"]);
                if (sHieuLuc == "3")
                {
                    sHieuLuc = "Còn hiệu lực 1 phần";
                }
                else if (sHieuLuc == "2") sHieuLuc = "Hết hiệu lực";
                else sHieuLuc = "Còn hiệu lực";
                dt.Dispose();
                            ...
                            <table width="60%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%= MyHtmlHelper.Label( data, "sGhiChu", sDanhSachTruongCam, "style=\"width:100%;\"")%><br />
                                        </div>
                                    </td>
                                </tr>
                            </table>
