...
<script src="<%= Url.Content("~/Scripts/jsBang_ChiTieu.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>   
...
<%
    ...
    PhanBo_ChiTieu_BangDuLieu bang = new PhanBo_ChiTieu_BangDuLieu(iID_MaChiTieu, arrGiaTriTimKiem, MaND, IPSua, LayTuDuToan);
...
<div style="display:none;">
    ...
    <form action="<%=Url.Action("DetailSubmit", "PhanBo_ChiTieuChiTiet", new{iID_MaChiTieu=iID_MaChiTieu})%>" method="post">
    <%
    } %>
...
<%
   ...
   <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td align="left" width="100px">
                <input class="button" type="button" value="<%=NgonNgu.LayXau("Lấy dự toán")%>" onclick="javascript:return parent.LayDuToan();" />
            </td>
            <td>&nbsp;</td>
            <td align="left">
                <%
                ...
                <% 
                  ...
                  <%  if (LuongCongViecModel.KiemTra_NguoiDungDuocDuyet(MaND,PhanHeModels.iID_MaPhanHeChiTieu))
                    {
