...
<%
    ...
    DataTable dtDuToan = PhanBo_ChiTieuModels.GET_DanhSachDuToan(UserID, MaChiTieu, true);
    DataTable dtChon = PhanBo_ChiTieuModels.GET_DanhSachDuToanDuocChon(MaChiTieu);
    using (Html.BeginForm("EditSubmit", "PhanBo_ChiTieu", new { ParentID = ParentID, MaChiTieu = MaChiTieu, MaDotPhanBo = MaDotPhanBo }))
    {
%>
                        ...
                        <tr>
                            ...
                            <td class="td_form2_td5">
                                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="mGrid">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <input type="checkbox" value="<%=iID_MaDuToan %>" <%=strChecked %> check-group="PhanBo"
                                                id="iID_MaDuToan" name="iID_MaDuToan" />
                                        </td>
                                        <td class="td_form2_td1" style="width: 15%;">
                                            <div>
                                                <b>
