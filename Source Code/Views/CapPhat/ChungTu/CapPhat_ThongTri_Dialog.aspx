                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table_form2">
                                        <tr>
                                            <td align="left" colspan="2" valign="top" style="width: 40%">
                                                <div style="width: 100%; height: 210px; overflow: scroll; position: relative;">
                                            ...
                                            <td style="width: 40%">
                                                ...
                                                <div style="width: 100%; height: 180px; overflow: scroll; position: relative;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mGrid">
                                                        <tr>
                                                            <td>
                                                                <%=MyHtmlHelper.Option(ParentID, "sNG", "sNG", "sLoaiThongTri", "")%>
                                                            </td>
                                                            <td>
                                                                <b>Ngành</b>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%=MyHtmlHelper.Option(ParentID, "sTM", "sTM", "sLoaiThongTri", "")%>
                                                            </td>
                                                            <td>
                                                                <b>Tiểu mục</b>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%=MyHtmlHelper.Option(ParentID, "sM", "sM", "sLoaiThongTri", "")%>
                                                            </td>
                                                            <td>
                                                                <b>Mục</b>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%=MyHtmlHelper.Option(ParentID, "sLNS", "sLNS", "sLoaiThongTri", "")%>
                                                            </td>
                                                            <td>
                                                                <b>Loại ngân sách</b>
                                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="td_form2_td5" colspan="3">
                                                <div>
                                                    <%=MyHtmlHelper.TextArea(ParentID, sLyDo, "sLyDo","", "style=\"height: 100px;width:100%\"")%><br />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
