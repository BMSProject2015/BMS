...
<%
    ...
    DataTable dt = CapPhat_ChungTu_CucModels.Get_DanhSachChungTu(MaPhongBan, MaND, iSoCapPhat, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet, iDM_MaLoaiCapPhat,false,CurrentPage, Globals.PageSize);

    double nums = CapPhat_ChungTu_CucModels.Get_DanhSachChungTu_Count(MaPhongBan, MaND, iSoCapPhat, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet, iDM_MaLoaiCapPhat,false);
    ...
    using (Html.BeginForm("SearchDuyetSubmit", "CapPhat_ChungTu_Cuc", new { ParentID = ParentID }))
    {
%>
<div class="box_tong">
...
<div class="box_tong">
    ...
    <table class="mGrid" id="<%= ParentID %>_thList">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            String strURL = MyHtmlHelper.ActionLink(Url.Action("Index", "CapPhat_ChungTu_CucChiTiet", new { iID_MaCapPhat = R["iID_MaCapPhat"] }).ToString(), "<img src='../Content/Themes/images/btnSetting.png' alt='' />", "Detail", null, "title=\"Xem chi tiết chứng từ\"");
            ...
            <tr <%=strColor%>>
                ...
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "CapPhat_ChungTu_CucChiTiet", new { iID_MaCapPhat = R["iID_MaCapPhat"] }).ToString(), Convert.ToString(R["sTienToChungTu"]) + Convert.ToString(R["iSoCapPhat"]), "Detail", "")%></b>
                </td>
                <td><%=LoaiCapPhat %></td>
