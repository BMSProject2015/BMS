...
<%
    ...
    using (Html.BeginForm("EditSubmit", "TCDN_ChungTu_ImportExcel", FormMethod.Post, new {  enctype = "multipart/form-data"}))
    {
%>
...
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td><span><%=NgonNgu.LayXau("Nhập thông tin chứng từ")%></span></td>
            </tr>
        </table>
    </div>
    <div id="nhapform">
        <div id="form2">
            <div style="width: 100%; float: left;">
                <table cellpadding="0" cellspacing="0" border="0" width="60%">
                    ...
                    <tr>
                        <td class="td_form2_td1" style="padding-top: 15px">
                            <div>
                   ...
                   <%-- <tr>
                        ...
                        <td class="td_form2_td5">
                            <a href="../../Libraries/Excels/TCDNMAU/MauNhapExcel-CanDoiKeToan.xls">
                                    Mẫu nhập excel</a>
                        </td>                    
                    </tr>
                    <tr>
...
function XemDuLieu() {
    ...
    var url = unescape('<%= Url.Action("get_dtSheet?ParentID=#0&DuongDan=#1", "TCDN_ChungTu_ImportExcel") %>');
