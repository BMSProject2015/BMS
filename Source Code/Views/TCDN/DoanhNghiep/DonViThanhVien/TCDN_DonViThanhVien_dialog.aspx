...
<head id="Head1" runat="server">
   ...
   <body>
    <%
        ...
        String sTen = "";
        String iLoai = "";
        DataTable dtLoai = TCDNModels.LoaiDonViThanhVien();
        SelectOptionList slLoai = new SelectOptionList(dtLoai,"iLoai","sTen");
        dtLoai.Dispose();
        DataTable dtCtyLDLK = TCDNModels.getChiTietDonViThanhVien(iID_Ma);
        if (dtCtyLDLK.Rows.Count > 0)
        {
            sTen = Convert.ToString(dtCtyLDLK.Rows[0]["sTen"]);
            iLoai = Convert.ToString(dtCtyLDLK.Rows[0]["iLoai"]);
        }
    ...
    <div class="box_tong">
        <% using (Html.BeginForm("EditSubmit_DonViThanhVien", "TCDN_HoSo_DoanhNghiep", new { ParentID = ParentID, iID_MaDoanhNghiep = iID_MaDoanhNghiep, iID_Ma = iID_Ma }))
           {%>
                    ...
                    <table width="100%">
                         <tr>
                            <td class="td_form2_td1" style="width: 30%">
                                <div>
                                    <b>
                                        <%= NgonNgu.LayXau("Loại hình công ty") %></b></div>
                            </td>
                            <td class="td_form2_td5" style="width: 45%">
                                <div>
                                     <%=MyHtmlHelper.DropDownList(ParentID, slLoai, iLoai, "iLoai", "", "class='input1_2' style='with:100px;'")%>
                                </div>
                            </td>
                            <td>
