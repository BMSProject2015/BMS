...
<script src="<%= Url.Content("~/Scripts/TCDN/jsBang_TCDN_BaoCaoTaiChinh.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
...
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                    <span>Báo cáo tài chính quý <%=iQuy %> năm <%=iNam%> của các công ty cổ phần</span>
                </td>
            </tr>
        </table>
    </div>
    <div id="nhapform">
        <div id="form2" style="padding: 10px;">
                        ...
                        <div>
                            <script type="text/javascript">
                                function ddlDuan_SelectedValueChanged(ctl) {
                                    var url = "<%=Url.Action("List", "TCDN_BaoCaoTaiChinh", new { iNam = iNam})%>";
            ...
            <br />
            <%Html.RenderPartial("~/Views/TCDN/BaoCaoTaiChinh/TCDN_BaoCaoTaiChinh_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name }); %>    
        </div>
    </div>
</div>
</asp:Content>
