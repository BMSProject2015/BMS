...
<%
    ...
    using (Html.BeginForm("EditSubmit", "TCDN_ChiTieuTaiChinh", new { ParentID = ParentID }))
    {
%>
...
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                    <span>Chỉ tiêu tài chính <%=iNam%></span>
                </td>
            </tr>
        </table>
    </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td class="td_form2_td1">
                            <div><b>Doanh nghiệp</b></div>
                        </td>
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slDoanhNghiep, "", "iID_MaDoanhNghiep", "", "class=\"input1_2\"")%><br />
                                <%= Html.ValidationMessage(ParentID + "_" + "err_iID_MaDoanhNghiep")%>
                            </div>
                        </td>
                    </tr>
                    <tr>
