...
<%
    ...
    TCDN_ChiTieuThuNop_BangDuLieu bang = new TCDN_ChiTieuThuNop_BangDuLieu(iID_MaDoanhNghiep, iQuy, iNam, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "TCDN_ChiTieuThuNop", new{iID_MaDoanhNghiep=iID_MaDoanhNghiep, iQuy=iQuy, iNam=iNam})%>" method="post">
    <%
    } %>
