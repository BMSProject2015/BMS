...
<%
    ...
    TCDN_ChiTieuTaiChinh_BangDuLieu bang = new TCDN_ChiTieuTaiChinh_BangDuLieu(iID_MaDoanhNghiep, iQuy, iNam, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "TCDN_ChiTieuTaiChinh", new{iID_MaDoanhNghiep=iID_MaDoanhNghiep, iQuy=iQuy, iNam=iNam})%>" method="post">
    <%
    } %>
...
<%
    ...
    String strDSTruongTien = "rSoDauNam,rSoCuoiKy";
 %>
