...
<%
    ...
    String iID_MaLoaiDoanhNghiep = Convert.ToString(props["iID_MaLoaiDoanhNghiep"].GetValue(Model));
    ...
    TCDN_BaoCaoTongHop_BangDuLieu bang = new TCDN_BaoCaoTongHop_BangDuLieu(iNam, iQuy, arrGiaTriTimKiem, MaND, IPSua);

    String BangID = "BangDuLieu";
    int Bang_Height = 470;
    int Bang_FixedRow_Height = 50;

    String strBaoCao = Url.Action("Reports", "TCDN_BaoCaoTongHop", new { iNamLamViec = iNam, iQuy = iQuy, iID_MaLoaiDoanhNghiep = iID_MaLoaiDoanhNghiep });
%>
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "TCDN_BaoCaoTongHop", new{iQuy=iQuy, iNam=iNam})%>" method="post">
    <%
    } %>
