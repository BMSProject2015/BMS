...
<form action="<%=Url.Action("ChiTiet_Submit", "KTCS_TaiSan", new {ParentID = ParentID})%>" method="post">
 ...
 <%=MyHtmlHelper.Hidden(ParentID,3,"iLoaiTS","") %>
            ...
            <div id="form2">
                ...
                <table cellpadding="4" cellspacing="4" border="0" class="table_form2">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, data, "sTinhChat_OTo", "", "class=\"input1_2\" tab-index='1'")%></div>
                        </td>
                        <td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, data, "sLoaiXe_OTo", "", "class=\"input1_2\"  tab-index='2'")%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="3">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, data, "sNhanHieu_OTo", "", "class=\"input1_2\" tab-index='3' ")%></div>
                        </td>
                    </tr>
                    <tr>
                        <td >
                        ...
                        <td colspan="3">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID,data, "sBienKiemSoat_OTo", "", "class=\"input1_2\" tab-index='4' ")%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div>
                                &nbsp;- Số chỗ ngồi/ Tải trọng (tấn):</div>
                        </td>
                        <td colspan="3">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, data, "sSoChoNgoi_OTo", "", "class=\"input1_2\" tab-index='5'")%></div>
                        </td>                        
                    </tr>
                   <tr>
                        <td>
