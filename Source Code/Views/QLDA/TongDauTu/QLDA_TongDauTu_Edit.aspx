...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        String iID_MaTongDauTu_QuyetDinh = Convert.ToString(ViewData["iID_MaTongDauTu_QuyetDinh"]);
        String ParentID = "Edit";
        String sSoQuyetDinh = "", dNgayQuyetDinh = "", sCapPheDuyet = "", dNgayLap = "", sSoQuyetDinh_Cu = "", sNoiDung = "";

        DataTable dt = QLDA_TongDauTuModels.Get_Row_TongDauTu_QuyetDinh1(iID_MaTongDauTu_QuyetDinh);
        if (dt.Rows.Count > 0 && iID_MaTongDauTu_QuyetDinh != null && iID_MaTongDauTu_QuyetDinh != "")
        {
            DataRow R = dt.Rows[0];
        ...
        using (Html.BeginForm("EditSubmit", "QLDA_TongDauTu", new { ParentID = ParentID, iID_MaTongDauTu_QuyetDinh = iID_MaTongDauTu_QuyetDinh }))
        {
    %>
                ...
                <table cellpadding="5" cellspacing="5" width="50%">
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, sSoQuyetDinh, "sSoQuyetDinh", "", "" + strOnblur + " class=\"input1_2\" tab-index='-1' style=\"width:30%;\" " + strReadOnlyMa + "")%>&nbsp;<span
                                ...
                                <script type="text/javascript">
                                    function CheckMaTrung(iID_MaChuDauTu) {
                                        ...
                                        if (iID_MaChuDauTu != null && iID_MaChuDauTu != '') {
                                            var url = unescape('<%= Url.Action("get_SoQuyetDinh?sSoQuyetDinh=#0", "QLDA_TongDauTu") %>');
                    ...
                    <tr>
                        <td class="td_form2_td1">
                            <div>
                                <b>Ngày lập&nbsp;<span style="color: Red;">*</span></b></div>
                        </td>
                        <td class="td_form2_td5">
                            <div>
                    ...
                    <tr>
                        <td class="td_form2_td1">
                            <div>
                                <b>Cấp phê duyệt&nbsp;<span style="color: Red;">*</span></b></div>
                        </td>
                        <td class="td_form2_td5">
                            <div>
                    ...
                    <tr>
                        <td class="td_form2_td1">
                            <div>
                                <b>Lấy dữ liệu của số quyết định trước</b></div>
                        </td>
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.Autocomplete(ParentID, sSoQuyetDinh_Cu, sSoQuyetDinh_Cu, "sSoQuyetDinh_Cu1", "sSoQuyetDinh_Cu", "", "class=\"input1_2\""+strReadOnlyMa+"")%>
                                <%=MyHtmlHelper.AutoComplete_Initialize(ParentID + "_sSoQuyetDinh_Cu", ParentID + "_sSoQuyetDinh_Cu1", Url.Action("get_DanhSach", "QLDA_TongDauTu"), "sTerm: request.term", "func_Auto_Complete", new { delay = 100, minchars = 1 })%>
                                <script type="text/javascript">
