...
<%
    ...
    DataTable dt = QLDA_TongDauTuModels.Get_DanhSachTongDauTu(iID_MaDanhMucDuAn, dTuNgay, dDenNgay, CurrentPage, Globals.PageSize);

    double nums = QLDA_TongDauTuModels.Get_DanhSachTongDauTu_Count(iID_MaDanhMucDuAn, dTuNgay, dDenNgay);
    int TotalPages = (int)Math.Ceiling(nums / Globals.PageSize);
    String strPhanTrang = MyHtmlHelper.PageLinks(String.Format("Trang {0}/{1}:", CurrentPage, TotalPages), CurrentPage, TotalPages, x => Url.Action("Search", "QLDA_TongDauTu", new { iID_MaDanhMucDuAn = iID_MaDanhMucDuAn, TuNgay = dTuNgay, DenNgay = dDenNgay, page = x }));
    ...
    <tr>
        ...
        <td align="left">
            <div style="padding-bottom: 5px; color:#ec3237;">
                ...
                <%=MyHtmlHelper.ActionLink(Url.Action("Search", "QLDA_TongDauTu"), "Danh sách dự án có tổng đầu tư")%>
            </div>
        </td>
    </tr>
</table>
...
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                    <span>Danh sách dự án đã có tổng đầu tư</span>
                </td>
            </tr>
        </table>
    </div>
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=strColor %>>
                ...
                <td align="left">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "QLDA_TongDauTu", new { iID_MaDanhMucDuAn = R["iID_MaDanhMucDuAn"], dNgayLap = dNgayLap }).ToString(), strTenDoanhNghiep, "Detail", "")%></b>
                </td>
