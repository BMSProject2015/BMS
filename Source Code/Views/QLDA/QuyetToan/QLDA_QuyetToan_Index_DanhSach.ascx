...
<%
    ...
    QLDA_QuyetToan_BangDuLieu bang = new QLDA_QuyetToan_BangDuLieu(iID_MaQuyetToan_SoPhieu, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_QuyetToan", new{iID_MaQuyetToan_SoPhieu=iID_MaQuyetToan_SoPhieu})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        BangDuLieu_iID_MaDanhMucDuAn = '<%=iID_MaQuyetToan_SoPhieu%>';
//        jsQLDA_MucLucNganSach = '<%=Url.Action("get_MucLucNganSach_DuToan", "QLDA_TongDuToan")%>';
        jsQLDA_MucLucNganSach = '<%=Url.Action("get_MucLucNganSach_DuToan", "QLDA_QuyetToan")%>';
        jsQLDA_rSoTienCap = '<%=Url.Action("get_rSoTienCap", "QLDA_QuyetToan")%>';
        jsQLDA_QuyetToan = '<%=Url.Action("get_CapPhat", "QLDA_QuyetToan")%>';
        BangDuLieu_DuocSuaChiTiet = <%=bang.DuocSuaChiTiet?"true":"false"%>;
        <%=bang.DuocSuaChiTiet?"":"Bang_keys.fnSetFocus(null, null);"%>
         iID_MaQuyetToan_SoPhieu=<%=iID_MaQuyetToan_SoPhieu%>
    });
</script>
