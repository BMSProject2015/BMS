...
<div class="box_tong">
    ...
    <table class='mGrid'>
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QLDA_QuyetToan", new { iID_MaQuyetToan_SoPhieu = R["iID_MaQuyetToan_SoPhieu"] }).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "Edit", "");
            strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QLDA_QuyetToan", new { iID_MaQuyetToan_SoPhieu = R["iID_MaQuyetToan_SoPhieu"] }).ToString(), "<img src='../Content/Themes/images/delete.gif' alt='' />", "Delete", "");
