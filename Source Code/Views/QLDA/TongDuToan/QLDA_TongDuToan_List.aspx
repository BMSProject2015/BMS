...
<div class="box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            String strEdit = "";
            String strDelete = "";
            strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QLDA_TongDuToan", new { iID_MaTongDuToan_QuyetDinh = R["iID_MaTongDuToan_QuyetDinh"] }).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "Edit", "");
            strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QLDA_TongDuToan", new { iID_MaTongDuToan_QuyetDinh = R["iID_MaTongDuToan_QuyetDinh"], sSoQuyetDinh = R["sSoQuyetDinh"] }).ToString(), "<img src='../Content/Themes/images/delete.gif' alt='' />", "Delete", "");
            %>
            <tr <%=sClasstr %>>
