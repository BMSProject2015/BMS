...
<%
    ...
    //QLDA_DuToan_Nam_BangDuLieu bang = new QLDA_DuToan_Nam_BangDuLieu(dNgayLap, arrGiaTriTimKiem, MaND, IPSua);
    QLDA_DuToan_Nam_BangDuLieu bang = new QLDA_DuToan_Nam_BangDuLieu(iID_MaDuToanNam_QuyetDinh, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_DuToan_Nam", new{dNgayLap = dNgayLap,iID_MaDuToanNam_QuyetDinh=iID_MaDuToanNam_QuyetDinh})%>" method="post">
    <%
    } %>
