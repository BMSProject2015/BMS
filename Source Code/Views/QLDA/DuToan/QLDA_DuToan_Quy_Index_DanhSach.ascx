...
<%
    ...
    //QLDA_DuToan_Quy_BangDuLieu bang = new QLDA_DuToan_Quy_BangDuLieu(dNgayLap, arrGiaTriTimKiem, MaND, IPSua);
    QLDA_DuToan_Quy_BangDuLieu bang = new QLDA_DuToan_Quy_BangDuLieu(iID_MaDuToanQuy_QuyetDinh, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_DuToan_Quy", new{dNgayLap = dNgayLap,iID_MaDuToanQuy_QuyetDinh=iID_MaDuToanQuy_QuyetDinh,iQuy=iQuy})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        jsQLDA_TongKeHoachVon = '<%= Url.Action("get_GiaTriTongKeHoachVon", "QLDA_DuToan_Quy")%>';
