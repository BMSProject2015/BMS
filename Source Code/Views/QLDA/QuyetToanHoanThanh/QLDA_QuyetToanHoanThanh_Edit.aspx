...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        String iID_MaQuyetToan_SoPhieu = Convert.ToString(ViewData["iID_MaQuyetToanHoanThanh_SoPhieu"]);
        ...
        DataTable dt = QLDA_QuyetToanHoanThanhModels.Get_Row_QuyetToanHoanThanh_SoPhieu(iID_MaQuyetToan_SoPhieu);
        ...
        using (Html.BeginForm("AddNewSubmit", "QLDA_QuyetToanHoanThanh", new { ParentID = ParentID, iID_MaQuyetToanHoanThanh_SoPhieu = iID_MaQuyetToan_SoPhieu }))
        {
    %>
