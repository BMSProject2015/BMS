...
<script src="<%= Url.Content("~/Scripts/QLDA/jsBang_QLDA_QuyetToanHoanThanh.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
...
<%
    ...
    String iID_MaQuyetToanHoanThanh_SoPhieu = Request.QueryString["iID_MaQuyetToanHoanThanh_SoPhieu"];
    ...
    NameValueCollection data = QLDA_QuyetToanHoanThanhModels.LayThongTin(iID_MaQuyetToanHoanThanh_SoPhieu);
%>
            ...
            <tr>
                <td valign="top" align="left" style="width: 50%;">
                    <div id="nhapform">
                        <div id="form2">
                            <%
                            using (Html.BeginForm("SearchSubmit", "QLDA_QuyetToanHoanThanh", new { ParentID = ParentID }))
                            {       
                            %>
        ...
        <div class="box_tong">
            <div class="title_tong">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td>
                            <span>Thông tin quyết toán hoàn thành</span>
                        </td>
                        <td align="right">
            ...
            <div id="nhapform">
                <div id="form2">
                    <table cellpadding="5" cellspacing="5" width="100%">
                        <tr>
                            <td class="td_form2_td1"  style="width: 10%">
                                <div>
                                    <b>Ngày quyết toán hoàn thành</b>&nbsp;<span  style="color:Red;">*</span></div>
                            </td>
                    ...
                    <%Html.RenderPartial("~/Views/QLDA/QuyetToanHoanThanh/QLDA_QuyetToanHoanThanh_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name }); %>
                </div>
            </div>
        </div>
    </div>
