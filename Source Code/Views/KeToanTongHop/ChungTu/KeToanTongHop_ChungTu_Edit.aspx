...
<%
    ...
    DataTable dtChungTu = KeToanTongHop_ChungTuModels.GetChungTu(MaChungTu);
    DataRow R;
    int iSoChungTu = 0, iNgay = 0, iThang = 0, iTapSo = 0;
    String sTienToChungTu="", dNgayChungTu = "", sDonVi="", sNoiDung = "", iID_MaTrangThaiDuyet = "";
    if (dtChungTu.Rows.Count > 0)
    {
        ...
        sDonVi = Convert.ToString(R["sDonVi"]);
        ...
        iTapSo = Convert.ToInt32(R["iTapSo"]);
    }
    else
    {
    ...
    if (ViewData["DuLieuMoi"] == "1")
    {
        ...
        iSoChungTu = KeToanTongHop_ChungTuModels.GetMaxChungTu_GoiY() + 1;
    }
    dtChungTu.Dispose();
    ...
    using (Html.BeginForm("EditSubmit", "KeToanTongHop_ChungTu", new { ParentID = ParentID, MaChungTu = MaChungTu}))
    {
%>
            ...
            <div style="width: 60%; float: left;">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slNgay, Convert.ToString(iNgay) , "iNgay", "", "class=\"input1_2\" style=\"width:17%;\"")%>/
                                <%=MyHtmlHelper.DropDownList(ParentID, slThang, Convert.ToString(iThang), "iThang", "", "class=\"input1_2\" style=\"width:17%;\"")%>
                    ...
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div><%=MyHtmlHelper.TextBox(ParentID, iTapSo, "iTapSo", "", "class=\"input1_2\"")%></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_form2_td1">
                        ...
                        <td class="td_form2_td5">
                            <div><%=MyHtmlHelper.TextBox(ParentID, sDonVi, "sDonVi", "", "class=\"input1_2\"")%></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_form2_td1">
