...
<script src="<%= Url.Content("~/Scripts/KeToanTongHop/jsBang_KeToanTongHop_ChungTuChiTietTuChoi.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
...
<%
    ...
    KeToanTongHop_ChungTuChiTietTuChoi_BangDuLieu bang = new KeToanTongHop_ChungTuChiTietTuChoi_BangDuLieu(iThang, iNam, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KeToanTongHop_ChungTu", new{iNam = iNam, iThang = iThang})%>" method="post">
    <%
    } %>
