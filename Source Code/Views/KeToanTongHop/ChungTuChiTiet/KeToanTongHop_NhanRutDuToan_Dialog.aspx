...
<body>
    <%
        ...
        String iNgay = HamChung.ConvertToString(data["iNgay"]);
        String iNam = HamChung.ConvertToString(data["iNamLamViec"]);
        ...
        DataTable dtTaiKhoan = TaiKhoanModels.DT_DSTaiKhoan_NgoaiBang(false, "", User.Identity.Name);
        SelectOptionList slTaiKhoan = new SelectOptionList(dtTaiKhoan, "iID_MaTaiKhoan", "sTen");
        dtTaiKhoan.Dispose();

        DataTable dt = KeToanTongHop_ChungTuChiTietModels.Lay_DanhSachChungTuChiTietKhoBac_TheoThang(iNam, iThang);

        using (Html.BeginForm("Edit_Fast_Submit_Nhan", "KeToanTongHop_ChungTu", new { ParentID = ParentID, iLoai = 1 }))
        {
    %>
            ...
            <div class="box_tong">
                <div class="title_tong">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td>
                                <span>Danh sách rút dự toán trong tháng:
                                    <%=iThang %></span>
                            </td>
                        </tr>
                    </table>
                            ...
                            <tr>
                                <td style="width: 100%; padding-left: 20px;">
                                    <fieldset style="height: 45px;border-radius: 4px; -moz-border-radius: 4px; -webkit-border-radius: 4px;
                                        cursor: pointer;">
                                        <legend>&nbsp;<b>Thông tin chứng từ</b></legend>
                                    ...
                                    <fieldset style="height: 45px;border-radius: 4px; -moz-border-radius: 4px; -webkit-border-radius: 4px;
                                        cursor: pointer;">
                                        <legend>&nbsp;<b>Định khoản RDT</b></legend>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                                            <tr>
                                                <td style="width: 10%">
                                                ...
                                                <td colspan="3" style="width: 30%">
                                                    <%=MyHtmlHelper.DropDownList(ParentID, slTaiKhoan, sTaiKhoan, "sTaiKHoan", "", "class=\"input1_2\" style=\"width:100%;\"")%>
                                                </td>
                                                <td colspan="2" style="padding-left: 10px;">
                                                    <%=MyHtmlHelper.Option(ParentID, "tkTrong", "tkTrong", "optNoCo", "")%>Bỏ trống
                                                    <%=MyHtmlHelper.Option(ParentID, "tkNo", "tkNo", "optNoCo", "")%>Nợ&nbsp;&nbsp;
                                                    <%=MyHtmlHelper.Option(ParentID, "tkCo", "tkCo", "optNoCo", "")%>Có &nbsp;&nbsp;
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset>
