...
<body>
    <%
        ...
        DataTable dt = KeToanTongHop_ChungTuChiTietModels.Lay_DanhSachChungTuChiTietTienGui_TheoThang(iNam, iThang);

        using (Html.BeginForm("Edit_Fast_Submit_Nhan", "KeToanTongHop_ChungTu", new { ParentID = ParentID, iLoai = 2 }))
        {
    %>
            ...
            <div class="box_tong">
                <div class="title_tong">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td>
                                <span>Danh sách ủy nhiệm chi trong tháng:
                                    <%=iThang %></span>
                            </td>
                        </tr>
                    </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="margin-right: 5px;">
                                                            <%=MyHtmlHelper.TextBox(ParentID, sSoGhiSo + 1, "sSoChungTu", "", "class=\"input1_2\" style=\"width:100%;\" maxlength='12'")%>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
