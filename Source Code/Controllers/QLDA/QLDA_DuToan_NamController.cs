...
{
    public class QLDA_DuToan_NamController : Controller
    {
        //
        // GET: /QLDA_DuToan_Nam/
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult DetailSubmit(String dNgayLap, String iID_MaDuToanNam_QuyetDinh)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult EditSubmit(String ParentID, String iID_MaDuToanNam_QuyetDinh)
        {
        ...
        [Authorize]
        public ActionResult Edit(String iID_MaDuToanNam_QuyetDinh)
        {
        ...
        [Authorize]
        public ActionResult Delete(String iID_MaDuToanNam_QuyetDinh)
        {
