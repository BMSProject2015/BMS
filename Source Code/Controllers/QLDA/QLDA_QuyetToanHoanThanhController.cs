...
{
    public class QLDA_QuyetToanHoanThanhController : Controller
    {
        //
        ...
        [Authorize]
        public ActionResult Delete(String iID_MaQuyetToanHoanThanh_SoPhieu)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult DetailSubmit(String iID_MaQuyetToanHoanThanh_SoPhieu)
        {
            DataTable dtCauHinh = NguoiDungCauHinhModels.LayCauHinh(User.Identity.Name);
