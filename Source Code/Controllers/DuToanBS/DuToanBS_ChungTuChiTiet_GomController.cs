    ...
    public class DuToanBS_ChungTuChiTiet_GomController : Controller
    {
        ...
        public ActionResult TrinhDuyet(String iID_MaChungTu,String iLoai,String sLNS)
        {
            ...
            if (sLNS.StartsWith("1040100"))
                iID_MaTrangThaiDuyet_TrinhDuyet = DuToanBS_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_Gom_BaoDam_TrinhDuyet(MaND, iID_MaChungTu);
            else
            ...
            String SQL = "";
            SQL = String.Format(@"UPDATE DTBS_ChungTu_TLTH SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet_TrinhDuyet WHERE iID_MaChungTu_TLTH=@iID_MaChungTu");
            ...
            SQL = String.Format(@"UPDATE DTBS_ChungTu SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet_TrinhDuyet WHERE iTrangThai=1 AND ({0})",DK);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iID_MaTrangThaiDuyet_TrinhDuyet", iID_MaTrangThaiDuyet_TrinhDuyet);
            Connection.UpdateDatabase(cmd);
            cmd.Dispose();
            ...
            for (int j = 0; j < arrChungtu.Length; j++)
            {
                DuToanBS_ChungTuModels.Update_iID_MaTrangThaiDuyet(arrChungtu[j], iID_MaTrangThaiDuyet_TrinhDuyet, false, MaND, Request.UserHostAddress);
            }
            if (iLoai == "1")
            {
                if (sLNS == "1040100")
                    return RedirectToAction("Index", "DuToanBS_ChungTu_BaoDam", new { sLNS = sLNS, iLoai = iLoai });
                else
                    return RedirectToAction("Index", "DuToanBS_ChungTu", new { sLNS1 = sLNS, iLoai = iLoai });
            }
            return RedirectToAction("ChungTuChiTiet_Frame", new { iID_MaChungTu = iID_MaChungTu, sLNS = sLNS });
        }
        [Authorize]
        public ActionResult TrinhDuyet_THCuc(String iID_MaChungTu, String iLoai, String sLNS)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
            int iID_MaTrangThaiDuyet_TrinhDuyet = DuToanBS_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_Gom_THCuc_TrinhDuyet(MaND, iID_MaChungTu);
            if (iID_MaTrangThaiDuyet_TrinhDuyet <= 0)
            {
                return RedirectToAction("Index", "PermitionMessage");
            }
            ...
            SQL = String.Format(@"UPDATE DTBS_ChungTu_TLTHCuc SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet_TrinhDuyet WHERE iID_MaChungTu_TLTHCuc=@iID_MaChungTu");
            SqlCommand cmd = new SqlCommand(SQL);
            cmd.Parameters.AddWithValue("@iID_MaTrangThaiDuyet_TrinhDuyet", iID_MaTrangThaiDuyet_TrinhDuyet);
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
            Connection.UpdateDatabase(cmd);
            ...
            //update trangthai bang DTBS_ChungTu_TLTH
            String DK = "";
            String iID_MaChungTu_TLTH = Convert.ToString(CommonFunction.LayTruong("DTBS_ChungTu_TLTHCuc", "iID_MaChungTu_TLTHCuc", iID_MaChungTu, "iID_MaChungTu_TLTH"));
            ...
            SQL = String.Format(@"UPDATE DTBS_ChungTu_TLTH SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet_TrinhDuyet WHERE iTrangThai=1 AND ( {0})",DK);
            cmd.Parameters.AddWithValue("@iID_MaTrangThaiDuyet_TrinhDuyet", iID_MaTrangThaiDuyet_TrinhDuyet);
            cmd.CommandText = SQL;
            Connection.UpdateDatabase(cmd);
            ...
            {
                String s = "";
                s = Convert.ToString(CommonFunction.LayTruong("DTBS_ChungTu_TLTH", "iID_MaChungTu_TLTH", arrChungtu[j], "iID_MaChungTu"));
                iID_MaChungTu_CT += s + ",";
            }
        ...
        public ActionResult TuChoi(String iID_MaChungTu, String iLoai, String sLNS)
        {
            ...
            if (sLNS.StartsWith("1040100"))
                iID_MaTrangThaiDuyet_TuChoi = DuToanBS_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_Gom_BaoDam_TuChoi(MaND, iID_MaChungTu);
            else
            ...
            for (int j = 0; j < arrChungtu.Length; j++)
            {
                DuToanBS_ChungTuModels.Update_iID_MaTrangThaiDuyet(arrChungtu[j], iID_MaTrangThaiDuyet_TuChoi, false, MaND, Request.UserHostAddress);
            }
            if (iLoai == "1")
            {
                if (sLNS == "1040100")
        ...
        public ActionResult TuChoi_THCuc(String iID_MaChungTu, String iLoai, String sLNS)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
            int iID_MaTrangThaiDuyet_TrinhDuyet = DuToanBS_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_Gom_THCuc_TuChoi(MaND, iID_MaChungTu);
            if (iID_MaTrangThaiDuyet_TrinhDuyet <= 0)
            {
                return RedirectToAction("Index", "PermitionMessage");
            }
