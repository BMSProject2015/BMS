...
function BangDuLieu_TinhOConLai(h, c) {
    if (Bang_arrMaCot[c] == "sTenDuAn") {
        ...
        $.getJSON(url, function (item) {
            ...
            Bang_GanGiaTriThatChoO(h, c + 23, item.iID_MaMucLucNganSach);
            Bang_GanGiaTriThatChoO(h, c + 24, item.sXauNoiMa);
        });
    }
    if (Bang_arrMaCot[c] == "rSoTienDauNam") {
        var rSoTienDauNam = Bang_arrGiaTri[h][c];
        var rSoTienDieuChinh = Bang_arrGiaTri[h][c + 6];
        var sotien = parseFloat(rSoTienDauNam) + parseFloat(rSoTienDieuChinh);
        Bang_GanGiaTriThatChoO_colName(h, "rTongTien", sotien);
    }
    if (Bang_arrMaCot[c] == "rNgoaiTe_SoTienDauNam") {
        var rNgoaiTe_SoTienDauNam = Bang_arrGiaTri[h][c];
        var rNgoaiTe_SoTienDieuChinh = Bang_arrGiaTri[h][c + 6];
        var sotien = parseFloat(rNgoaiTe_SoTienDauNam) + parseFloat(rNgoaiTe_SoTienDieuChinh);
        Bang_GanGiaTriThatChoO_colName(h, "rTongNgoaiTeTrongDo", sotien);
    }
    if (Bang_arrMaCot[c] == "rNgoaiTe_DauNam") {
        var rNgoaiTe_DauNam = Bang_arrGiaTri[h][c];
        var rNgoaiTe_DieuChinh = Bang_arrGiaTri[h][c + 6];
        var sotien = parseFloat(rNgoaiTe_DauNam) + parseFloat(rNgoaiTe_DieuChinh);
        Bang_GanGiaTriThatChoO_colName(h, "rTongNgoaiTeDieuChinh", sotien);
    }
    if (Bang_arrMaCot[c] == "rSoTienDieuChinh") {
        var rSoTienDieuChinh = Bang_arrGiaTri[h][c];
        var rSoTienDauNam = Bang_arrGiaTri[h][c - 6];
        var sotien = parseFloat(rSoTienDauNam) + parseFloat(rSoTienDieuChinh);
        Bang_GanGiaTriThatChoO_colName(h, "rTongTien", sotien);
    }
    if (Bang_arrMaCot[c] == "rNgoaiTe_SoTienDieuChinh") {
        var rNgoaiTe_SoTienDieuChinh = Bang_arrGiaTri[h][c];
        var rNgoaiTe_SoTienDauNam = Bang_arrGiaTri[h][c - 6];
        var sotien = parseFloat(rNgoaiTe_SoTienDauNam) + parseFloat(rNgoaiTe_SoTienDieuChinh);
        Bang_GanGiaTriThatChoO_colName(h, "rTongNgoaiTeTrongDo", sotien);
    }
    if (Bang_arrMaCot[c] == "rNgoaiTe_DieuChinh") {
        var rNgoaiTe_DieuChinh = Bang_arrGiaTri[h][c];
        var rNgoaiTe_DauNam = Bang_arrGiaTri[h][c - 6];
        var sotien = parseFloat(rNgoaiTe_DauNam) + parseFloat(rNgoaiTe_DieuChinh);
        Bang_GanGiaTriThatChoO_colName(h, "rTongNgoaiTeDieuChinh", sotien);
    }
}
