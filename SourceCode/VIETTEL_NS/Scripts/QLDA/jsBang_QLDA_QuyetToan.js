...
var jsQLDA_rSoTienCap = "";
var iID_MaQuyetToan_SoPhieu = "";
...
function BangDuLieu_TinhOConLai(h, c) {
    if (Bang_arrMaCot[c] == "sTenDuAn") {
        var iID_MaDanhMucDuAn = Bang_arrGiaTri[h][c + 13];
        ...
        $.getJSON(url, function (item) {
            ...
            Bang_GanGiaTriThatChoO(h, c + 14, item.iID_MaMucLucNganSach);
            Bang_GanGiaTriThatChoO(h, c + 15, item.sXauNoiMa);
            var urlrSoTienCap = jsQLDA_rSoTienCap;
            urlrSoTienCap += "?iID_MaDanhMucDuAn=" + iID_MaDanhMucDuAn + "&sXauNoiMa=" + sXauNoiMa + "&iID_MaQuyetToan_SoPhieu=" + iID_MaQuyetToan_SoPhieu;
            $.getJSON(urlrSoTienCap, function (itemValue) {
                Bang_GanGiaTriThatChoO(h, c + 10, itemValue.rSoTienCap);
            });
        });
    }
}
