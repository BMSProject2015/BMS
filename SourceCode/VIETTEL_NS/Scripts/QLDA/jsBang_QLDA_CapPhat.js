...
function BangDuLieu_TinhOConLai(h, c) {
    if (Bang_arrMaCot[c] == "sLoaiKeHoachVon") {
        var MaHopDong = iID_MaHopDong;
        var MaDuAn = iID_MaDanhMucDuAn;
        jQuery.ajaxSetup({ cache: false });
        var vR;
        var url = jsQLDA_MucLucNganSach;
        url += "?iID_MaHopDong=" + MaHopDong + "&iID_MaDanhMucDuAn=" + MaDuAn;
        $.getJSON(url, function (item) {
            ...
            Bang_GanGiaTriThatChoO(h, c + 51, item.iID_MaMucLucNganSach);
            Bang_GanGiaTriThatChoO(h, c + 52, item.sXauNoiMa);
        });
    }
    if (Bang_arrMaCot[c] == "rChuDauTuTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c];
        var GiaTri2 = Bang_arrGiaTri[h][c + 4];
        var GiaTri3 = Bang_arrGiaTri[h][c + 8];
        var GiaTri4 = Bang_arrGiaTri[h][c + 12];
        var GiaTri5 = Bang_arrGiaTri[h][c + 16];
        Bang_GanGiaTriThatChoO(h, c + 16, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
        Bang_GanGiaTriThatChoO(h, c + 20, GiaTri1);
        Bang_GanGiaTriThatChoO(h, c + 36, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
    }
    else if (Bang_arrMaCot[c] == "rNgoaiTe_ChuDauTuTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c];
        var GiaTri2 = Bang_arrGiaTri[h][c + 4];
        var GiaTri3 = Bang_arrGiaTri[h][c + 8];
        var GiaTri4 = Bang_arrGiaTri[h][c + 12];
    ...
    else if (Bang_arrMaCot[c] == "rChuDauTuThanhToan") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 4];
        var GiaTri2 = Bang_arrGiaTri[h][c];
        var GiaTri3 = Bang_arrGiaTri[h][c + 4];
        var GiaTri4 = Bang_arrGiaTri[h][c + 8];
        Bang_GanGiaTriThatChoO(h, c + 12, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
        Bang_GanGiaTriThatChoO(h, c + 20, GiaTri2);
        Bang_GanGiaTriThatChoO(h, c + 32, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
    }
    else if (Bang_arrMaCot[c] == "rNgoaiTe_ChuDauTuThanhToan") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 4];
        var GiaTri2 = Bang_arrGiaTri[h][c];
        var GiaTri3 = Bang_arrGiaTri[h][c + 4];
        var GiaTri4 = Bang_arrGiaTri[h][c + 8];
    ...
    else if (Bang_arrMaCot[c] == "rChuDauTuThuTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 8];
        var GiaTri2 = Bang_arrGiaTri[h][c - 4];
        var GiaTri3 = Bang_arrGiaTri[h][c];
        var GiaTri4 = Bang_arrGiaTri[h][c + 4];
        Bang_GanGiaTriThatChoO(h, c + 8, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
        Bang_GanGiaTriThatChoO(h, c + 20, GiaTri3);
        Bang_GanGiaTriThatChoO(h, c + 28, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
    }
    else if (Bang_arrMaCot[c] == "rNgoaiTe_ChuDauTuThuTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 8];
        var GiaTri2 = Bang_arrGiaTri[h][c - 4];
        var GiaTri3 = Bang_arrGiaTri[h][c];
        var GiaTri4 = Bang_arrGiaTri[h][c + 4];
    ...
    else if (Bang_arrMaCot[c] == "rChuDauTuThuKhac") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 12];
        var GiaTri2 = Bang_arrGiaTri[h][c - 8];
        var GiaTri3 = Bang_arrGiaTri[h][c - 4];
        var GiaTri4 = Bang_arrGiaTri[h][c];
        Bang_GanGiaTriThatChoO(h, c + 4, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
        Bang_GanGiaTriThatChoO(h, c + 20, GiaTri4);
        Bang_GanGiaTriThatChoO(h, c + 24, GiaTri1 + GiaTri2 - GiaTri3 - GiaTri4);
    }
    else if (Bang_arrMaCot[c] == "rNgoaiTe_ChuDauTuThuKhac") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 12];
        var GiaTri2 = Bang_arrGiaTri[h][c - 8];
        var GiaTri3 = Bang_arrGiaTri[h][c - 4];
        var GiaTri4 = Bang_arrGiaTri[h][c];
    ...
    else if (Bang_arrMaCot[c] == "rDeNghiPheDuyetTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c];
        var GiaTri2 = Bang_arrGiaTri[h][c+4];
        var GiaTri3 = Bang_arrGiaTri[h][c+8];
        var GiaTri4 = Bang_arrGiaTri[h][c+12];
    ...
    else if (Bang_arrMaCot[c] == "rNgoaiTe_DeNghiPheDuyetTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c];
        var GiaTri2 = Bang_arrGiaTri[h][c + 4];
        var GiaTri3 = Bang_arrGiaTri[h][c + 8];
        var GiaTri4 = Bang_arrGiaTri[h][c + 12];
    ...
    else if (Bang_arrMaCot[c] == "rDeNghiPheDuyetThanhToan") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 4];
        var GiaTri2 = Bang_arrGiaTri[h][c];
        var GiaTri3 = Bang_arrGiaTri[h][c + 4];
        var GiaTri4 = Bang_arrGiaTri[h][c + 8];
    ...
    else if (Bang_arrMaCot[c] == "rNgoaiTe_DeNghiPheDuyetThanhToan") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 4];
        var GiaTri2 = Bang_arrGiaTri[h][c];
        var GiaTri3 = Bang_arrGiaTri[h][c + 4];
        var GiaTri4 = Bang_arrGiaTri[h][c + 8];
    ...
    else if (Bang_arrMaCot[c] == "rDeNghiPheDuyetThuTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 8];
        var GiaTri2 = Bang_arrGiaTri[h][c - 4];
        var GiaTri3 = Bang_arrGiaTri[h][c];
        var GiaTri4 = Bang_arrGiaTri[h][c + 4];
    ...
    else if (Bang_arrMaCot[c] == "rNgoaiTe_DeNghiPheDuyetThuTamUng") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 8];
        var GiaTri2 = Bang_arrGiaTri[h][c - 4];
        var GiaTri3 = Bang_arrGiaTri[h][c];
        var GiaTri4 = Bang_arrGiaTri[h][c + 4];
    ...
    else if (Bang_arrMaCot[c] == "rDeNghiPheDuyetThuKhac") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 12];
        var GiaTri2 = Bang_arrGiaTri[h][c - 8];
        var GiaTri3 = Bang_arrGiaTri[h][c - 4];
        var GiaTri4 = Bang_arrGiaTri[h][c];
    ...
    else if (Bang_arrMaCot[c] == "rNgoaiTe_DeNghiPheDuyetThuKhac") {
        var GiaTri1 = Bang_arrGiaTri[h][c - 12];
        var GiaTri2 = Bang_arrGiaTri[h][c - 8];
        var GiaTri3 = Bang_arrGiaTri[h][c - 4];
        var GiaTri4 = Bang_arrGiaTri[h][c];
...
function BangDuLieu_onKeypress_F2(h, c) {
    if (BangDuLieu_DuocSuaChiTiet && h < Bang_nH - 1) {
        ...
        var arrTruongTien = "rChuDauTuTamUng,rNgoaiTe_ChuDauTuTamUng,rTyGia_ChuDauTuTamUng,rChuDauTuThanhToan,rNgoaiTe_ChuDauTuThanhToan,rTyGia_ChuDauTuThanhToan,rChuDauTuThuTamUng,rNgoaiTe_ChuDauTuThuTamUng,rTyGia_ChuDauTuThuTamUng,rChuDauTuThuKhac,rNgoaiTe_ChuDauTuThuKhac,rTyGia_ChuDauTuThuKhac,rChuDauTuDonViThuHuong,rNgoaiTe_ChuDauTuDonViThuHuong,rTyGia_ChuDauTuDonViThuHuong,rDeNghiPheDuyetTamUng,rNgoaiTe_DeNghiPheDuyetTamUng,rTyGia_DeNghiPheDuyetTamUng,rDeNghiPheDuyetThanhToan,rNgoaiTe_DeNghiPheDuyetThanhToan,rTyGia_DeNghiPheDuyetThanhToan,rDeNghiPheDuyetThuTamUng,rNgoaiTe_DeNghiPheDuyetThuTamUng,rTyGia_DeNghiPheDuyetThuTamUng,rDeNghiPheDuyetThuKhac,rNgoaiTe_DeNghiPheDuyetThuKhac,rTyGia_DeNghiPheDuyetThuKhac,rDeNghiPheDuyetDonViThuHuong,rNgoaiTe_DeNghiPheDuyetDonViThuHuong,rTyGia_DeNghiPheDuyetDonViThuHuong".split(',');
...
/* Su kien BangDuLieu_CapNhapSTT
- Muc dinh: cap nhap so thu tu cho bang
*/
