...
function BangDuLieu_onCellAfterEdit(h, c) {
    ...
    if (Bang_arrMaCot[c] == 'sSoChungTu') {
        ...
        var url = urlServerPath + "KTCT_KhoBac_ChungTuChiTiet/get_ThongTinChungTuMoi?iNamLamViec=" + iNamLamViec;
        ...
        $.getJSON(url, function (item) {
            if (item.Trung) {
                ...
                url = urlServerPath + "KTCT_KhoBac_ChungTuChiTiet/get_ThongTinChungTuMoi?iNamLamViec=" + iNamLamViec;
                $.getJSON(url, function (item) {
                    var cs;
                    iID_MaChungTu = item.iID_MaChungTu;
                    cs = Bang_arrCSMaCot["sSoChungTu"];
