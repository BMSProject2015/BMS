...
function BangDuLieu_onCellAfterEdit(h, c) {
    ...
    var url = urlServerPath + "KTCT_TienGui_ChungTuChiTiet/get_ThongTinChungTuMoi?iNamLamViec=" + iNamLamViec;
    var sSoChungTu;
    var iID_MaChungTu;
    if (Bang_arrMaCot[c] == 'sSoChungTu') {
        ...
        iID_MaChungTu = Bang_arrMaHang[h]
        ...
        $.getJSON(url, function (item) {
            if (item.Trung) {
                ...
                url = urlServerPath + "KTCT_TienGui_ChungTuChiTiet/get_ThongTinChungTuMoi?iNamLamViec=" + iNamLamViec;
                $.getJSON(url, function (item) {
                    var cs;
                    iID_MaChungTu = item.iID_MaChungTu;
                    cs = Bang_arrCSMaCot["sSoChungTu"];
