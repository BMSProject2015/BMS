...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_TongHop_TongHopController : Controller
    {
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_TongHop_1010000(String MaND, String iID_MaPhongBan)
        {
...
rTuChi=SUM(rTuChi/{3})
 ...
 ", "", DKPhongBan, DKDonVi, DVT);
        ...
        public static DataTable DT_rptDuToan_TongHop_NV(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
,rHienVat=SUM(rHienVat/{3})
 ...
 ", "", DKPhongBan, DKDonVi, DVT);
        ...
        public static DataTable DT_rptDuToan_TongHop_XDCB(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
rTuChi=SUM(rTuChi/{3})
 FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1  AND( sLNS='1030100') AND iNamLamViec=@iNamLamViec {1} {2}
 ", "", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            DataTable dt = Connection.GetDataTable(cmd);
        ...
        public static DataTable DT_rptDuToan_TongHop_DN(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
rTuChi=SUM(rTuChi/{3})
 FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1  AND( sLNS LIKE '105%')  AND iNamLamViec=@iNamLamViec {1} {2}
 ", "", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            DataTable dt = Connection.GetDataTable(cmd);
        ...
        public static DataTable DT_rptDuToan_TongHop_Khac(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
rTuChi=SUM(rTuChi/{3})
 FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1  AND( sLNS LIKE '109%')  AND iNamLamViec=@iNamLamViec {1} {2}
 ", "", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            DataTable dt = Connection.GetDataTable(cmd);
        ...
        public static DataTable DT_rptDuToan_ThuNop(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            //  DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1 AND  sLNS LIKE '8%'  AND iNamLamViec=@iNamLamViec {0} {1}", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            DataTable dt = Connection.GetDataTable(cmd);
            cmd.Dispose();
        ...
        public static DataTable DT_rptDuToan_TongHop_BD(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
,rHangNhap=SUM(rHangNhap/{3})
 FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1  AND( sLNS LIKE '104%')  AND iNamLamViec=@iNamLamViec {1} {2}
 ", "", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            DataTable dt = Connection.GetDataTable(cmd);
...
rTuChi=SUM(rTonKho/{3})
 ...
 ", "", DKPhongBan, DKDonVi, DVT);
        ...
        public static DataTable DT_rptDuToan_TongHop_NN(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
rTuChi=SUM(rTuChi/{3})
 FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1  AND( sLNS LIKE '2%') AND iNamLamViec=@iNamLamViec {1} {2}
 ", "", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            DataTable dt = Connection.GetDataTable(cmd);
        ...
        public static DataTable DT_rptDuToan_TongHop_KPKhac(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
...
rTuChi=SUM(rTuChi/{3})
 FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1  AND( sLNS LIKE '4%')  AND iNamLamViec=@iNamLamViec {1} {2}
 ", "", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            DataTable dt = Connection.GetDataTable(cmd);
