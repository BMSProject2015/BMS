...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_1020000_TungDonViController : Controller
    {
        ...
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020000_TungDonVi.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020000_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1020000_TungDonVi(String MaND,String iID_MaDonVi)
        {
...
,rHienVat=SUM(rHienVat/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1020000' AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec {1} {2}
