...
{
    public class rptDuToan_ThuNop_TongHopController : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_ThuNop_TongHop.xls";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_ThuNop_TongHop");
...
_8010101=SUM(CASE WHEN sLNS=8010101 THEN rTuChi/{2} ELSE 0 END),
_8010102=SUM(CASE WHEN sLNS=8010102 THEN rTuChi/{2} ELSE 0 END),
_8010103=SUM(CASE WHEN sLNS=8010103 THEN rTuChi/{2} ELSE 0 END),
_ThuCanDoiKhac=SUM(CASE WHEN (sLNS LIKE '80101%' AND sLNS NOT IN (8010101,8010102,8010103)) THEN rTuChi/{2} ELSE 0 END),
_8010201=SUM(CASE WHEN sLNS=8010201 THEN rTuChi/{2} ELSE 0 END),
_8010202=SUM(CASE WHEN sLNS=8010202 THEN rTuChi/{2} ELSE 0 END),
_8010203=SUM(CASE WHEN sLNS=8010203 THEN rTuChi/{2} ELSE 0 END),
_8010204=SUM(CASE WHEN sLNS=8010204 THEN rTuChi/{2} ELSE 0 END),
_ThuQuanLyKhac=SUM(CASE WHEN  (sLNS LIKE '80102%' AND sLNS NOT IN (8010201,8010202,8010203,8010204)) THEN rTuChi/{2} ELSE 0 END),
_ThuNhaNuoc=SUM(CASE WHEN sLNS LIKE '802%' THEN rTuChi/{2} ELSE 0 END)
FROM DT_ChungTuChiTiet
 ...
 GROUP BY iID_MaDonVi,sTenDonVi", DKPhongBan, DKDonVi, DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_ThuNop_TongHop(MaND, iID_MaPhongBan);
