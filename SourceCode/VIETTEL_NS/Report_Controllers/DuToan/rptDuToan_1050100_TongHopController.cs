...
{
    public class rptDuToan_1050100_TongHopController : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1050100_TongHop.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1050100_TongHop.aspx";
            ViewData["PageLoad"] = "0";
...
,rHienVat=SUM(rHienVat/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1050100'  AND iNamLamViec=@iNamLamViec {1} {2}
