...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_ThuNop_TungDonViController : Controller
    {
        ...
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_ThuNop_TungDonVi.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_ThuNop_TungDonVi.aspx";
                ViewData["PageLoad"] = "0";
...
FROM DT_ChungTuChiTiet
 WHERE iTrangThai=1 AND  sLNS LIKE '8%' AND iID_MaDonVi =@iID_MaDonVi  AND iNamLamViec=@iNamLamViec {0} {1}
 GROUP BY sLNS,sMoTa", DKPhongBan, DKDonVi, DVT,iID_MaDonVi);
            cmd.CommandText = SQL;
