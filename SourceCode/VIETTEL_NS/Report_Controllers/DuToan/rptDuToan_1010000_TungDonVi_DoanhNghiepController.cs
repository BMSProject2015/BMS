...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class  rptDuToan_1010000_TungDonVi_DoanhNghiepController : Controller
    {
        ...
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1010000_TungDonVi_DoanhNghiep.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1010000_TungDonVi_DoanhNghiep.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1010000_TungDonVi_DoanhNghiep");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1010000_TungDonVi_DoanhNghiep(String MaND,String iID_MaDonVi)
        {
            ...
            int DVT = 1000;
            String iID_MaPhongBanQuanLy = DonViModels.getPhongBanCuaDonVi(iID_MaDonVi);
...
,rChiTapChung=SUM(rChiTapTrung/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1010000' AND iID_MaDonVi =@iID_MaDonVi AND iID_MaPhongBan<>@MaPhongBanQL AND iNamLamViec=@iNamLamViec {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi
HAVING SUM(rTuChi)<> 0 OR SUM(rChiTapTrung)<>0 ", iID_MaDonVi,DKPhongBan,DKDonVi,DVT);
            cmd.CommandText = SQL;
