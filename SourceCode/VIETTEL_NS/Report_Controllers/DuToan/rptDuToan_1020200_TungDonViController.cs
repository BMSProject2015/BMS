...
{
    public class rptDuToan_1020200_TungDonViController : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020200_TungDonVi.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020200_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1020200_TungDonVi(String MaND,String iID_MaDonVi)
        {
...
,rHangNhap=SUM(rHangNhap/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1020200' AND iID_MaDonVi =@iID_MaDonVi  AND iNamLamViec=@iNamLamViec {1} {2}
