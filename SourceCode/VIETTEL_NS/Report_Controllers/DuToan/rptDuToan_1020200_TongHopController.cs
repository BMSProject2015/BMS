...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_1020200_TongHopController : Controller
    {
        ...
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020200_TongHop.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020200_TongHop.aspx";
            ViewData["PageLoad"] = "0";
...
,rHangNhap=SUM(rHangNhap/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1020200' AND iNamLamViec=@iNamLamViec {0} {1} {2}
