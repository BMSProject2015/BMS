...
{
    public class rptDuToan_109_TongHopController : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_109_TongHop.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_109_TongHop.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_109_TongHop");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_109_TongHop(String MaND,String iID_MaPhongBan)
        {
            ...
            int DVT = 1000;
            String SQL = String.Format(@"SELECT sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaPhongBan
,rTuChi=SUM(rTuChi/{3})
...
,rDuPhong=SUM(rDuPhong/{3})
 ...
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaPhongBan", "", DKPhongBan, DKDonVi, DVT);
            cmd.CommandText = SQL;
