...
{
    public class rptDuToan_BieuKiem_1020800Controller : Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_BieuKiem_1020800.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_BieuKiem_1020800.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String iID_MaTrangThaiDuyet)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_BieuKiem_1020800");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_BieuKiem_1020800(String MaND, String iID_MaTrangThaiDuyet)
        {
            ...
            String SQL = String.Format(@"SELECT *
                                        ...
                                        WHERE iTrangThaI=1  {0} AND sLNS IN('1020800') {1}
        ...
        {
            DataTable data = DT_rptDuToan_BieuKiem_1020800( MaND, iID_MaTrangThaiDuyet);
