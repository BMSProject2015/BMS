...
{
    public class rptKHV_Bieu02VDTController : Controller
    {
        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/QLDA/rptKHV_Bieu02VDT.xls";
        ...
        {
            ViewData["path"] = "~/Report_Views/QLDA/rptKHV_Bieu02VDT.aspx";
        ...
        public ExcelFile CreateReport(String path, String NgoaiTe, String dNgay)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptKHV_Bieu02VDT");
