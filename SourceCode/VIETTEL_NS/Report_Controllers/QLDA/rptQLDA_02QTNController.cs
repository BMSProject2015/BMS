...
{
    public class rptQLDA_02QTNController : Controller
    {
        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/QLDA/rptQLDA_02QTN.xls";
        ...
        {
            ViewData["path"] = "~/Report_Views/QLDA/rptQLDA_02QTN.aspx";
        ...
        public ExcelFile CreateReport(String path, String NgoaiTe, String dNgay)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptQLDA_02QTN");
        ...
        public clsExcelResult ExportToExcel(String NgoaiTe, string vidDenNgay)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                ms.Position = 0;
                clsResult.ms = ms;
                clsResult.FileName = "rptQLDA_02QTN" + String.Format("{0:ddMMyyyyhhmmss}", DateTime.Now) + ".xls";
                clsResult.type = "xls";
                return clsResult;
            }
        }
