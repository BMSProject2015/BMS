...
{
    public class rptQLDA_03_CPController : Controller
    {
        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/QLDA/rptQLDA_03_CP.xls";
        public ActionResult Index()
        {
            ViewData["path"] = "~/Report_Views/QLDA/rptQLDA_03_CP.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public static DataTable dt_rptQLDA_03_CP(String iID_MaDotCapPhat, String MaND,String MaTien)
        {
...
SUM(CASE WHEN iNamLamViec=@iNamLamViec AND iID_MaLoaiKeHoachVon=1 THEN {2} ELSE 0 END) <> 0
        ...
        public ExcelFile CreateReport(String path, String iID_MaDotCapPhat, String MaND,String MaTien)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptQLDA_03_CP");
        ...
        private void LoadData(FlexCelReport fr, String iID_MaDotCapPhat, String MaND,String MaTien)
        {
            ...
            DataTable data = dt_rptQLDA_03_CP(iID_MaDotCapPhat, MaND, MaTien);
