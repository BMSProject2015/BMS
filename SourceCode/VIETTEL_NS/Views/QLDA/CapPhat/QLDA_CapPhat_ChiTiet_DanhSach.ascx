...
<%
    ...
    QLDA_CapPhatChiTiet_BangDuLieu bang = new QLDA_CapPhatChiTiet_BangDuLieu(iID_MaDotCapPhat, iID_MaHopDong, iID_MaDanhMucDuAn, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("ChiTietSubmit", "QLDA_CapPhat", new{iID_MaDotCapPhat = iID_MaDotCapPhat})%>" method="post">
    <%
    } %>
