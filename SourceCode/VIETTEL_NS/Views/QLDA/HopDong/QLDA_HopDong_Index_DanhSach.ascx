...
<%
    ...
    QLDA_HopDong_BangDuLieu bang = new QLDA_HopDong_BangDuLieu(iID_MaHopDong, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_HopDong", new{iID_MaHopDong=iID_MaHopDong})%>" method="post">
    <%
    } %>
