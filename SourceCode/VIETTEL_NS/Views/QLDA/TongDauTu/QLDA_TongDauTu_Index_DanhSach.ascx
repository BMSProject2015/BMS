...
<%
    ...
    QLDA_TongDauTu_BangDuLieu bang = new QLDA_TongDauTu_BangDuLieu(sSoQuyetDinh, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_TongDauTu", new{sSoQuyetDinh=sSoQuyetDinh,iID_MaTongDauTu_QuyetDinh=iID_MaTongDauTu_QuyetDinh})%>" method="post">
    <%
    } %>
