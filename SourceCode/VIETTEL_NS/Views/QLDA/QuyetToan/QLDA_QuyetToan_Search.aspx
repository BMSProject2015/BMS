...
<%
    ...
    DataTable dt = QLDA_QuyetToanModels.Get_DanhSach(iID_MaDanhMucDuAn, iNam, dTuNgay, dDenNgay, CurrentPage, Globals.PageSize);

    double nums = QLDA_QuyetToanModels.Get_DanhSach_Count(iID_MaDanhMucDuAn, iNam, dTuNgay, dDenNgay);
...
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                    <span>Danh sách tìm kiếm quyết toán</span>
                </td>
            </tr>
        </table>
    </div>
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=strColor %>>
                ...
                <td align="left">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "QLDA_QuyetToan", new { iID_MaDanhMucDuAn = R["iID_MaDanhMucDuAn"], dNgayLap = dNgayLap }).ToString(), strTenDoanhNghiep, "Detail", "")%></b>
                </td>
