...
<%
    ...
    QLDA_KeHoachVon_BangDuLieu bang = new QLDA_KeHoachVon_BangDuLieu(iID_KeHoachVon_QuyetDinh, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_KeHoachVon", new{iLoaiKeHoachVon=iLoaiKeHoachVon, dNgayKeHoachVon = dNgayKeHoachVon,iID_KeHoachVon_QuyetDinh=iID_KeHoachVon_QuyetDinh})%>" method="post">
    <%
    } %>
