...
<script src="<%= Url.Content("~/Scripts/QLDA/jsBang_QLDA_TongDuToan.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
...
<%
    ...
    String iID_MaTongDuToan_QuyetDinh = Request.QueryString["iID_MaTongDuToan_QuyetDinh"];
    ...
    if(sSoQuyetDinh_Cu != null && sSoQuyetDinh_Cu != ""){
        if (QLDA_TongDuToanModels.CheckSoQuyetDinhTrongTongDuToan(sSoQuyetDinh) == 0 )
        {
            QLDA_TongDuToanModels.DienDuLieuCuaSoQuyetDinhCu(sSoQuyetDinh, sSoQuyetDinh_Cu, User.Identity.Name, Request.UserHostAddress);
        }
    }
%>
    ...
    <div id="pHeader" class="collapsePanelHeader"> 
        <div id="dvHeaderText" class="HeaderContent" style="width: 80%;">
            <div style="width: 100%; float: left;">
                <span><%=NgonNgu.LayXau("Tìm kiếm thông tin tổng dự toán")%></span>
            </div>
        </div>
        ...
        <div class="box_tong">
            <div class="title_tong">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td>
                            <span>Thông tin tổng dự toán</span>
                        </td>
                        <td align="right">
            ...
            <div id="nhapform">
                <div id="form2">
                    ...
                    <%Html.RenderPartial("~/Views/QLDA/TongDuToan/QLDA_TongDuToan_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name }); %>
                </div>
            </div>
        </div>
    </div>
