...
<%
    ...
    QLDA_TongDuToan_BangDuLieu bang = new QLDA_TongDuToan_BangDuLieu(sSoQuyetDinh, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_TongDuToan", new{sSoQuyetDinh=sSoQuyetDinh,iID_MaTongDuToan_QuyetDinh=iID_MaTongDuToan_QuyetDinh})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        jsQLDA_TongDauTu = '<%= Url.Action("get_GiaTriTongDauTu", "QLDA_TongDuToan")%>';
        jsQLDA_MucLucNganSach = '<%= Url.Action("get_MucLucNganSach", "QLDA_TongDuToan")%>';
