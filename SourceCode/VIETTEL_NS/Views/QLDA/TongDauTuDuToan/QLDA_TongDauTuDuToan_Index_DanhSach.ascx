...
<%
    ...
    QLDA_TongDauTuDuToan_BangDuLieu bang = new QLDA_TongDauTuDuToan_BangDuLieu(iID_MaDanhMucDuAn, dNgayLap, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_TongDauTuDuToan", new{iID_MaDanhMucDuAn=iID_MaDanhMucDuAn, dNgayLap = dNgayLap})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        BangDuLieu_iID_MaDanhMucDuAn = '<%=iID_MaDanhMucDuAn%>';
