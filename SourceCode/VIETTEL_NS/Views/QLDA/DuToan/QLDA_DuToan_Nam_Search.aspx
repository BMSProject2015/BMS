...
<%
    ...
    DataTable dt = QLDA_DuToan_NamModels.Get_DanhSach(iNam, dTuNgay, dDenNgay, CurrentPage, Globals.PageSize);

    double nums = QLDA_DuToan_NamModels.Get_DanhSach_Count(iNam, dTuNgay, dDenNgay);
    int TotalPages = (int)Math.Ceiling(nums / Globals.PageSize);
    String strPhanTrang = MyHtmlHelper.PageLinks(String.Format("Trang {0}/{1}:", CurrentPage, TotalPages), CurrentPage, TotalPages, x => Url.Action("Search", "QLDA_DuToan_Nam", new {iNam = iNam, TuNgay = dTuNgay, DenNgay = dDenNgay, page = x }));
    ...
    <tr>
        ...
        <td align="left">
            <div style="padding-bottom: 5px; color:#ec3237;">
                ...
                <%=MyHtmlHelper.ActionLink(Url.Action("Search", "QLDA_DuToan_Nam"), "Tìm kiếm danh sách dự toán năm")%>
            </div>
        </td>
    </tr>
</table>
...
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                    <span>Danh sách tìm kiếm dự toán năm</span>
                </td>
            </tr>
        </table>
    </div>
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=strColor %>>
                ...
                <td align="left">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "QLDA_DuToan_Nam", new { iID_MaDanhMucDuAn = R["iID_MaDanhMucDuAn"], dNgayLap = dNgayLap }).ToString(), strTenDoanhNghiep, "Detail", "")%></b>
                </td>
