...
<%
    ...
    QLDA_QuyetToanHoanThanh_BangDuLieu bang = new QLDA_QuyetToanHoanThanh_BangDuLieu(iID_MaQuyetToanHoanThanh_SoPhieu, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QLDA_QuyetToanHoanThanh", new{iID_MaQuyetToanHoanThanh_SoPhieu=iID_MaQuyetToanHoanThanh_SoPhieu})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        BangDuLieu_iID_MaDanhMucDuAn = '<%=iID_MaQuyetToanHoanThanh_SoPhieu%>';
        jsQLDA_MucLucNganSach = '<%=Url.Action("get_MucLucNganSach_DuToan", "QLDA_TongDuToan")%>';
        BangDuLieu_DuocSuaChiTiet = <%=bang.DuocSuaChiTiet?"true":"false"%>;
        <%=bang.DuocSuaChiTiet?"":"Bang_keys.fnSetFocus(null, null);"%>
          jsQLDA_QuyetToanHoanThanh = '<%=Url.Action("get_CapPhat", "QLDA_QuyetToanHoanThanh")%>';
          iID_MaQuyetToanHoanThanh_SoPhieu=<%=iID_MaQuyetToanHoanThanh_SoPhieu%>
    });
</script>
