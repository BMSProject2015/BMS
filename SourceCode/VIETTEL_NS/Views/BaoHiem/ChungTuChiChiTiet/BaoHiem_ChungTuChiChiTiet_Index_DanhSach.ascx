...
<%
    ...
    String bChi = Convert.ToString(props["bChi"].GetValue(Model));
    ...
    BaoHiemChi_BangDuLieu bang = new BaoHiemChi_BangDuLieu(iID_MaChungTuChi,arrGiaTriTimKiem, MaND, IPSua, bChi);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit","BaoHiem_ChungTuChiChiTiet",new {iID_MaChungTuChi=iID_MaChungTuChi,bChi=bChi}) %>" method="post">
    <%
    } %>
