...
<%
    ...
    BaoHiem_CauHinhDoiTuongNganSach_BangDuLieu bang = new BaoHiem_CauHinhDoiTuongNganSach_BangDuLieu(arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit","BaoHiem_CauHinhDoiTuongNganSach") %>" method="post">
    <%
    } %>
