...
<script src="<%= Url.Content("~/Scripts/jsBang_BaoHiem_CauHinhNganSach.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
...
<div style="width: 100%; float: left;">
    <div style="width: 100%; float:left;">
        <div class="box_tong">
            ...
            <div id="nhapform">
                <div id="form2">                    
                    <%Html.RenderPartial("~/Views/BaoHiem/CauHinhNganSach/BaoHiem_CauHinhDoiTuongNganSach_DanhSach.ascx", new { ControlID = "BaoHiem_CauHinhNganSach", MaND = User.Identity.Name}); %>    
                </div>
            </div>
        </div>
    </div>
