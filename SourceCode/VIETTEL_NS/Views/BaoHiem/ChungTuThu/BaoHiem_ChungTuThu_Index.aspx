...
<div class="box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "BaoHiem_ChungTuThu", new { iID_MaChungTuThu = R["iID_MaChungTuThu"]}).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "BaoHiem_ChungTuThu", new { iID_MaChungTuThu = R["iID_MaChungTuThu"]}).ToString(), "<img src='../Content/Themes/images/delete.gif' alt='' />", "Delete", "");
            }
