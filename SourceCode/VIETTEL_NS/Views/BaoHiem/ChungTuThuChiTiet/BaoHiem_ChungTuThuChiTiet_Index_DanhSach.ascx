...
<%
    ...
    BaoHiemThu_BangDuLieu bang = new BaoHiemThu_BangDuLieu(iID_MaChungTuThu, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit","BaoHiem_ChungTuThuChiTiet",new {iID_MaChungTuThu=iID_MaChungTuThu}) %>" method="post">
    <%
    } %>
