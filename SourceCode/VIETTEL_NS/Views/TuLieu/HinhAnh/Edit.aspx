...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        {
            cmd = new SqlCommand("SELECT * FROM TL_Anh WHERE iID_MaTaiLieu_Anh=@iID_MaTaiLieu");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                MaTuLieuAnh = Convert.ToString(dt.Rows[0]["sMaTaiLieuLienQuan"]);
        ...
        using (Html.BeginForm("EditSubmit", "TuLieu_HinhAnh", new { ParentID = ParentID, MaTaiLieu = MaTaiLieu, path = path }, FormMethod.Post, new { enctype = "multipart/form-data" }))
        {
    %>
    <%= Html.Hidden(ParentID + "_DuLieuMoi", ViewData["DuLieuMoi"])%>
    <%= Html.Hidden(ParentID + "_iID_MaTaiLieu_Anh", MaTaiLieu)%>
        ...
        <tr>
            ...
            <td align="left">
                <div style="padding-bottom: 5px; color: #ec3237;">
                    ...
                    <%=MyHtmlHelper.ActionLink(Url.Action("Index", "ChangeDirectoryV2", new { contronllerName = "TuLieu_HinhAnh" }), "Thay đổi thu mục lưu file")%>
                </div>
            </td>
        </tr>
    </table>
    <script type="text/javascript">
        ...
        function checkAllRelatedImages(aspnetForm) {
            if (aspnetForm.Edit_chb_RelatedImages.checked == true) {
                for (var i = 0; i < aspnetForm.elements.length; i++) {
        ...
        function checkFileExtension() {
            ...
            alert('File dữ liệu hình ảnh không phù hợp!');
            return false;
        }
    </script>
    <div class="box_tong">
                        ...
                        <td width="50%">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            ...
                                            <input type="file" name="uploadFile" id="uploadFile" style="width: 95%" accept="image/*"
                                ...
                                <tr>
                                    <td class="td_form2_td1">
                                        <div>
                                            <%=NgonNgu.LayXau("Hình ảnh liên quan") %></div>
                                    </td>
                                    <td class="td_form2_td5">
                                        <div>
                                            <table>
                                                  <tr>
                                                    <td style="width: 2%" align="left">
                                                        <%= MyHtmlHelper.CheckBox(ParentID, "", "chb_RelatedImages", "", "onclick=\"JavaScript:checkAllRelatedImages(this.form);\"")%>
                                                    </td>
                                                    <td align="left">
                                                        Chọn tất cả
                                                    </td>
                                        ...
                                        <div style="overflow: auto;max-height: 400px">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <%
                                                    cmd = new SqlCommand("SELECT iID_MaTaiLieu_Anh, sTen FROM TL_Anh  where iTrangThai=1 ORDER BY sTen");
                                                dt = Connection.GetDataTable(cmd);
                                                String tla;
                                                for (int i = 0; i < dt.Rows.Count; i++)
                                                {
                                                    tla = "";
                                                    if (MaTuLieuAnh.IndexOf(String.Format(",{0},", dt.Rows[i]["iID_MaTaiLieu_Anh"])) >= 0)
                                                    {
                                                        tla = "on";
                                                    }
                                                %>
                                                <tr>
                                                    <td align="left" colspan="2">
                                                        <%= MyHtmlHelper.CheckBox(ParentID, tla, "sMaTaiLieuLienQuan", "", String.Format("value='{0}'", Convert.ToString(dt.Rows[i]["iID_MaTaiLieu_Anh"])))%>
                                                  &nbsp;&nbsp;
                                                        <%= dt.Rows[i]["sTen"]%>
                                                    </td>
                                                </tr>
