...
<%
    ...
    using (Html.BeginForm("EditSubmit", "TimKiemVatTu", new { ParentID = ParentID, iID_MaVatTu = iID_MaVatTu, iTrangThai = iTrangThai }))
    {
%>
	...
	<tr>
		...
		<td width="30%" align="right">
            <table cellpadding="0" cellspacing="0" border="0" align="right">
        	    <tr>
            	    <td>
            	        <input type="submit" id="Luu" class="button4" value="Gửi lên" />
            	    </td>
                    <td width="5px"></td>
                    <td>
