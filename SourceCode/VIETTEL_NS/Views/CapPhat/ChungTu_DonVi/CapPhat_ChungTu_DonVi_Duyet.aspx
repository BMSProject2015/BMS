...
<div class="box_tong">
    ...
    <table class="mGrid" id="<%= ParentID %>_thList">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "CapPhat_ChungTu_DonVi", new { iID_MaCapPhat = R["iID_MaCapPhat"]}).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "Edit", "");
