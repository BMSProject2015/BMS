...
<%
    ...
    {
        %>
        <script src="<%= Url.Content("~/Scripts/KeToanChiTietTienMat/jsBang_KeToanChiTiet_TienMat_ChungTuChiTiet.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
        ...
        <%Html.RenderPartial("~/Views/KeToanChiTiet/TienMat/KeToanChiTiet_TienMat_ChungTuChiTiet_Frame_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name, iID_MaChungTu = iID_MaChungTu }); %>
        <%
    }
%>
</asp:Content>
