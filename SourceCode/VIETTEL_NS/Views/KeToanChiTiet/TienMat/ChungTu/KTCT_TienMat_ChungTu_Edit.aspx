...
<%
    ...
    DataTable dtChungTu = KTCT_TienMat_ChungTuModels.GetChungTu(MaChungTu);
    DataRow R;
    int iSoChungTu = 0, iNgay = 0, iThang = 0;
    String sTienToChungTu="", dNgayChungTu = "", sNoiDung = "", sLyDo = "", iID_MaTrangThaiDuyet = "";
    ...
    if (ViewData["DuLieuMoi"] == "1")
    {
        ...
        iSoChungTu = KTCT_TienMat_ChungTuModels.GetMaxChungTu() + 1;
    }
    dtChungTu.Dispose();
    ...
    using (Html.BeginForm("EditSubmit", "KTCT_TienMat_ChungTu", new { ParentID = ParentID, MaChungTu = MaChungTu}))
    {
%>
