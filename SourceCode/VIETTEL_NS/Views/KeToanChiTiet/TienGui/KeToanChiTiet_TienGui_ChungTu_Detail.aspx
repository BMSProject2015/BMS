...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/KeToanChiTietTienGui/jsKeToanChiTietTienGui.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
    ...
    <%
        ...
        //{
        //    DataTable dtChungTu = KTCT_TienGui_ChungTuModels.List_DanhSachChungTu(iThang, iNam);
        ...
        //    dtChungTu.Dispose();
        //}
        string strNoiDung = KTCT_TienGui_ChungTuModels.getSoChungTuGhiSo(iID_MaChungTu);
        ...
        dtTrangThai.Dispose();
        String urlCheckTrungSoGhiSo = Url.Action("CheckTrungSoGhiSo", "KTCT_TienGui_ChungTu");
        String urlget_get_Check_iID_MaChungTu = Url.Action("get_Check_iID_MaChungTu", "KTCT_TienGui_ChungTu");
                        ...
                        <td align="right" style="padding-right: 10px;">
                           ...
                           <div style="float: right; margin-right: 5px;">
                            ...
                            <div style="float: left; padding-left: 20px;">
                                <div style="float: right; margin-right: 5px;" onclick="OnInit_CT(700, 'KIỂM TRA SỐ LIỆU UNC');">
                                    <%= Ajax.ActionLink("6. KIỂM TRA SỐ LIỆU", "Index", "NhapNhanh", new { id = "KT_TIENGUI_KIEMTRASOLIEUUNC", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaChungTu = iID_MaChungTu, iNam = 1 }, new AjaxOptions { }, new { @class = "button_title", id = "idKT_TIENGUI_KIEMTRASOLIEUUNC" })%>
                                </div>
                                <div style="float: right; margin-right: 3px;">
                                    <a href='<%=Url.Action("ChungTuChiTietTuChoi","KTCT_TienGui_ChungTuChiTiet")%>' class="button_title">
                                        5. D.sách C.T TỪ CHỐI</a>
                                </div>
                                <div style="float: right; margin-right: 3px;" onclick="OnInit_CT(1000, 'Lịch sử Chứng từ ghi sổ');">
                                    <%= Ajax.ActionLink("4.Lịch sử CTGS", "Index", "NhapNhanh", new { id = "KTTH_TIENGUI_LICHSUCHUNGTU", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaChungTu = iID_MaChungTu, iThang = iThang }, new AjaxOptions { }, new { @class = "button_title", id = "idKTTH_LICHSUCHUNGTU" })%>
                                </div>
                                <div style="float: right; margin-right: 5px;" onclick="OnInit_CT(400, 'IN THÔNG TRI');">
                                    <%= Ajax.ActionLink("3. Thông tri", "Index", "NhapNhanh", new { id = "KT_TIENGUI_THONGTRI", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaChungTu = iID_MaChungTu, iNam = 1 }, new AjaxOptions { }, new { @class = "button_title", id = "idKT_TIENGUI_THONGTRI" })%>
                                </div>
                              <%--  <div style="float: right; margin-right: 5px; " onclick="OnInit_CT(400, 'Tổng hợp ngày');">
                                    <%= Ajax.ActionLink("3. T.hợp ngày", "Index", "NhapNhanh", new { id = "KT_TIENGUI_TONGHOP_NGAY", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaChungTu = iID_MaChungTu, iNam = 1 }, new AjaxOptions { }, new { @class = "button_title", id = "idKT_TIENGUI_TONGHOP_NGAY" })%>
                                </div>--%>
                                <div style="float: right; margin-right: 5px;" onclick="OnInit_CT(400, 'TỔNG HỢP CTGS');">
                                    <%= Ajax.ActionLink("2. T.hợp CTGS", "Index", "NhapNhanh", new { id = "KT_TIENGUI_TONGHOP_CTGS", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaChungTu = iID_MaChungTu, iNam = 1 }, new AjaxOptions { }, new { @class = "button_title", id = "idKT_TIENGUI_TONGHOP_CTGS" })%>
                                </div>
                                <div style="float: right; margin-right: 5px;" onclick="OnInit_CT(500, 'IN ỦY NHIỆM CHI');">
                                    <%= Ajax.ActionLink("1. IN ỦY NHIỆM CHI", "Index", "NhapNhanh", new { id = "KTCT_UYNHIEMCHI", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaChungTu = iID_MaChungTu, iNam = 1 }, new AjaxOptions { }, new { @class = "button_title", id = "idKTCT_UYNHIEMCHI" })%>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function GetChungTuGhiSo(iID_MaChungTu) {
            ...
            var url = unescape('<%= Url.Action("getSoChungTuGhiSo?iID_MaChungTu=#0", "KTCT_TienGui_ChungTu")%>');
        ...
        function ChonThangNam(value, loai) {
            ...
            jQuery.ajaxSetup({ cache: false });
            var url = unescape('<%= Url.Action("UpdateCauHinhNamLamViec?MaND=#0&iThangLamViec=#1&iNamLamViec=#2","KeToanChiTietTienGui") %>');
        ...
        $(document).ready(function () {
         jsNamLamViec=<%=iNam %>;
            ...
            jsKeToan_url_ChungTu_Check = '<%= Url.Action("get_CheckSoChungTuGhiSo", "KTCT_TienGui_ChungTu")%>';
             jsKeToan_url_MaChungTu_Check = '<%=urlget_get_Check_iID_MaChungTu %>';
            jsKeToan_url_ChungTu = '<%= Url.Action("ChungTu_Frame", "KTCT_TienGui_ChungTuChiTiet")%>';
            jsKeToan_url_ChungTuChiTiet = '<%= Url.Action("ChungTuChiTiet_Frame", "KTCT_TienGui_ChungTuChiTiet")%>';
            jsKeToan_url_KTCT_UYNHIEMCHI = '<%= Url.Action("Index", "NhapNhanh", new { id = "KTCT_UYNHIEMCHI", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT" })%>';
            jsKeToan_url_KT_TIENGUI_THONGTRI = '<%= Url.Action("Index", "NhapNhanh", new { id = "KT_TIENGUI_THONGTRI", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT" })%>';
            jsKeToan_url_KT_TIENGUI_TONGHOP_NGAY = '<%= Url.Action("Index", "NhapNhanh", new { id = "KT_TIENGUI_TONGHOP_NGAY", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT" })%>';
            jsKeToan_url_KT_TIENGUI_TONGHOP_CTGS = '<%= Url.Action("Index", "NhapNhanh", new { id = "KT_TIENGUI_TONGHOP_CTGS", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT" })%>';
            jsKeToan_url_KTTH_LICHSUCHUNGTU = '<%= Url.Action("Index", "NhapNhanh", new { id = "KTTH_TIENGUI_LICHSUCHUNGTU", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT"})%>';
            jsKeToan_url_KT_TIENGUI_KIEMTRASOLIEUUNC = '<%= Url.Action("Index", "NhapNhanh", new { id = "KT_TIENGUI_KIEMTRASOLIEUUNC", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT"})%>';
