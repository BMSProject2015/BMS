...
<script src="<%= Url.Content("~/Scripts/KeToanChiTietTienGui/jsBang_TinhChatCapThu.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
        ...
        <div class="box_tong">
            <div class="title_tong">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td>
                            <span>Danh sách tính chất cấp thu</span>
                        </td>
                        <td align="right">
            ...
            <div id="nhapform">
                <div id="form2">                  
                    <%Html.RenderPartial("~/Views/KeToanChiTiet/TienGui/TinhChatCapThu/TinhChatCapThu_DanhMuc_Index._DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name }); %>
                </div>
            </div>
        </div>
    </div>
