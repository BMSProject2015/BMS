...
<%
    ...
    KTTG_TinhChatCapThu_ChungTu_BangDuLieu bang = new KTTG_TinhChatCapThu_ChungTu_BangDuLieu(iID_MaChungTu, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTTG_TinhChatCapThuChungTu", new{iID_MaChungTu=iID_MaChungTu})%>" method="post">
    <%
    } %>
