...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/KeToanChiTietTienGui/jsKeToanChiTietTienGui_ChungTuChiTietTuChoi.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
        ...
        <tr>
            ...
            <td align="left">
                <div style="padding-bottom: 5px; color: #ec3237;">
                    ...
                    |
                    <%=MyHtmlHelper.ActionLink(Url.Action("Index", "KeToanChiTietTienGui"), "Danh sách chứng từ ghi sổ")%>
                </div>
            </td>
        </tr>
    </table>
    <div class="box_tong">
        ...
        <div style="width: 100%; float: left; margin-right: 15px;">
            <iframe id="ifrChungTu" width="100%" height="660px" src="<%= Url.Action("ChungTuChiTietTuChoi_Frame", "KTCT_TienGui_ChungTuChiTiet")%>">
            </iframe>
        </div>
    </div>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            jsKeToan_url_ChungTuChiTiet = '<%= Url.Action("ChungTuChiTietTuChoi_Frame", "KTCT_TienGui_ChungTuChiTiet")%>';
            jsKeToan_url_KeToanTongHop = '<%= Url.Action("Index", "KeToanChiTietTienGui")%>';
        });
    </script>
</asp:Content>
