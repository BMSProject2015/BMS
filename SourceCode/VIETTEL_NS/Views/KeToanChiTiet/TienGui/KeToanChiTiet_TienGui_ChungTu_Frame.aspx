...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/KeToanChiTietTienGui/jsBang_KeToanChiTiet_TienGui_ChungTu.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
    ...
    <%
        ...
        KTCT_TienGui_ChungTu_BangDuLieu bang = new KTCT_TienGui_ChungTu_BangDuLieu(iThang, iNam, arrGiaTriTimKiem, MaND, IPSua);
            ...
            <div id="form2">
                ...
                <div style="display: none;">
                    ...
                    <%  
                        ...
                        {
                    %>
                    <form action="<%=Url.Action("DetailSubmit", "KTCT_TienGui_ChungTu", new{iNam = iNam, iThang = iThang})%>"
                    method="post">
                    <%
    } %>
