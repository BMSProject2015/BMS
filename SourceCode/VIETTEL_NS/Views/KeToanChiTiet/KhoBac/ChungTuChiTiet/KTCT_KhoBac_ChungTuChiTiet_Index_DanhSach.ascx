...
<%
    ...
    KTCT_KhoBac_ChungTu_BangDuLieu bang = new KTCT_KhoBac_ChungTu_BangDuLieu(iID_MaChungTu, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTCT_KhoBac_ChungTuChiTiet", new{iID_MaChungTu=iID_MaChungTu})%>" method="post">
    <%
    } %>
