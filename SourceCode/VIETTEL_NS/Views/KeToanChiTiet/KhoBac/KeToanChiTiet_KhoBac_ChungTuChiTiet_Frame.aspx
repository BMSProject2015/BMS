...
<%
    ...
    {
        %>
        <script src="<%= Url.Content("~/Scripts/KeToanChiTietKhoBac/jsBang_KeToanChiTiet_KhoBac_ChungTuChiTiet.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
        ...
        <%Html.RenderPartial("~/Views/KeToanChiTiet/KhoBac/KeToanChiTiet_KhoBac_ChungTuChiTiet_Frame_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet", MaND = User.Identity.Name, iID_MaChungTu = iID_MaChungTu, iLoai = iLoai }); %>
        <%
    }
%>
</asp:Content>
