...
<%
    ...
    CapThu_BangDuLieu bang = new CapThu_BangDuLieu(iID_MaChungTu_Duyet, arrGiaTriTimKiem, MaND, IPSua);
...
<div class="box_tong">
        ...
        <div id="form2">
            ...
            <div style="display: none;">
                ...
                <%  
                    ...
                    {
                %>
                <form action="<%=Url.Action("DetailSubmit", "KTCT_CapThu", new{iID_MaChungTu_Duyet=iID_MaChungTu_Duyet})%>"
                method="post">
                <%
                    } %>
    ...
    $(document).ready(function () {
     ...
     function ChonRDT(value) {
            var c = Bang_arrCSMaCot["bRutDuToan"];
            if (Bang_nH != 0 && c != null) {
     ...
     function ChonUNC(value) {
            var c = Bang_arrCSMaCot["bLoai"];
            if (Bang_nH != 0 && c != null) {
                for (var h = 0; h < Bang_nH-1; h++) {
                     if (value == "true" || value=="1") {
                         Bang_GanGiaTriThatChoO(h, c, "1");
