...
<%
 ...
 %>
   <table  class="mGrid" style="width: 100%">
        <tr>
            <th align="center" style="width: 40px;"> <input type="checkbox"  id="abc" onclick="CheckAllDonVi(this.checked)" /></th>
            ...
            <tr>
                <%for (int c = 0; c < SoCot; c++)
                  {
                      ...
                      {
                          strChecked = "";
                          strsTen = Convert.ToString(dtDonVi.Rows[i + c]["sTenDonVi"]);
               ...
               <td align="center" style="width: 40px;">
                    <input type="checkbox" value="<%=MaDonVi %>" <%=strChecked %> check-group="DV" id="sDV" name="sDV" onclick="ChonDonVi()"/>
                </td>
                <td align="left">
                    <%=strsTen%>
                </td>
