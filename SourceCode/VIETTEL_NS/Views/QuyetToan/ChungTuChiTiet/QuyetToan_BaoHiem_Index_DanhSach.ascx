...
<%
    ...
    QuyetToan_QuyetToan_BaoHiem_BangDuLieu bang = new QuyetToan_QuyetToan_BaoHiem_BangDuLieu(iID_MaChungTu, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit_BH", "QuyetToan_ChungTuChiTiet", new{iID_MaChungTu=iID_MaChungTu})%>" method="post">
    <%
    } %>
...
%>
    <table cellpadding="0" cellspacing="0" border="0" align="center">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td align="left">
                <input class="button" type="button" value="<%=NgonNgu.LayXau("Quay lại")%>" onclick="parent.jsBH_Dialog_close_Reload()" />
            </td>
            <td>&nbsp;</td>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        <%=bang.DuocSuaChiTiet?"":"Bang_keys.fnSetFocus(0, 0);"%>
    });
</script>
