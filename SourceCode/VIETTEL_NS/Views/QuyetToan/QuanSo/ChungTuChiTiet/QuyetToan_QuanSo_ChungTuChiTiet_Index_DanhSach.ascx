...
<%
    ...
    QuyetToan_QuanSo_ChungTu_BangDuLieu bang = new QuyetToan_QuanSo_ChungTu_BangDuLieu(iID_MaChungTu, arrGiaTriTimKiem, MaND, IPSua);
    ...
    String url = Url.Action("LayThongTinTuLuong", "QuyetToan_QuanSo_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu });
%>
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "QuyetToan_QuanSo_ChungTuChiTiet", new{iID_MaChungTu=iID_MaChungTu})%>" method="post">
    <%
    } %>
