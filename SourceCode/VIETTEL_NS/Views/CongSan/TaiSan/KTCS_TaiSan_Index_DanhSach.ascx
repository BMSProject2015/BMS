...
<%
    ...
    KTCS_TaiSan_BangDuLieu bang = new KTCS_TaiSan_BangDuLieu(iLoai, iID_MaLoaiTaiSan, arrGiaTriTimKiem, MaND, IPSua);

    String BangID = "BangDuLieu";
    int Bang_Height = 600;
    int Bang_FixedRow_Height = 30;
...
<%  
    ...
    <form action="<%=Url.Action("DetailSubmit", "KTCS_TaiSan", new{iLoai=iLoai,iID_MaLoaiTaiSan=iID_MaLoaiTaiSan})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
    $(document).ready(function () {
        jsKTCS_Check_MaTaiSan = '<%= Url.Action("get_Check_MaTaiSan", "KTCS_TaiSan")%>';
        jsQLDA_LayNamSuDung = '<%= Url.Action("get_GiaTriSoNamSuDung", "KTCS_TaiSan")%>';
