...
<script src="<%= Url.Content("~/Scripts/KeToanCongSan/jsKeToanCongSan_ChungTuChiTietTuChoi.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>
...
<%
    ...
    KTCS_ChungTuChiTietTuChoi_BangDuLieu bang = new KTCS_ChungTuChiTietTuChoi_BangDuLieu(iThang, iNam, arrGiaTriTimKiem, MaND, IPSua);
