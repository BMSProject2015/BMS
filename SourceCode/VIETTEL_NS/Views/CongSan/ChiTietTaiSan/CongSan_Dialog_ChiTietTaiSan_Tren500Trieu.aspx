...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <%
    ...
    {%> 
    <%   
    String ParentID = "TaiSan_Tren500Trieu";
...
<form action="<%=Url.Action("ChiTiet_Submit", "KTCS_TaiSan", new {ParentID = ParentID})%>" method="post">
 ...
 <%=MyHtmlHelper.Hidden(ParentID,4,"iLoaiTS","") %>
            ...
            <div id="form2">
                ...
                <table cellpadding="4" cellspacing="4" border="0" class="table_form2">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, data, "sLoai_500", "", "class=\"input1_2\" tab-index='1'")%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="3">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, data, "sHangSX_500", "", "class=\"input1_2\" tab-index='2' ")%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
