...
<form action="<%=Url.Action("ChiTiet_Submit", "KTCS_TaiSan", new {ParentID = ParentID})%>" method="post">
 ...
 <%=MyHtmlHelper.Hidden(ParentID,1,"iLoaiTS","") %>
                ...
                <table cellpadding="4" cellspacing="4" border="0" class="table_form2">
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            ...
                            <%=MyHtmlHelper.Label(data, "iID_MaTaiSan", "", "")%> - T/TSCĐ</span></b>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 20%; height: 20px;">
                            <div> 1. Tên tài sản</div>
                        </td>
                        <td colspan="3">
                            <div>
                                <b><%=MyHtmlHelper.TextBox(ParentID, sTenTaiSan, "sTenTaiSan", "", "khong-nhap='1'", 0, true)%></b>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 20%;">
                            <div> 2. Thông số kỹ thuật</div>
                        </td>
                        <td colspan="3">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div style="width: 150px;"> - DT khuôn viên (m2)</div>
                        </td>
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTKhuonVien", "", "class=\"input1_2\" tab-index='-1'", 1)%></div>
                        </td>
                        <td>
                            <div style="margin-left: 5px;"> - DT làm trụ sở (TT74) (m2)</div>
                        </td>
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTLamTruSo", "", "class=\"input1_2\" tab-index='2'", 1)%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTLamNhaLamViec", "", "class=\"input1_2\" tab-index='3'", 1)%></div>
                        </td>
                        <td>
                            <div style="margin-left: 5px;"> - DT làm cơ sở HĐSN (m2)</div>
                        </td>
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTLamCoSoHDSN", "", "class=\"input1_2\" tab-index='4'", 1)%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTLamNhaO", "", "class=\"input1_2\" tab-index='5'", 1)%></div>
                        </td>
                        <td>
                            <div style="margin-left: 5px;"> - DT cho thuê (m2)</div>
                        </td>
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTChoThue", "", "class=\"input1_2\" tab-index='6'", 1)%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTBoTrong", "", "class=\"input1_2\" tab-index='7'", 1)%></div>
                        </td>
                        <td>
                            <div style="margin-left: 5px;"> - DT bị lấn chiếm (m2)</div>
                        </td>
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTBiLanChiem", "", "class=\"input1_2\" tab-index='8'", 1)%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "rDTKhac", "", "class=\"input1_2\" tab-index='9'", 1)%></div>
                        </td>
                        <td>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div><%=MyHtmlHelper.TextBox(ParentID, data, "iNamSX", "", "class=\"input1_2\" tab-index='10'", 1)%></div>
                        </td>
                        <td>
