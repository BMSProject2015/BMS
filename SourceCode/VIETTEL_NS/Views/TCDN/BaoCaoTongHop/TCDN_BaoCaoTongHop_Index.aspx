...
<%
    ...
    using (Html.BeginForm("EditSubmit", "TCDN_BaoCaoTongHop", new { ParentID = ParentID }))
    {
%>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slLoaiHinh, "", "iID_MaLoaiDoanhNghiep", "", "class=\"input1_2\"")%><br />
                                <%= Html.ValidationMessage(ParentID + "_" + "err_iID_MaLoaiDoanhNghiep")%>
                            </div>
                        </td>
                    </tr>
                    <tr>
