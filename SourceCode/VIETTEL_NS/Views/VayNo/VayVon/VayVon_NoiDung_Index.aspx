        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("EditNoiDung", "VayVon_NoiDung", new { ID = R["ID"] }).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "EditNoiDung", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("DeleteNoiDung", "VayVon_NoiDung", new { ID = R["ID"] }).ToString(), "<img src='../Content/Themes/images/delete.gif' alt='' />", "DeleteNoiDung", "");
            %>
            <tr>
