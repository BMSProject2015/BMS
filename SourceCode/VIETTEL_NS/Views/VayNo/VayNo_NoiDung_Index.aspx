                            ...
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, iID_MaNoiDung, "iID_MaNoiDung", "", "class=\"input1_2\" tab-index='-1'")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("EditNoiDung", "VayNo_NoiDung", new { ID = R["iID_MaNoiDung"] }).ToString(), "<img src='../Content/Themes/images/edit.gif' alt='' />", "EditNoiDung", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("DeleteNoiDung", "VayNo_NoiDung", new { ID = R["iID_MaNoiDung"] }).ToString(), "<img src='../Content/Themes/images/delete.gif' alt='' />", "DeleteNoiDung", "");
            %>
            <tr>
