  ...
  <script src="<%= Url.Content("~/Scripts/jsDuToan.js?id=") %><%=DateTime.Now.ToString("yyMMddHHmmss") %>"
                    ...
                    <td>
                        ...
                        <td>
                          ...
                          <td align="right">
                            ...
                            <div>
                                <%Html.RenderPartial("~/Views/DuToan/ChungTuChiTiet/ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet_Index_DanhSach", MaND = User.Identity.Name, ChucNangCapNhap = true, sLNS = sLNS,iLoai=iLoai }); %>
                            </div>
                        </div>
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            jsDuToan_Url_Frame = '<%=Url.Action("ChungTuChiTiet_Frame", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu })%>';
