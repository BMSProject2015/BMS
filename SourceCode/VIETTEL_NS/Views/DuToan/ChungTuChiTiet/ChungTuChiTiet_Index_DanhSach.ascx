...
<div class="box_tong">
    <div id="nhapform">
        <div id="form2">
            ...
            <iframe id="ifrChiTietChungTu" width="100%" height="538px" src="<%= Url.Action("ChungTuChiTiet_Frame", "DuToan_ChungTuChiTiet", new {iID_MaChungTu=iID_MaChungTu, iID_MaDonVi=iID_MaDonVi, sLNS=sLNS,iLoai=iLoai})%>"></iframe>
        </div>
    </div>
</div>