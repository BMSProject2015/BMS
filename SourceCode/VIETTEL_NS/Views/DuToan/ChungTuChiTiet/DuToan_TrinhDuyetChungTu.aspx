...
<body>
    <%
        ...
        String idAction = "1";
        using (Html.BeginForm("TrinhDuyet", "DuToan_ChungTuChiTiet", new { ParentID = ParentID, iID_MaChungTu = iID_MaChungTu, sLNS = sLNS,iKyThuat=iKyThuat, iLoai = 1, iID_MaChungTu_TLTH = iID_MaChungTu_TLTH }))
        {
    %>
