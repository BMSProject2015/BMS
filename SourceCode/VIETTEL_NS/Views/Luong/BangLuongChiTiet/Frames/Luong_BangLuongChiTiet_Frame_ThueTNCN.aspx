...
<%
    ...
    Luong_BangDuLieu bang = new Luong_BangDuLieu(iID_MaBangLuong, Luong_BangDuLieu.iLoaiBangLuong_BangThueTNCN, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    {
    %>
    <form action="<%=Url.Action("DetailSubmit", "Luong_BangLuongChiTiet", new {iID_MaBangLuong=iID_MaBangLuong, Detail = "ThueTNCN"})%>" method="post">
    <%
    } %>
...
var BangDuLieu_Url = '<%=Url.Action("Index", "Luong_BangLuongChiTiet", new {iID_MaBangLuong = iID_MaBangLuong,LoaiBang= Luong_BangDuLieu.iLoaiBangLuong_BangThueTNCN})%>';
...
//        BangDuLieu_Url_getGiaTri = '<%=Url.Action("get_GiaTri", "Luong_BangLuongChiTiet")%>';
//        BangDuLieu_Url_getDanhSach = '<%=Url.Action("get_DanhSach", "Luong_BangLuongChiTiet")%>';
