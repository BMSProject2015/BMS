...
<%
    ...
    Luong_BangDuLieu bang = new Luong_BangDuLieu(iID_MaBangLuong, Luong_BangDuLieu.iLoaiBangLuong_BangBaoHiem, arrGiaTriTimKiem, MaND, IPSua);
...
<%  
    ...
    {
    %>
    <form action="<%=Url.Action("DetailSubmit", "Luong_BangLuongChiTiet", new {iID_MaBangLuong=iID_MaBangLuong, Detail = "BaoHiem"})%>" method="post">
    <%
    } %>
...
<script type="text/javascript">
  var BangDuLieu_Url = '<%=Url.Action("Index", "Luong_BangLuongChiTiet", new {iID_MaBangLuong = iID_MaBangLuong,LoaiBang=Luong_BangDuLieu.iLoaiBangLuong_BangBaoHiem})%>';
