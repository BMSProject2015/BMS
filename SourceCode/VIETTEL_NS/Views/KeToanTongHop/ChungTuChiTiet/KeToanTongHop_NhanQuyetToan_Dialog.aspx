...
<body>
    <%
        ...
        using (Ajax.BeginForm("Edit_Fast_QuyetToan_Submit", "KeToanTongHop_ChungTuChiTiet", new { ParentID = ParentID, OnSuccess = OnSuccess, iID_MaChungTu = iID_MaChungTu, MaDiv = MaDiv, MaDivDate = MaDivDate }, new AjaxOptions { }))
        {
    %>
            ...
            <div class="box_tong">
                <div class="title_tong">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td>
                                <span>Danh sách rút dự toán trong tháng: <%=iThang %></span>
                            </td>
                        </tr>
                    </table>
                </div>
                                ...
                                <td align="left" colspan="2" valign="top">
                                    <table class="mGrid">
                                        <tr>
                                            ...
                                            <th style="width: 150px;">Số chứng từ quyết toán</th>
                                            <th>Loại ngân sách- Mô tả</th>
