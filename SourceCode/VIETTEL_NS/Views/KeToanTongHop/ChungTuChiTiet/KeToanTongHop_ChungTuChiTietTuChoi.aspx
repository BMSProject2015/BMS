...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/KeToanTongHop/jsKeToan_ChungTuChiTietTuChoi.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
    ...
    <div class="box_tong">
        ...
        <div style="width: 100%; float: left; margin-right: 15px;">
            <iframe id="ifrChungTu" width="100%" height="660px" src="<%= Url.Action("ChungTuChiTietTuChoi_Frame", "KeToanTongHop_ChungTuChiTiet")%>">
            </iframe>
        </div>
    </div>
...
//            });
        ...
        $(document).ready(function () {
            jsKeToan_url_ChungTuChiTiet = '<%= Url.Action("ChungTuChiTietTuChoi_Frame", "KeToanTongHop_ChungTuChiTiet")%>';
            jsKeToan_url_KeToanTongHop = '<%= Url.Action("Index", "KeToanTongHop")%>';
        });
    </script>
</asp:Content>
