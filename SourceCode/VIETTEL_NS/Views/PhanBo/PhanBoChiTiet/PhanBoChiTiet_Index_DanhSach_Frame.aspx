...
<script src="<%= Url.Content("~/Scripts/jsBang_PhanBo.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>" type="text/javascript"></script>   
...
<%
    ...
    PhanBo_PhanBo_BangDuLieu bang = new PhanBo_PhanBo_BangDuLieu(iID_MaPhanBo, arrGiaTriTimKiem, MaND, IPSua);
...
<div style="display:none;">
    ...
    <form action="<%=Url.Action("DetailSubmit", "PhanBo_PhanBoChiTiet", new{iID_MaPhanBo=iID_MaPhanBo})%>" method="post">
    <%
    } %>
                    ...
                    <tr>                    
                        ...
                        <td align="left">
                            ...
                            if (iID_MaTrangThaiDuyet_TrinhDuyet > 0)
                            {
                                ...
                                if (LuongCongViecModel.KiemTra_NguoiDungDuocDuyet(MaND, PhanHeModels.iID_MaPhanHePhanBo))
                                {
