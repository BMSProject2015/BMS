...
<body>
    ...
    String UrlReport = Url.Action("ViewPDF", "rptKTTienMat_PhieuChi", new { MaND = UserID, iID_MaChungTuChiTiet = iID_MaChungTuChiTiet, LoaiBaoCao = LoaiBaoCao, iID_MaChungTu = iID_MaChungTu });
    String BackURL = Url.Action("Index", "KeToanChiTietTienMat");
    using (Html.BeginForm("EditSubmit", "rptKTTienMat_PhieuChi", new { ParentID = ParentID, ChiSo = ChiSo }))
   {
    %>  
   ...
   <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptKTTienMat_PhieuChi", new { ParentID = ParentID, ChiSo = ChiSo, iID_MaChungTuChiTiet = iID_MaChungTuChiTiet, iNamLamViec = iNamLamViec, iThang = iThang, iID_MaChungTu = iID_MaChungTu }), "Xuất ra file Excel")%>
