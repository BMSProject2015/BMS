...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        String Cap = "3";
        using (Html.BeginForm("Loc_Submit", "rptKTTongHop_ChiTiet_TongHopTaiKhoan", new { ParentID = ParentID, iNamLamViec = iNamLamViec }))
        { 
    %>
    ...
    <script type="text/javascript">     
           function ChonCap(value)
           {
                ...
                var url = unescape('<%= Url.Action("Get_objTaiKhoan?CapTK=#0&TuThang=#1&DenThang=#2&iNamLamViec=#3", "rptKTTongHop_ChiTiet_TongHopTaiKhoan") %>');
           ...
           function ChonThang(Thang,TenTruong) {
               ...
               jQuery.ajaxSetup({ cache: false });
               var url = unescape('<%= Url.Action("Get_objNgayThang?ParentID=#0&TenTruong=#1&Ngay=#2&Thang=#3&iNam=#4", "rptKTTongHop_ChiTiet_TongHopTaiKhoan") %>');
