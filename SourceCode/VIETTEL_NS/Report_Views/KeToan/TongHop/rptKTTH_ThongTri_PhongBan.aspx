...
<body>
    <%
        ...
        String URL = Url.Action("Index", "KeToanTongHop");
        using (Html.BeginForm("EditSubmit", "rptKTTongHop_ThongTri_PhongBan", new { ParentID = ParentID }))
        {
    %>
    <!---------Test----------------------->
    <div class="box_tong">
    ...
    <iframe src="<%=Url.Action("ViewPDF","rptKTTongHop_ThongTri_PhongBan", new{iID_MaChungTu=iID_MaChungTu,iID_MaDonVi = iID_MaDonVi,LoaiTK=LoaiTK, iThang = iThang, iNam = iNam,iID_MaThongTri=iID_MaThongTri})%>"
