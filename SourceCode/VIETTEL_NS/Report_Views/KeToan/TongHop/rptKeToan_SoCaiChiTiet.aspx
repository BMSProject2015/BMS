...
<body>
    <% 
        ...
        {
            ThangLamViec = DateTime.Now.Month.ToString();
        }
        ...
        DataTable dtTaiKhoan = rptKeToan_SoCaiChiTietController.KeToan_ToIn(iID_MaPhuongAn);
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptKeToan_SoCaiChiTiet", new { NamLamViec = NamLamViec, ThangLamViec = ThangLamViec, iID_MaPhuongAn = iID_MaPhuongAn, iID_MaTaiKhoan = iID_MaTaiKhoan, KhoGiay = KhoGiay });
        using (Html.BeginForm("EditSubmit", "rptKeToan_SoCaiChiTiet", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td width="47.9%">
                        <span>Báo cáo sổ cái chi tiết</span>
                    </td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                    ...
                    <tr>
                        ...
                        <td id="<%=ParentID%>_tdNoiDung" width="10%">
                            <% rptKeToan_SoCaiChiTietController rpt1 = new rptKeToan_SoCaiChiTietController();%>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptKeToan_SoCaiChiTiet", new { NamLamViec = NamLamViec, ThangLamViec = ThangLamViec, iID_MaPhuongAn = iID_MaPhuongAn, iID_MaTaiKhoan = iID_MaTaiKhoan, KhoGiay = KhoGiay }), "Xuất ra Excel")%>
    <script type="text/javascript">
        function ChonKieuIn() {
            var iID_MaPhuongAn = document.getElementById("<%=ParentID %>_iID_MaPhuongAn").value;
            jQuery.ajaxSetup({ cache: false });
            var url = unescape('<%= Url.Action("ds_NhomDonVi?ParentID=#0&iID_MaPhuongAn=#1&iID_MaTaiKhoan=#2", "rptKeToan_SoCaiChiTiet") %>');
