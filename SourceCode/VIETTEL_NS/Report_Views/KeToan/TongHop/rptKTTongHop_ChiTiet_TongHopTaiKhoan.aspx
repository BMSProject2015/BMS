...
<%
    ...
    String BackURL = Url.Action("Index", "rptKTTongHop_ChiTiet_TongHopTaiKhoan");
    using (Html.BeginForm("EditSubmit", "rptKTTongHop_ChiTiet_TongHopTaiKhoan", new { ParentID = ParentID, iNamLamViec = iNamLamViec, iNgay1 = iNgay1, iNgay2 = iNgay2, iThang1 = iThang1, iThang2 = iThang2, ChiSo = ChiSo }))
      { 
%>
...
<%} %>
<%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptKTTongHop_ChiTiet_TongHopTaiKhoan", new { iNamLamViec = iNamLamViec, iNgay1 = iNgay1, iNgay2 = iNgay2, iThang1 = iThang1, iThang2 = iThang2, LoaiBaoCao = sLoaiBaoCao, iID_MaTaiKhoan = iID_MaTaiKhoan, UserName = MaND }), "Export To Excel")%>
<div>
    <iframe src="<%=Url.Action("ViewPDF","rptKTTongHop_ChiTiet_TongHopTaiKhoan",new{iNamLamViec = iNamLamViec, iNgay1 = iNgay1, iNgay2 = iNgay2,iThang1=iThang1,iThang2=iThang2,LoaiBaoCao=sLoaiBaoCao,iID_MaTaiKhoan=iID_MaTaiKhoan,UserName=MaND})%>"
