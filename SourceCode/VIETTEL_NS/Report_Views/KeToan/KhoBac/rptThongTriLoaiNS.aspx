...
<%
    ...
    String UrlReport = Url.Action("ViewPDF", "rptThongTriLoaiNS", new { MaND = UserID, iID_MaChungTu = iID_MaChungTu, sSoChungTuChiTiet = iID_MaChungTuChiTiet, InTenMLNS = InTenMLNS });
    String BackURL = Url.Action("Index", "KeToanChiTietKhoBac", new { iLoai=1});
    using (Html.BeginForm("EditSubmit", "rptThongTriLoaiNS", new { ParentID = ParentID, ChiSo = ChiSo }))
   {
    %>   
   ...
   <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptThongTriLoaiNS", new { ParentID = ParentID, ChiSo = ChiSo, iID_MaChungTuChiTiet = iID_MaChungTuChiTiet, iNamLamViec = iNamLamViec, iThang = iThang }), "Xuất ra file Excel")%>
