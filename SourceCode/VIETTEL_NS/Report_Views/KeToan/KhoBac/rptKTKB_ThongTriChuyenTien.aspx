...
<%
    ...
    String UrlReport = Url.Action("ViewPDF", "rptThongTriChuyenTien", new { MaND = UserID, iID_MaChungTu = iID_MaChungTu, sSoChungTuChiTiet = iID_MaChungTuChiTiet, InTenMLNS = InTenMLNS });
   ...
   <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptThongTriChuyenTien", new { ParentID = ParentID, ChiSo = ChiSo, iID_MaChungTuChiTiet = iID_MaChungTuChiTiet, iNamLamViec = iNamLamViec, iThang = iThang }), "Xuất ra file Excel")%>
