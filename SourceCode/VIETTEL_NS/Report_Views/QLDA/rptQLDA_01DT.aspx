...
<body>
    ...
    using (Html.BeginForm("EditSubmit", "rptQLDA_01DT", new { ParentID = ParentID, NamLamViec = NamLamViec }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Kế Khoạch Vốn Đầu Tư Năm <%=NamHienTai%></span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQLDA_01DT", new { NamLamViec = NamLamViec }), "Export to Excel")%>
    <iframe src="<%=Url.Action("ViewPDF","rptQLDA_01DT",new{NamLamViec=NamLamViec})%>" height="600px" width="100%"></iframe>
</body>
</html>
