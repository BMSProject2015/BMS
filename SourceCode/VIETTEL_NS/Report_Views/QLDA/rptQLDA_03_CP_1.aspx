...
<body>
    <%   
       ...
       // dtDotCapPhat.Dispose();
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptQLDA_03_CP_1", new { iID_MaDotCapPhat = iID_MaDotCapPhat, MaND = MaND, MaTien = MaTien });
        String URL = Url.Action("Index", "QLDA_Report");
        using (Html.BeginForm("EditSubmit", "rptQLDA_03_CP_1", new { ParentID = ParentID }))
        {
    %>
            ...
            <table width="100%" cellpadding="0"  cellspacing="0" border="0" class="table_form2">                
                        ...
                        <td width="30%"></td>
                         <td style="width: 10%;" class="td_form2_td1">
                            <div><%=NgonNgu.LayXau("Chọn ngày báo cáo:")%></div>                        </td>
                        <td width="10%">
                              <div>
                        ...
                        <td width="10%" id="<%= ParentID %>_LoaiTien">                            
                            <% rptQLDA_03_CP_1Controller rpt = new rptQLDA_03_CP_1Controller();%>                
     ...
     <script type="text/javascript">
      ...
      <script type="text/javascript">
          function ChonDot() {
              ...
              var url = unescape('<%= Url.Action("ds_QLDA?ParentID=#0&iID_MaDotCapPhat=#1&MaND=#2&MaTien=#3","rptQLDA_03_CP_1") %>');
