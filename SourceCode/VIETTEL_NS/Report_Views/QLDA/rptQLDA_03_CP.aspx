...
<body>
    <%   
       ...
       // dtDotCapPhat.Dispose();
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptQLDA_03_CP", new { iID_MaDotCapPhat = iID_MaDotCapPhat, MaND = MaND, MaTien = MaTien });
        String URL = Url.Action("Index", "QLDA_Report");
        using (Html.BeginForm("EditSubmit", "rptQLDA_03_CP", new { ParentID = ParentID }))
        {
    %>
