...
<body>
    <% 
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptQLDA_03QTN", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });
        String URL = Url.Action("Index", "QLDA_Report");
        String urlExport = Url.Action("ExportToExcel", "rptQLDA_03QTN", new { NgoaiTe = NgoaiTe, vidDenNgay = dDenNgay });
        using (Html.BeginForm("EditSubmit", "rptQLDA_03QTN", new { ParentID = ParentID, vidDenNgay = dDenNgay }))
        {
    %>
    <div class="box_tong">
