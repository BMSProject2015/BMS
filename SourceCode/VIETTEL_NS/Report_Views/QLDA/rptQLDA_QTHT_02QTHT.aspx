...
<body>
    ...
    using (Html.BeginForm("EditSubmit", "rptQLDA_QTHT_02QTHT", new { ParentID = ParentID, NamLamViec = NamLamViec }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQLDA_QTHT_02QTHT", new { NamLamViec = NamLamViec }), "Export to Excel")%>
    <iframe src="<%=Url.Action("ViewPDF","rptQLDA_QTHT_02QTHT",new{NamLamViec=NamLamViec})%>" height="600px" width="100%"></iframe>
</body>
</html>
