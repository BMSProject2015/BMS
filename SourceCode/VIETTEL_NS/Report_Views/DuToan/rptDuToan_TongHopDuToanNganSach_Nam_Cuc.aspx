...
<body>
    ...
    using (Html.BeginForm("EditSubmit", "rptDuToan_TongHopDuToanNganSach_Nam_Cuc", new { ParentID = ParentID, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }))
    {
    %>   
    <div class="box_tong">
        ...
        <div id="table_form2" class="table_form2">
            <div id="" style="width:250px; margin:0px auto; min-height:10px;">                
                <div style="max-width:160px; text-align:left; float:left" >
                    <p class="p"><%=NgonNgu.LayXau("Chọn trạng thái")%></p>                      
                </div>
                <div  style="width:160px; float:right">
                    <p class="p"><%=MyHtmlHelper.DropDownList(ParentID, slTrangThai, iID_MaTrangThaiDuyet, "iID_MaTrangThaiDuyet", "", "class=\"input1_2\" style=\"width: 100%\" ")%></p>                    
                </div>
            </div>
...
%>
<%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_TongHopDuToanNganSach_Nam_Cuc", new { MaND = MaND, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "Xuất ra excel")%>
   <iframe src="<%=Url.Action("ViewPDF","rptDuToan_TongHopDuToanNganSach_Nam_Cuc",new{MaND=MaND,iID_MaDonVi=iID_MaDonVi,iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
</body>
</html>
