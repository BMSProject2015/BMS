...
<body>
   <%
    ...
    using (Html.BeginForm("EditSubmit", "rptDT_3bC", new { ParentID = ParentID, MaND = MaND, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDT_3bC", new { MaND = MaND, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "Export to Excel")%>
    <iframe src="<%=Url.Action("ViewPDF","rptDT_3bC",new{MaND=MaND, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
</body>
</html>
