...
<%
    ...
    using (Html.BeginForm("EditSubmit", "rptDuToanChiNganSachQuocPhongDamBao", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo dự toán chi ngân sách quốc phòng - phần ngân sách đảm bảo</span>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <table width="100%" cellpadding="0"  cellspacing="0" border="0" class="table_form2"">
                    <tr>
                        <td class="td_form2_td1" style="text-align:right; width:50%;">
                            <div><b><%=NgonNgu.LayXau("Trạng Thái : ")%></b></div>
                        </td>
    ...
    <%}
        dtNam.Dispose();
         %>
    <div>    
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToanChiNganSachQuocPhongDamBao", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "Xuất ra file Excel")%>
    <iframe src="<%=Url.Action("ViewPDF","rptDuToanChiNganSachQuocPhongDamBao",new{iID_MaTrangThaiDuyet=iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
    </div>
</body>
</html>
