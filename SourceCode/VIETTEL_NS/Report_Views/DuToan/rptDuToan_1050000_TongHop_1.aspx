...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_1050000_TongHop_1", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan });
    }  
    ...
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_1050000_TongHop_1", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_1050000_TongHop_1", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan }), "Export to Excel")%>
