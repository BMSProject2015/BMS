...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtPhongBan(MaND, "1010000,1020000,1020100");
         ...
         if (PageLoad == "1")
         {
                 arrView[0] =
                     String.Format(
                         @"/rptDuToan_ChiTapTrung_TongHop/viewpdf?iID_MaPhongBan={0}&MaND={1}",
                         iID_MaPhongBan, MaND);
                 Chuoi += arrView[0];
         }
         String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai = "0" });
         using (Html.BeginForm("EditSubmit", "rptDuToan_ChiTapTrung_TongHop", new {ParentID=ParentID}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán tổng hợp số liệu chi tập trung năm <%=iNamLamViec %>
                           </span>
                    </td>
