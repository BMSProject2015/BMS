...
<body>
   <%
    ...
    using (Html.BeginForm("EditSubmit", "rtCongKhaiPhanBoVonDauTuCongTrinhPhoThong", new { ParentID = ParentID, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rtCongKhaiPhanBoVonDauTuCongTrinhPhoThong", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet }), "Export to Excel")%>
    <iframe src="<%=Url.Action("ViewPDF","rtCongKhaiPhanBoVonDauTuCongTrinhPhoThong",new{iID_MaTrangThaiDuyet=iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
