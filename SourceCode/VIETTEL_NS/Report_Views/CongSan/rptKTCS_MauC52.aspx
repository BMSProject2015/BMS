...
<body>
   <%
      ...
      //ĐƠN VỊ
       ...
       if(PageLoad=="1")
       {
           URL = Url.Action("ViewPDF","rptKTCS_MauC52",new{NamChungTu=NamChungTu, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi,KhoGiay=KhoGiay});
       }
      //tai san
       String BackURL = Url.Action("Index", "CongSan_Report");
       String urlExport = Url.Action("ExportToExcel", "rptKTCS_MauC52", new { NamChungTu = NamChungTu, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, KhoGiay = KhoGiay });
       using (Html.BeginForm("EditSubmit", "rptKTCS_MauC52", new { ParentID = ParentID}))
    {
%>
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                	<span>BÁO CÁO Mẫu đánh giá lại tài sản  </span>
                </td>
