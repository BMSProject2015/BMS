...
<body>
  <%
      ...
      /// <returns></returns>
       ...
       DataTable dtLoaiBaoCao = rptKTCS_TongHopMau10Controller.DTLoaiBaoCao();
       ...
       String urlExport = Url.Action("ExportToExcel", "rptKTCS_TongHopMau10", new { NamChungTu = NamChungTu, LoaiBaoCao = LoaiBaoCao, iID_MaLoaiTaiSan = iID_MaLoaiTaiSan, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, TongHopLTS = TongHopLTS, KhoGiay = KhoGiay });
       using (Html.BeginForm("EditSubmit", "rptKTCS_TongHopMau10", new { ParentID = ParentID, NamChungTu = NamChungTu, LoaiBaoCao = LoaiBaoCao, iID_MaLoaiTaiSan = iID_MaLoaiTaiSan, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, TongHopLTS = TongHopLTS, KhoGiay = KhoGiay }))
    {
%>
<div class="box_tong">
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                	<span>BÁO CÁO TÌNH HÌNH TĂNG GIẢM TSCĐ</span>
                </td>
...
<table width="100%" height="136"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="231" valign="bottom"><b>Chọn đơn vị</b> </td>
    <td width="119">&nbsp;</td>
    <td width="380">&nbsp;</td>
  </tr>
  <tr>
    <td rowspan="3" valign="top"><%=MyHtmlHelper.DropDownList(ParentID, slTaiSan, iID_MaLoaiTaiSan, "iID_MaLoaiTaiSan", "", "class=\"input1_2\"style=\"width: 80%\" size='20' tabindex='-1'")%></td>
    <td rowspan="3" valign="top"><%=MyHtmlHelper.DropDownList(ParentID, slTenDonVi, iID_MaDonVi, "iID_MaDonVi", "", "class=\"input1_2\"style=\"width: 80%\"size='20' tabindex='-1'")%></td>
    <td><b>Chọn mẫu báo cáo: </b></td>
    <td> <%=MyHtmlHelper.DropDownList(ParentID, slLoaiBaoCao, LoaiBaoCao, "LoaiBaoCao", "", "class=\"input1_2\"style=\"width: 60%\"")%></td>
  </tr>
  <tr>
    <td><b>Chọn năm : </b></td>
  ...
  <tr>
    ...
    <td><b>Tất cả đơn vị :</b>&nbsp;&nbsp;<%=MyHtmlHelper.CheckBox(ParentID, TongHopDonVi, "TongHopDonVi", "", "")%></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<%  } %>
<br />
   <iframe src="<%=Url.Action("ViewPDF","rptKTCS_TongHopMau10",new{NamChungTu=NamChungTu,LoaiBaoCao=LoaiBaoCao,iID_MaLoaiTaiSan=iID_MaLoaiTaiSan, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, TongHopLTS = TongHopLTS, KhoGiay = KhoGiay })%>" height="600px" width="100%"></iframe>
</body>
</html>
