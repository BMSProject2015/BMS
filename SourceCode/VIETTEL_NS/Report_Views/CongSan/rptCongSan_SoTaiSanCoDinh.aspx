...
<body>
  <%
      ...
      if (PageLoad == "1")
      {
          URL = Url.Action("ViewPDF", "rptCongSan_SoTaiSanCoDinh", new { NamChungTu = NamChungTu, ThangChungTu=ThangChungTu,iID_MaLoaiTaiSan = iID_MaLoaiTaiSan, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, TongHopLTS = TongHopLTS, KhoGiay = KhoGiay });
      }
      
       String BackURL = Url.Action("Index", "CongSan_Report");
       String urlExport = Url.Action("ExportToExcel", "rptCongSan_SoTaiSanCoDinh", new { NamChungTu = NamChungTu,ThangChungTu=ThangChungTu, iID_MaLoaiTaiSan = iID_MaLoaiTaiSan, iID_MaDonVi = iID_MaDonVi, TongHopDonVi = TongHopDonVi, TongHopLTS = TongHopLTS, KhoGiay = KhoGiay });
       using (Html.BeginForm("EditSubmit", "rptCongSan_SoTaiSanCoDinh", new { ParentID = ParentID }))
    {
  %>
<div class="box_tong" >
    <div class="title_tong">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                	<span>BÁO CÁO SỔ  TÀI SẢN CỐ ĐỊNH</span>
                </td>
