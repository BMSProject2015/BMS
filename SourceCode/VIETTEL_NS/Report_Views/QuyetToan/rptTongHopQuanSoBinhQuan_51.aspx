...
<body>
    ...
    //dt Trạng thái duyệt
    DataTable dtTrangThai = rptTongHopQuanSoBinhQuan_51Controller.tbTrangThai();
    ...
    String urlReport = "";
    if (pageload == "1")
        urlReport = Url.Action("ViewPDF", "rptTongHopQuanSoBinhQuan_51", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iAll = iAll, iMaDV = iID_MaDonVi });
    dtThang.Dispose();
    String URL = Url.Action("Index", "QuyetToan_QuanSo_Report");
    using (Html.BeginForm("EditSubmit", "rptTongHopQuanSoBinhQuan_51", new { ParentID = ParentID }))
    {
    %>   
     <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo tổng hợp quân số bình quân</span>
                    </td>
                </tr>
            </table>
        </div>        
                    ...
                    <div id="Left" style="float:left; width:400px;">
                        <div style="float:left; width:200px; ">                                         
                            ...
                            <div class="div-label" style="width:100px; float:right; text-align:left; ">
                                <p class="p"><%=MyHtmlHelper.DropDownList(ParentID, slThang, iThang, "iThang", "", "class=\"input1_2\" style=\"width:100%; padding:2px;\" onchange=\"ChonDonvi()\"")%></p>                                    
                            </div>                       
                        ...
                        <div style="float:left; width:300px;">
                            ...
                            <div class="div-label" style="width:150px; text-align:center;float:left;">                    
                                <p class="p" id="<%=ParentID %>_divDonvi">                                   
                                    <%rptTongHopQuanSoBinhQuan_51Controller rpt = new rptTongHopQuanSoBinhQuan_51Controller();%>
    ...
    <script type="text/javascript">
        ...
        function ChonDonvi() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDonvi?ParentID=#0&iThang=#1&iID_MaTrangThaiDuyet=#2&iMaDV=#3", "rptTongHopQuanSoBinhQuan_51") %>');
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptTongHopQuanSoBinhQuan_51", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iAll = iAll, iMaDV = iID_MaDonVi }), "ExportToExcel")%>
