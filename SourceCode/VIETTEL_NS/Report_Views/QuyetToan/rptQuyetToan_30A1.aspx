...
<body>
    <% 
        ...
        dtQuy.Dispose();
        DataTable dtDonVi = rptQuyetToan_30A1Controller.DanhSach_DonVi_Quy_TX(iID_MaTrangThaiDuyet, Quy,MaND);
        ...
        {
            urlReport = Url.Action("ViewPDF", "rptQuyetToan_30A1", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, Quy = Quy, iID_MaDonVi = iID_MaDonVi });
        }  
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_30A1", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo chi tiết quyết toán thường xuyên Quý-Tháng</span>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <tr>
                      ...
                      <td class="td_form2_td1" style="width: 10%;">
                         ...
                         <td style="width: 10%;">
                            ...
                            <%rptQuyetToan_30A1Controller rptTB1 = new rptQuyetToan_30A1Controller();%>                                   
...
<td>
     ...
     <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_30A1", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, Quy = Quy, iID_MaDonVi = iID_MaDonVi }), "Xuất ra Excels")%>
      <script type="text/javascript">
          function ChonQuy() {
              var iID_MaTrangThaiDuyet = document.getElementById("<%=ParentID %>_iID_MaTrangThaiDuyet").value;
              var Quy = document.getElementById("<%=ParentID %>_MaQuy").value;
              jQuery.ajaxSetup({ cache: false });
              var url = unescape('<%= Url.Action("Get_dsDonVi?ParentID=#0&iID_MaTrangThaiDuyet=#1&Quy=#2&iID_MaDonVi=#3", "rptQuyetToan_30A1") %>');
