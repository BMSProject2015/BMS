...
<body>
    <%        
        ...
        {
            urlReport = Url.Action("ViewPDF", "rptQuyetToan_nghiepvu_46C", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, iID_MaDonVi = iID_MaDonVi, Thang_Quy = Thang_Quy, TruongTien = TruongTien, RutGon = RutGon, MaND = MaND, ToSo = ToSo, KhoGiay = KhoGiay });
        }
        String BackURL = Url.Action("Index", "QuyetToan_Report", new { Loai = "1" });
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_nghiepvu_46C", new { ParentID = ParentID,ToDaXem=ToDaXem }))
        {
    %>
         <div class="box_tong">
            <div class="title_tong">
                 <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td>
                        <span>Báo cáo tổng hợp quyết toán tháng chọn đơn vị</span>
                    </td>
                ...
                <div id="Div2">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                        ...
                        <td class="style1">
                            ...
                            <td style="width: 20%;" rowspan="23" id="<%= ParentID %>_tdDonVi">
                                 <%rptQuyetToan_NghiepVu_46CController.data data = new rptQuyetToan_NghiepVu_46CController.data();
                                   rptQuyetToan_NghiepVu_46CController rpt = new rptQuyetToan_NghiepVu_46CController();
...
<td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
         ...
         <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_NghiepVu_46C", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS = sLNS, iID_MaDonVi = iID_MaDonVi, Thang_Quy = Thang_Quy, TruongTien = TruongTien, RutGon = RutGon, MaND = MaND, ToSo = ToSo, KhoGiay = KhoGiay }), "Xuất ra Excel")%>
    <%} %>
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function Chon() {
             ...
             var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&iID_MaTrangThaiDuyet=#1&Thang_Quy=#2&RutGon=#3&MaND=#4&KhoGiay=#5&ToSo=#6&sLNS=#7&TruongTien=#8&iID_MaDonVi=#9", "rptQuyetToan_NghiepVu_46C") %>');
