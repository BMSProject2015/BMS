...
<body>
    ...
    // Đơn Vị
    DataTable dtDonVi = rptQuanSo_53Controller.GetDonvi(iThang, iID_MaTrangThaiDuyet,MaND);    
    ...
    String urlReport = "";
    if (pageload == "1")
        urlReport = Url.Action("ViewPDF", "rptQuanSo_53", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iAll = iAll, iMaDV = iID_MaDonVi });
    dtThang.Dispose();
    String URL = Url.Action("Index", "QuyetToan_QuanSo_Report");
    using (Html.BeginForm("EditSubmit", "rptQuanSo_53", new { ParentID = ParentID}))
    {
    %>   
     <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo tình hình thực hiện quân số</span>
                    </td>
                </tr>
            </table>
        </div>        
                        ...
                        <div style="float:left; width:300px;">
                            ...
                            <div class="div-label" style="width:150px; text-align:center;float:left;">                    
                                <p class="p" id="<%=ParentID %>_divDonvi">                                   
                                    <%rptQuanSo_53Controller rpt = new rptQuanSo_53Controller();%>
    ...
    <script type="text/javascript">
        ...
        function ChonDonvi() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDonvi?ParentID=#0&iThang=#1&iID_MaTrangThaiDuyet=#2&iMaDV=#3", "rptQuanSo_53") %>');
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuanSo_53", new { iThang = iThang, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iAll = iAll, iMaDV = iID_MaDonVi }), "ExportToExcel")%>
