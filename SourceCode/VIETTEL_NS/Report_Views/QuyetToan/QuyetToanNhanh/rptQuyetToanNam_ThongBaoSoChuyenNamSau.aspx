...
<%
    ...
    String URLView = "";
    if (PageLoad == "1")
        URLView = Url.Action("ViewPDF", "rptQuyetToanNam_ThongBaoSoChuyenNamSau", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, iID_MaDonVi = iID_MaDonVi, iID_MaNamNganSach = iID_MaNamNganSach,iLoai=iLoai });
    ...
    using (Html.BeginForm("EditSubmit", "rptQuyetToanNam_ThongBaoSoChuyenNamSau", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo thông báo số chuyển năm sau <%=iNamLamViec %></span>
                    </td>
                </tr>
            </table>
        </div>   
                ...
                <table width="100%" cellpadding="0"  cellspacing="0" border="0" class="table_form2">
                 ...
                 <td class="td_form2_td1" style="width: 20%" >
                        ...
                        <td  style="width: 10%" >
                                 ...
                                 <% rptQuyetToanNam_ThongBaoSoChuyenNamSauController rpt = new rptQuyetToanNam_ThongBaoSoChuyenNamSauController();%> 
                                <%=rpt.obj_DonVi(ParentID, iID_MaPhongBan, iID_MaDonVi, MaND)%>
                            </div>
                               </td>
                                  <%--<td class="td_form2_td1"  style="width: 10%" >
                            <div> Năm ngân sách:</div> 
                        </td>
                        <td style="width: 10%" >
                                    <div>
                        ...
                        <td style="width: 10%" >
                               ...
                               <td></td>
                                ...
                                <tr>
                   <td  colspan="9"><table cellpadding="0" cellspacing="0" border="0" align="left" style="margin: 10px;" width="100%">
                            <tr>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToanNam_ThongBaoSoChuyenNamSau", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, iID_MaDonVi = iID_MaDonVi, iID_MaNamNganSach = iID_MaNamNganSach, iLoai = iLoai }), "Xuất ra excel")%>
   <iframe src="<%=URLView%>" height="600px" width="100%"></iframe>
      ...
      <script type="text/javascript">
          function Chon() {
              ...
              var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&iID_MaPhongBan=#1&iID_MaDonVi=#2&MaND=#3","rptQuyetToanNam_ThongBaoSoChuyenNamSau") %>');
