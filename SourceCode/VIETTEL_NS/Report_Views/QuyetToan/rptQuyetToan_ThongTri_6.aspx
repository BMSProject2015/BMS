...
<body>
    ...
    DataTable dtTrangThai = rptQuyetToan_ThongTri_6Controller.tbTrangThai();
    ...
    dtThang.Dispose();
    DataTable dtDonVi = rptQuyetToan_ThongTri_6Controller.DanhSachDonVi( iThang_Quy, iID_MaTrangThaiDuyet,MaND);
    ...
    dtDonVi.Dispose();
    String urlExport = Url.Action("ExportToExcel", "rptQuyetToan_ThongTri_6", new { iThang_Quy = iThang_Quy, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iID_MaDonVi = iID_MaDonVi });
    String URL = Url.Action("Index", "QuyetToan_Report", new { Loai = "0" });
    String urlReport = "";
    String PageLoad = Convert.ToString(ViewData["PageLoad"]);
    if (PageLoad.Equals("1"))
    {
        urlReport = Url.Action("ViewPDF", "rptQuyetToan_ThongTri_6", new { iThang_Quy = iThang_Quy, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iID_MaDonVi = iID_MaDonVi });
    }  
    using (Html.BeginForm("EditSubmit", "rptQuyetToan_ThongTri_6", new { ParentID = ParentID }))
    {
    %>   
     <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo thông tri đơn vị theo mục</span>
                    </td>
                </tr>
            </table>
        </div>
        <div id="Div3" style="background-color:#F0F9FE;">
           <div id="Div4" style="margin-left:50px;">           
<table width="1100" border="0" cellpadding="0" cellspacing="0" style="height: 71px">
  <tr>
  <td width="10%"></td>
    ...
    <td width="143"><div id="<%= ParentID %>_divDonVi">
                                     <%rptQuyetToan_ThongTri_6Controller rptTB1 = new rptQuyetToan_ThongTri_6Controller();%>                                    
  ...
  <td></td>
    ...
    <script type="text/javascript">
        function ChonDV() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDonVi?ParentID=#0&iThang_Quy=#1&iID_MaTrangThaiDuyet=#2&iID_MaDonVi=#3", "rptQuyetToan_ThongTri_6") %>');
