...
<body>
    <%         
        ...
        DataTable dtTrangThai = rptQuyetToan_33BController.tbTrangThai();
        ...
        dtQuy.Dispose();
        DataTable dtDonVi = rptQuyetToan_33BController.LayDSDonVi(iID_MaTrangThaiDuyet, Quy,MaND);
        ...
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptQuyetToan_33B", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, Quy = Quy, iID_MaDonVi = iID_MaDonVi});
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_33B", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo tổng hợp QTTX Năm- Quý</span>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <tr>
                      ...
                      <td class="td_form2_td1" style="width: 10%;">
                         ...
                         <td style="width: 10%;">
                            ...
                            <%rptQuyetToan_33BController rptTB1 = new rptQuyetToan_33BController();%>                                   
...
<td>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_33B", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, Quy = Quy, iID_MaDonVi = iID_MaDonVi }), "Xuất ra Excels")%>
      <script type="text/javascript">
          function ChonQuy() {
              var iID_MaTrangThaiDuyet = document.getElementById("<%=ParentID %>_iID_MaTrangThaiDuyet").value;
              var Quy = document.getElementById("<%=ParentID %>_MaQuy").value;
              jQuery.ajaxSetup({ cache: false });
              var url = unescape('<%= Url.Action("Get_dsDonVi?ParentID=#0&iID_MaTrangThaiDuyet=#1&Quy=#2&iID_MaDonVi=#3", "rptQuyetToan_33B") %>');
