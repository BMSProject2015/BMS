...
<body>
    <% 
        String ParentID = "NhanSu_TrinhDo";
        String PageLoad = Convert.ToString(ViewData["PageLoad"]);
        //load loại đào tạo
        DataTable dtLoaiDaoTao = new DataTable();
        dtLoaiDaoTao.Columns.Add("iDaTotNghiep", typeof(String));
        dtLoaiDaoTao.Columns.Add("sDaTotNghiep", typeof(String));
        DataRow drDoiTuong = dtLoaiDaoTao.NewRow();
        drDoiTuong["iDaTotNghiep"] = "-1";
        drDoiTuong["sDaTotNghiep"] = "Cả 2 loại";
        dtLoaiDaoTao.Rows.Add(drDoiTuong);
        drDoiTuong = dtLoaiDaoTao.NewRow();
        drDoiTuong["iDaTotNghiep"] = "0";
        drDoiTuong["sDaTotNghiep"] = "Đang học";
        dtLoaiDaoTao.Rows.Add(drDoiTuong);
        drDoiTuong = dtLoaiDaoTao.NewRow();
        drDoiTuong["iDaTotNghiep"] = "1";
        drDoiTuong["sDaTotNghiep"] = "Đã tốt nghiệp";
        dtLoaiDaoTao.Rows.Add(drDoiTuong);

        String iDaTotNghiep = Convert.ToString(ViewData["iDaTotNghiep"]);
        if (String.IsNullOrEmpty(iDaTotNghiep))
        {
            iDaTotNghiep = "0";
        }
        SelectOptionList slDaTotNghiep = new SelectOptionList(dtLoaiDaoTao, "iDaTotNghiep", "sDaTotNghiep");
        dtLoaiDaoTao.Dispose();

        DataTable dtDoiTuong = CanBo_DanhMucNhanSuModels.getHocVan(false);
        String DoiTuong = Convert.ToString(ViewData["DoiTuong"]);
        if (String.IsNullOrEmpty(DoiTuong))
        {
            DoiTuong = "0";
        }
        SelectOptionList slDoiTuong = new SelectOptionList(dtDoiTuong, "sID_MaTrinhDo", "sTen");
        dtDoiTuong.Dispose();
        ...
        if (PageLoad == "1")
        {
            //edit
            if (bBaoCaoTH)
                URLView = Url.Action("ViewPDF_TongHop", "rptNhanSu_TrinhDo", new { DoiTuong = DoiTuong, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam, iDaTotNghiep = iDaTotNghiep });
            else
                URLView = Url.Action("ViewPDF", "rptNhanSu_TrinhDo", new { DoiTuong = DoiTuong, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam, iDaTotNghiep = iDaTotNghiep });
        }
        String urlExport = Url.Action("ExportToExcel", "rptNhanSu_TrinhDo", new { DoiTuong = DoiTuong, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam, iDaTotNghiep = iDaTotNghiep });
        using (Html.BeginForm("EditSubmit", "rptNhanSu_TrinhDo", new { ParentID = ParentID, DoiTuong = DoiTuong, LoaiIn = LoaiIn, Cap = Cap, Nam = Nam, iDaTotNghiep = iDaTotNghiep }))
        {
    %>
    ...
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Khai thác dữ liệu theo cấp bậc</span>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                    <tr>
                        ...
                        <td class="td_form2_td1" style="width: 7%;">
                            <div>
                                <%=NgonNgu.LayXau("Loại:")%></div>
                        </td>
                        <td width="10%" style="vertical-align: middle;">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slDaTotNghiep, iDaTotNghiep, "iDaTotNghiep", "", "class=\"input1_2\" style=\"width:100%;\" ")%>
                            </div>
                        </td>
                        <td class="td_form2_td1" style="width: 7%;">
                            <div>
                                <%=NgonNgu.LayXau("Trình độ:")%></div>
                        </td>
