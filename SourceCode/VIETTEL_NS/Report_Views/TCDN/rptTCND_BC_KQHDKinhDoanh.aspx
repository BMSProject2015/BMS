...
<body>
     <%
        ...
        String Nam = Convert.ToString(ViewData["iNamLamViec"]);
        ...
        DataTable dtDoanhNghiep = rptTCND_BC_KQHDKinhDoanhController.GetDoanhNghiep(iQuy, Nam);
        ...
        if (PageLoad == "1")
            urlReport = Url.Action("ViewPDF", "rptTCND_BC_KQHDKinhDoanh", new { Quy=iQuy, Nam = Nam, MaDN = iID_MaDoanhNghiep });
        using (Html.BeginForm("EditSubmit", "rptTCND_BC_KQHDKinhDoanh", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
            ...
            <div id="" style="width:850px; max-width:850px; margin:0px auto; padding:0px 0px; overflow:visible; ">
                <ul class="inlineBlock">
                    ...
                    <li>                       
                        ...
                        <span style="float:right; text-align:center; width:140px;" id="<%=ParentID %>_divDoanhNghiep"><% rptTCND_BC_KQHDKinhDoanhController rpt = new rptTCND_BC_KQHDKinhDoanhController();%><%=rpt.obj_DSDoanhNghiep(ParentID,iQuy,Nam,iID_MaDoanhNghiep) %></span>                         
                    </li>                    
                </ul>
    ...
    <script type="text/javascript">
        ...
        function ChonDoanhNghiep() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDoanhNghiep?ParentID=#0&Quy=#1&Nam=#2&iMaDN=#3", "rptTCND_BC_KQHDKinhDoanh") %>');
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptTCND_BC_KQHDKinhDoanh", new { Quy = iQuy, Nam = Nam, MaDN = iID_MaDoanhNghiep }), "Xuất ra excel")%>
