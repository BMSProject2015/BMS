...
<body>
    <%
        ...
        DataTable dtDoanhNghiep = rptTCDN_BangCanDoiKeToan_B01DNController.GetDoanhNghiep(iQuy, Nam);
        ...
        if (PageLoad == "1")
            urlReport = Url.Action("ViewPDF", "rptTCDN_BangCanDoiKeToan_B01DN", new { iQuy = iQuy, iNam = Nam, iMaDN = iID_MaDoanhNghiep });
        using (Html.BeginForm("EditSubmit", "rptTCDN_BangCanDoiKeToan_B01DN", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo bảng cân đối kế toán</span>
                    </td>
                </tr>
            </table>
        </div>        
            ...
            <div id="" style="width:850px; max-width:850px; margin:0px auto; padding:0px 0px; overflow:visible; ">
                <ul class="inlineBlock">
                    ...
                    <li>                       
                        ...
                        <span style="float:right; text-align:center; width:140px;" id="<%=ParentID %>_divDoanhNghiep"><% rptTCDN_BangCanDoiKeToan_B01DNController rpt = new rptTCDN_BangCanDoiKeToan_B01DNController();%><%=rpt.obj_DSDoanhNghiep(ParentID,iQuy,Nam,iID_MaDoanhNghiep) %></span>                         
                    </li>                    
                </ul>
    ...
    <script type="text/javascript">
        ...
        function ChonDoanhNghiep() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDoanhNghiep?ParentID=#0&Quy=#1&Nam=#2&iMaDN=#3", "rptTCDN_BangCanDoiKeToan_B01DN") %>');
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptTCDN_BangCanDoiKeToan_B01DN", new { Quy = iQuy, Nam = Nam, MaDN = iID_MaDoanhNghiep }), "Xuất ra excel")%>
