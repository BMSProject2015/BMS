...
<body>
    <div>
     <%
        ...
        String URL = "";
        if (pageload == "1") URL = Url.Action("ViewPDF", "rptTinDungQuaHanDenThang", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iNam = iNam, iThang = iThang });
        using (Html.BeginForm("EditSubmit", "rptTinDungQuaHanDenThang", new { ParentID = ParentID }))
        {%>
         <div class="box_tong">
...
<td>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptTinDungQuaHanDenThang", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iNam = iNam, iThang = iThang }), "Xuất ra Excels")%>
