...
<body>
    <div>
     <%
        ...
        String URL = "";
        if (pageload == "1") URL = Url.Action("ViewPDF", "rptTinDungQuaHanTrongThang", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iNam = iNam, iThang = iThang });
        using (Html.BeginForm("EditSubmit", "rptTinDungQuaHanTrongThang", new { ParentID = ParentID }))
        {%>
         <div class="box_tong">
          <div class="title_tong">
                 <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td>
                            <span>Báo cáo tình hình đầu tư tín dụng (biểu quá hạn)</span>
                         </td>
                    </tr>
                </table>
            </div>
...
<td>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptTinDungQuaHanTrongThang", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iNam = iNam, iThang = iThang }), "Xuất ra Excels")%>
