...
<body>
    <%        
        ...
        String _Checked = "";
        DataTable dtDonVi = rptLuong_DanhSachChiTraController.GetDonVi(iNamLuong, iThangLuong, iTrangThai);        
        ...
        if (PageLoad == "1")
            urlReport = Url.Action("ViewPDF", "rptLuong_DanhSachChiTra", new { Nam=iNamLuong, Thang=iThangLuong, TrangThai=iTrangThai,MaDV=MaDV, LoaiBieu=iReport });
        using (Html.BeginForm("EditSubmit", "rptLuong_DanhSachChiTra", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
                    ...
                    <div id="DKMiddle" style="width:280px; height:60px; float:right">
                        ...
                        <div style="clear:both; float:right;">
                            <fieldset style="border:1px dashed #cecece; border-radius:5px; padding:0px 2px 2px 2px; height:45px; float:right; width:270px;">
                                ...
                                <p class="p" style="line-height:18px; height:20px;"><%=MyHtmlHelper.Option(ParentID, "rTheoDV", iReport, "isReport", "", "onchange=\"Chon()\"")%><span style="font-size:10pt; line-height:16px;">&nbsp;&nbsp;Theo đơn vị&nbsp;&nbsp;</span>              
                                <%=MyHtmlHelper.Option(ParentID, "rLietKe", iReport, "isReport", "", "onchange=\"Chon()\"")%><span style="font-size:10pt; line-height:16px;">&nbsp;&nbsp;Liệt kê&nbsp;&nbsp;</span>
                                <%=MyHtmlHelper.Option(ParentID, "rCoHoTen", iReport, "isReport", "", "onchange=\"Chon()\"")%><span style="font-size:10pt; line-height:16px;">&nbsp;&nbsp;Theo họ tên</span></p>
                            </fieldset>
                    ...
                    <div id="donvi" style="float:left; width:340px; height:60px;">
                        ...
                        <div class="div-label"style="width:196px;padding:1px 0px; float:right; text-align:left;border: 1px dashed #cecece;">
                            ...
                            <div style="width: 100%; clear:both; min-height: 20px; max-height:50px; overflow: auto;" id="<%=ParentID %>_divDonVi"> 
                                <%rptLuong_DanhSachChiTraController rptTB1 = new rptLuong_DanhSachChiTraController();%>  
    ...
    <script type="text/javascript">
        ...
        function ChonDV() {
            ...
            var url = unescape('<%= Url.Action("ds_DonVi?NamLuong=#0&ThangLuong=#1&DuyetLuong=#2&arrDV=#3", "rptLuong_DanhSachChiTra") %>');
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptLuong_DanhSachChiTra", new { Nam = iNamLuong, Thang = iThangLuong, TrangThai = iTrangThai, MaDV = MaDV, LoaiBieu = iReport }), "Xuất ra file Excel")%>
