...
<head runat="server">
    <title>DANH SÁCH CÁ NHÂN CÓ THÙ LAO, THƯỞNG</title>
    <style type="text/css">
        .div-floatleft
        {               
            max-height:80px;            
...
<body>
     <%
        ...
        String iThangLuong = Convert.ToString(Request.QueryString["iThangLuong"]);
        ...
        String iNamLuong = Convert.ToString(Request.QueryString["iNamLuong"]); 
        ...
        DataTable dtDonVi = rptLuong_DSCaNhan_CoThuLao_ThuongController.Get_DonVi_(iNamLuong, iThangLuong);        
        ...
        String iTrangThai = Convert.ToString(Request.QueryString["iTrangThai"]);
        ...
        urlReport = Url.Action("ViewPDF", "rptLuong_DSCaNhan_CoThuLao_Thuong", new {iID_MaBangLuong = iMaBL});
        using (Html.BeginForm("EditSubmit", "rptLuong_DSCaNhan_CoThuLao_Thuong", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo danh sách cá nhân có thù lao thưởng</span>
                    </td>
                </tr>
            </table>
        </div>           
        <div id="table_form2" class="table_form2" style="display:none;">
            <div id="" style="width:850px;margin:0px auto; height:35px; padding:5px;">                
                ...
                <div class="div-floatleft div-txt" style="float:right;max-width:160px;">
                    <div id="<%=ParentID %>_divDonVi" class="p">
                        <%rptLuong_DSCaNhan_CoThuLao_ThuongController rptTB1 = new rptLuong_DSCaNhan_CoThuLao_ThuongController();%>                                    
                        <%=rptTB1.obj_DSDonVi(ParentID,iNamLuong,iThangLuong,iID_MaDonVi)%>
                    </div>                                         
                </div>
                <div class="div-floatleft div-label" style="float:right;max-width:100px; text-align:center; padding-right:3px; padding-left:5px; margin-left:10px;">
    ...
    <script type="text/javascript">
        function ChonDonVi() {
            ...
            var url = unescape('<%= Url.Action("Get_dsDonVi?ParentID=#0&NamLuong=#1&ThangLuong=#2&iID_MaDonVi=#3", "rptLuong_DSCaNhan_CoThuLao_Thuong") %>');
    ...
    <%} %>
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptLuong_DSCaNhan_CoThuLao_Thuong", new {iID_MaBangLuong = iMaBL}), "Xuất ra file Excel")%>
