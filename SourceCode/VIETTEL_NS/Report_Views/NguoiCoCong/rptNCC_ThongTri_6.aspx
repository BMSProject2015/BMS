...
<body>
   <%
        ...
        String urlExport = Url.Action("ExportToExcel", "rptNCC_Thongtri_6", new { NamLamViec = NamLamViec, sLNS = sLNS, Thang_Quy = Thang_Quy, iID_MaDonVi = iID_MaDonVi });
        using (Html.BeginForm("EditSubmit", "rptNCC_Thongtri_6", new { ParentID = ParentID, NamLamViec = NamLamViec, sLNS = sLNS,  Thang_Quy = Thang_Quy, iID_MaDonVi = iID_MaDonVi }))
        {
    %>
    <div class="box_tong">
...
<table width="1000" border="0" cellpadding="0" cellspacing="0" style="height: 104px">
  <tr>
    ...
    <td width="293" class="style1"> <%=MyHtmlHelper.Option(ParentID, "0","0", "ThangQuy", "")%>Tháng&nbsp;&nbsp;
                                ...
                                <%=MyHtmlHelper.DropDownList(ParentID, slQuy, "", "iQuy", "", "class=\"input1_2\" style=\"width:80px;height:24px;\"")%><br /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <%} %>
    <iframe src="<%=Url.Action("ViewPDF","rptNCC_Thongtri_6", new{NamLamViec=NamLamViec,LoaiThangQuy=LoaiThangQuy,sLNS=sLNS,Thang_Quy=Thang_Quy,iID_MaDonVi=iID_MaDonVi})%>" height="600px" width="100%">
    </iframe>
</body>
</html>
