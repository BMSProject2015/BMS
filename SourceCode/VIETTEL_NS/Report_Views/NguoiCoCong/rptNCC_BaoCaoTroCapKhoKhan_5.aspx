...
<body>
    <%
        ...
        // dt đơn vị
        DataTable dtDonVi = rptNCC_BaoCaoQTTroCapKhoKhan_5Controller.dtDanhsach_DonVi(LoaiThang_Quy,Thang_Quy,sLNS,iID_MaTrangThaiDuyet,MaND);
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptNCC_BaoCaoQTTroCapKhoKhan_5", new { Thang_Quy = Thang_Quy, LoaiThang_Quy = LoaiThang_Quy, sLNS = sLNS, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, KhoGiay = KhoGiay ,TongHop=TongHop});
        
        String BackURL = Url.Action("Index", "NguoiCoCong_Report", new { iLoai = 2 });
        String urlExport = Url.Action("ExportToExcel", "rptNCC_BaoCaoQTTroCapKhoKhan_5", new { Thang_Quy = Thang_Quy, LoaiThang_Quy = LoaiThang_Quy, sLNS = sLNS, iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, KhoGiay = KhoGiay, TongHop = TongHop });
        using (Html.BeginForm("EditSubmit", "rptNCC_BaoCaoQTTroCapKhoKhan_5", new { ParentID = ParentID}))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo Trợ cấp Khó khăn</span>
                    </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 110px">
  <tr>
    ...
    <td class="style4">&nbsp;<%=MyHtmlHelper.Option(ParentID, "0", LoaiThang_Quy, "LoaiThang_Quy", "", "onchange=Chon()")%>&nbsp;&nbsp;Tháng
                                <%=MyHtmlHelper.DropDownList(ParentID, slThang, Thang_Quy, "iThang", "", "class=\"input1_2\" style=\"width:27%;\" onchange=Chon()")%>
                                &nbsp; <%=MyHtmlHelper.Option(ParentID, "1", LoaiThang_Quy, "LoaiThang_Quy", "", "onchange=Chon()")%>&nbsp;&nbsp;Quý
                                <%=MyHtmlHelper.DropDownList(ParentID, slQuy, Thang_Quy, "iQuy", "", "class=\"input1_2\" style=\"width:27%;\" onchange=Chon()")%><br /></td>
    <td class="style5">&nbsp;</td>
    <td width="20%" rowspan="2"><fieldset style="text-align:left;padding:5px 5px 8px 8px;font-size:11px;width:160px; -moz-border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;border-radius: 3px;border:1px #C0C0C0 solid;">
                           ...
                           <b>Tổng hợp đơn vị  :<%=MyHtmlHelper.CheckBox(ParentID,TongHop,"TongHop","") %></b></td>
  </tr>
  <tr>
    <td class="style1">&nbsp;</td>
    ...
    <td id="<%= ParentID %>_tdDonVi" class="style4"><%rptNCC_BaoCaoQTTroCapKhoKhan_5Controller rptTB1 = new rptNCC_BaoCaoQTTroCapKhoKhan_5Controller();                          
                              
                            %>
                            <%=rptTB1.obj_DonVi(ParentID, Thang_Quy, LoaiThang_Quy, sLNS, iID_MaDonVi,iID_MaTrangThaiDuyet,MaND)%>   </td>
    <td class="style5">&nbsp;</td>
  </tr>
  <tr>
     ...
     <script type="text/javascript">
      ...
      <script type="text/javascript">
          function Chon() {
              ...
              var url = unescape('<%= Url.Action("ds_DonVi?ParentID=#0&Thang_Quy=#1&LoaiThang_Quy=#2&sLNS=#3&iID_MaDonVi=#4&iID_MaTrangThaiDuyet=#5", "rptNCC_BaoCaoQTTroCapKhoKhan_5") %>');
