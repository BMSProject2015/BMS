...
<body>
      <%
       ...
       String ToDaXem = Convert.ToString(ViewData["ToDaXem"]);
        ...
        DataTable dtDotPhanBo = rptTongHopChiTieuDonViController.LayDSDotPhanBo2(MaND, sLNS, iID_MaTrangThaiDuyet, TruongTien);
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptTongHopChiTieuDonVi", new { MaND=MaND,sLNS=sLNS,iID_MaDotPhanBo=iID_MaDotPhanBo,iID_MaTrangThaiDuyet=iID_MaTrangThaiDuyet,TruongTien=TruongTien,KhoGiay=KhoGiay,LuyKe=LuyKe,ToSo=ToSo});
        String BackURL = Url.Action("Index", "PhanBo_Report");
        String urlExport = Url.Action("ExportToExcel", "rptTongHopChiTieuDonVi", new { MaND = MaND, sLNS = sLNS, iID_MaDotPhanBo = iID_MaDotPhanBo, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, TruongTien = TruongTien, KhoGiay = KhoGiay, LuyKe = LuyKe, ToSo = ToSo });
        using (Html.BeginForm("EditSubmit", "rptTongHopChiTieuDonVi", new { ParentID = ParentID,ToDaXem=ToDaXem}))
        {
    %>
    <div class="box_tong">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 194px">
  ...
  <tr>
    ...
    <td><div id="<%=ParentID %>_divDotPhanBo" style="height:23px;">
                                    <% rptTongHopChiTieuDonViController rpt = new rptTongHopChiTieuDonViController();
                                       rptTongHopChiTieuDonViController.LNSdata _Data = new rptTongHopChiTieuDonViController.LNSdata();
    ...
    <td colspan="6" align="center"><table cellpadding="0" cellspacing="0" border="0" align="center" style="margin-left: 100px;margin-top:10px;">
        ...
        <script type="text/javascript">
            function Chon() {
                ...
                var url = unescape('<%= Url.Action("ds_DotPhanBo?ParentID=#0&MaND=#1&sLNS=#2&iID_MaDotPhanBo=#3&iID_MaTrangThaiDuyet=#4&TruongTien=#5&KhoGiay=#6&LuyKe=#7&ToSo=#8", "rptTongHopChiTieuDonVi") %>');
