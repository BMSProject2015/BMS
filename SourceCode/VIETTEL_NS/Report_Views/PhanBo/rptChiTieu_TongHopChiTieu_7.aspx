...
<body>
      <%
        ...
        //ToDaXem += ToSo + ",";
        //if (ToDaXem == ",") ToDaXem = "";
        DataTable dtDotPhanBo = rptCT_TongHopCT7Controller.LayDSDotPhanBo2(MaND, sLNS, iID_MaTrangThaiDuyet, TruongTien);
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptCT_TongHopCT7", new { MaND = MaND, sLNS = sLNS, iID_MaDotPhanBo = iID_MaDotPhanBo, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, TruongTien = TruongTien, KhoGiay = KhoGiay, LuyKe = LuyKe,ToSo=ToSo });
        String BackURL = Url.Action("Index", "PhanBo_Report");
        String urlExport = Url.Action("ExportToExcel", "rptCT_TongHopCT7", new { MaND = MaND, sLNS = sLNS, iID_MaDotPhanBo = iID_MaDotPhanBo, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, TruongTien = TruongTien, KhoGiay = KhoGiay, LuyKe = LuyKe, ToSo = ToSo });
        using (Html.BeginForm("EditSubmit", "rptCT_TongHopCT7", new { ParentID = ParentID, ToDaXem = ToDaXem }))
        {
    %>
    <div class="box_tong">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 105px">
  <tr>
    <td width="345" rowspan="14" align="center" valign="top"><fieldset style="text-align:left;padding:3px 6px;font-size:11px;width:500px; -moz-border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;border-radius: 3px;border:1px #C0C0C0 solid;">
    ...
    <td width="20%"><%=MyHtmlHelper.DropDownList(ParentID, slTrangThai, iID_MaTrangThaiDuyet, "iID_MaTrangThaiDuyet", "", "class=\"input1_2\" style=\"width: 85%;heigh:22px;\"onchange=Chon()")%></td>
    <td width="184" rowspan="13" valign="top" align="center"><fieldset style="text-align:left;padding:5px 5px 8px 8px;font-size:11px;width:130px; -moz-border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;border-radius: 3px;border:1px #C0C0C0 solid;">
                           ...
                           <br />
                           <b>Lũy Kế đến đợt chọn :&nbsp;<%=MyHtmlHelper.CheckBox(ParentID, LuyKe, "LuyKe", "", "onclick=\"Chon()\"")%></b>
                           </td>
    <td width="170" rowspan="13" valign="top" align="center"><fieldset style="text-align:left;padding:5px 5px 8px 8px;font-size:11px;width:130px; -moz-border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;border-radius: 3px;border:1px #C0C0C0 solid;">
                            <legend><b><%=NgonNgu.LayXau("In trên giấy") %></b></legend>
                            &nbsp;&nbsp; <%=MyHtmlHelper.Option(ParentID, "1", KhoGiay, "KhoGiay", "", "onchange=Chon()")%> &nbsp;&nbsp;A3 - Giấy to<br />
                            &nbsp;&nbsp; <%=MyHtmlHelper.Option(ParentID, "2", KhoGiay, "KhoGiay", "", "onchange=Chon()")%> &nbsp;&nbsp;A4 - Giấy nhỏ
                           </fieldset><br />Các tờ đã xem : (<%=ToDaXem %>)</td>
  </tr>
  <tr>
    <td align="right" class="style2"><b>Đợt phân bổ : </b></td>
    <td id="<%=ParentID %>_divDotPhanBo">
                                    <% rptCT_TongHopCT7Controller rpt = new rptCT_TongHopCT7Controller();
                                       rptCT_TongHopCT7Controller.LNSdata _Data = new rptCT_TongHopCT7Controller.LNSdata();
    ...
    <td colspan="4"> <table cellpadding="0" cellspacing="0" border="0" align="left" style="margin-left: 100px;">
       ...
       <script type="text/javascript">
           function Chon() {
               ...
               var url = unescape('<%= Url.Action("ds_DotPhanBo?ParentID=#0&MaND=#1&sLNS=#2&iID_MaDotPhanBo=#3&iID_MaTrangThaiDuyet=#4&TruongTien=#5&KhoGiay=#6&LuyKe=#7&ToSo=#8", "rptCT_TongHopCT7") %>');
