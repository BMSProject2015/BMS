...
<%
    ...
    {
        urlReport = Url.Action("ViewPDF", "rptCP_ChiTieu_QT", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, Thang_Quy = Thang_Quy, LoaiThang_Quy = LoaiThang_Quy });
    }
    using (Html.BeginForm("EditSubmit", "rptCP_ChiTieu_QT", new { ParentID = ParentID }))
      { 
%>
<div class="box_tong">
