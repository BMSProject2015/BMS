...
<body>
    ...
    DataTable dtTrangThai = rptGia_7aController.tbTrangThai();
    ...
    DataTable dtDonVi = GIA_ReportController.getDtDonVi(UserID, "1");
    SelectOptionList slDonVi = new SelectOptionList(dtDonVi, "iID_MaDonVi", "sTen");
    dtDonVi.Dispose();
    String URL = Url.Action("Index", "Gia_Report");
    using (Html.BeginForm("EditSubmit", "rptGia_7a", new { ParentID = ParentID, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet}))
    {
    %>   
    <div class="box_tong">
  ...
  <%-- <tr>
    <td align="right" class="style1"><b>Trạng Thái : </b></td>
    <td width="494"><%=MyHtmlHelper.DropDownList(ParentID, slTrangThai, iID_MaTrangThaiDuyet, "iID_MaTrangThaiDuyet", "", "class=\"input1_2\" style=\"width: 30%;heigh:22px;\"")%> </td>
  </tr>--%>
  <tr>
    ...
    %>
<%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptGia_7a", new { iID_MaDonVi = iID_MaDonVi, NamLamViec = NamLamViec, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet}), "Export to Excel")%>
   <iframe src="<%=Url.Action("ViewPDF","rptGia_7a",new{iID_MaDonVi = iID_MaDonVi, NamLamViec = NamLamViec, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet})%>" height="600px" width="100%"></iframe>
</body>
</html>
