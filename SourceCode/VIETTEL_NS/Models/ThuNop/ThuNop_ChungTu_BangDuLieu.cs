...
{
    /// <summary>
    /// Lớp ThuNop_ChungTu_BangDuLieu cho phần bảng của Thu nộp
    /// </summary>
    public class ThuNop_ChungTu_BangDuLieu : BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public ThuNop_ChungTu_BangDuLieu(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            Boolean ND_DuocSuaChungTu = LuongCongViecModel.NguoiDung_DuocSuaChungTu(ThuNopModels.iID_MaPhanHe, MaND, iID_MaTrangThaiDuyet);
            if (LuongCongViecModel.KiemTra_TrangThaiDaDuyet(ThuNopModels.iID_MaPhanHe, iID_MaTrangThaiDuyet))
            {
                _ChiDoc = true;
            }
            ...
            if (LuongCongViecModel.KiemTra_TrangThaiTrinhDuyet(ThuNopModels.iID_MaPhanHe, iID_MaTrangThaiDuyet) &&
                ND_DuocSuaChungTu)
            {
                _CoCotDuyet = true;
                _DuocSuaDuyet = true;
            ...
            if (LuongCongViecModel.KiemTra_TrangThaiTuChoi(ThuNopModels.iID_MaPhanHe, iID_MaTrangThaiDuyet))
            {
                _CoCotDuyet = true;
            }

            _DuocSuaChiTiet = LuongCongViecModel.NguoiDung_DuocThemChungTu(ThuNopModels.iID_MaPhanHe, MaND);

            _dtChiTiet = ThuNop_ChungTuChiTietModels.Get_dtThuNopChiTiet(_iID_Ma, arrGiaTriTimKiem);
        ...
        protected void CapNhapDanhSachMaCot_Fixed()
        {
            ...
            String[] arrDSTruongTienTieuDe = MucLucNganSachModels.strDSTruongTien_ThuNopTieuDe.Split(',');
            String[] arrDSTruongTienDoRong = MucLucNganSachModels.strDSTruongTien_ThuNopDoRong.Split(',');
        ...
        {
            String[] arrDSTruongTien = (MucLucNganSachModels.strDSTruongTien_ThuNop+",rTongSo").Split(',');
            String[] arrDSTruongTienTieuDe = (MucLucNganSachModels.strDSTruongTien_ThuNopTieuDe+",Tổng số").Split(',');
            String[] arrDSTruongTienDoRong = (MucLucNganSachModels.strDSTruongTien_ThuNopDoRong+",100").Split(',');
        ...
        {
            String strDSTruongTien_ThuNop = MucLucNganSachModels.strDSTruongTien_ThuNop_So;
            String[] arrDSTruongTien = strDSTruongTien_ThuNop.Split(',');
