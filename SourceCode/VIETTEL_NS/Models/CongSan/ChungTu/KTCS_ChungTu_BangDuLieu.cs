...
{
    public class KTCS_ChungTu_BangDuLieu : BangDuLieu
    {
        ...
        public KTCS_ChungTu_BangDuLieu(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._iThang = iThang;
            this._iNam = iNam;
            this._MaND = MaND;
            ...
            _dtChiTiet = KTCS_ChungTuModels.List_DanhSachChungTu(_iThang, _iNam, arrGiaTriTimKiem);
        ...
        {
            String strDSTruong = "sSTT,sSoChungTu,iNgay,sNoiDung,rTongSo,sTenTrangThaiDuyet,dNgayChungTu";
            String strDSTruongTieuDe = "STT,Số chứng từ,Ngày,Nội dung,Tổng số,Trạng thái,Ngày tạo";
            ...
            if (LuongCongViecModel.KiemTra_TroLyPhongBan(_MaND) == false)
            {
                ...
                strDSTruongTieuDe = "Chọn," + strDSTruongTieuDe;
                strDSTruongDoRong = "40," + strDSTruongDoRong;
            }
        ...
        protected void CapNhap_arrEdit()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                if (LuongCongViecModel.NguoiDung_DuocSuaChungTu(CongSanModels.iID_MaPhanHe, this._MaND, iID_MaTrangThaiDuyet))
                {
                    okHangChiDoc = false;
                }
                for (int j = 0; j < _arrDSMaCot.Count; j++)
