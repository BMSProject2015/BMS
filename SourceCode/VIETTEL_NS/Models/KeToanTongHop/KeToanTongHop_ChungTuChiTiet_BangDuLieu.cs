...
namespace VIETTEL.Models
{
    ...
    /// </summary>
    public class KeToanTongHop_ChungTuChiTiet_BangDuLieu : BangDuLieu
    {
        ...
        public KeToanTongHop_ChungTuChiTiet_BangDuLieu(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            String SQL;
            SqlCommand cmd;
            SQL = "SELECT * FROM KT_ChungTu WHERE iID_MaChungTu=@iID_MaChungTu AND iTrangThai=1";
            cmd = new SqlCommand();
            ...
            _dtChiTiet = KeToanTongHop_ChungTuChiTietModels.Get_dtChungTuChiTiet(_iID_Ma, arrGiaTriTimKiem, _MaND);
        ...
        {
            //String[] arrDSTruong = "iNgay,iThang,sSoChungTuChiTiet,sNoiDung,rSoTien,sTenTaiKhoan_Co,sTenTaiKhoanGiaiThich_Co,sTenPhongBan_Co,sTenDonVi_Co,sTenTaiKhoan_No,sTenTaiKhoanGiaiThich_No,sTenPhongBan_No,sTenDonVi_No,sGhiChu,sID_MaNguoiDungTao".Split(',');
            //String[] arrDSTruongTieuDe = "Ngày<span style=\"color: Red;\">*</span>,Tháng<span style=\"color: Red;\">*</span>,Số ChTu<span style=\"color: Red;\">*</span>,Nội dung<span style=\"color: Red;\">*</span>,Số tiền<span style=\"color: Red;\">*</span>,Tài khoản có,Chi tiết TK có,B có,Đơn vị có,Tài khoản nợ,Chi tiết TK nợ,B nợ,Đơn vị nợ,Ghi chú,Người tạo".Split(',');
            //String[] arrDSTruongDoRong = "40,40,60,400,100,200,200,50,200,200,200,50,200,300,100".Split(',');
            String[] arrDSTruong = "iNgay,iThang,sSoChungTuChiTiet,sNoiDung,rSoTien,sTenTaiKhoan_No,sTenTaiKhoanGiaiThich_No,sTenPhongBan_No,sTenDonVi_No,sTenTaiKhoan_Co,sTenTaiKhoanGiaiThich_Co,sTenPhongBan_Co,sTenDonVi_Co,sGhiChu,sID_MaNguoiDungTao".Split(',');
            String[] arrDSTruongTieuDe = "Ngày<span style=\"color: Red;\">*</span>,Tháng<span style=\"color: Red;\">*</span>,Số ChTu<span style=\"color: Red;\">*</span>,Nội dung<span style=\"color: Red;\">*</span>,Số tiền<span style=\"color: Red;\">*</span>,Tài khoản nợ,Chi tiết TK nợ,B nợ,Đơn vị nợ,Tài khoản có,Chi tiết TK có,B có,Đơn vị có,Ghi chú,Người tạo".Split(',');
            //String[] arrDSTruongDoRong = "40,40,60,450,100,200,200,50,200,200,200,50,200,200,100".Split(',');
            String[] arrDSTruongDoRong = "40,40,60,500,120,250,200,50,200,250,200,50,200,200,100".Split(',');
