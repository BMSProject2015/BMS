...
namespace VIETTEL.Models
{
    ...
    /// </summary>
    public class BaoHiemChi_BangDuLieu:BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public BaoHiemChi_BangDuLieu(String iID_MaChungTuChi, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua, String bChi)
        {
            this._iID_Ma = iID_MaChungTuChi;
            this._MaND = MaND;
            this._IPSua = IPSua;

            String SQL;
            SqlCommand cmd;
            SQL = "SELECT * FROM BH_ChungTuChi WHERE iID_MaChungTuChi=@iID_MaChungTuChi AND bChi=@bChi AND iTrangThai=1";
            cmd = new SqlCommand();
            cmd.Parameters.AddWithValue("@iID_MaChungTuChi", _iID_Ma);
            ...
            _dtChiTiet = BaoHiem_ChungTuChiChiTietModels.Get_dtBaoHiemChiChiTiet(_iID_Ma, arrGiaTriTimKiem);
        ...
        /// </summary>
        protected void DienDuLieu(String bChi)
        {
            if (_arrDuLieu == null)
            {
                CapNhapDanhSachMaHang();
                CapNhapDanhSachMaCot_Fixed(bChi);
                CapNhapDanhSachMaCot_Slide(bChi);
                CapNhapDanhSachMaCot_Them(bChi);
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaChungTuChiChiTiet"]);
        ...
        /// </summary>
        protected void CapNhapDanhSachMaCot_Fixed(String bChi)
        {
            //Khởi tạo các mảng
            ...
            if (bChi == "1")
            {
                arrDSTruong = BaoHiemChiModels.strDSTruong.Split(',');
                arrDSTruongTieuDe = BaoHiemChiModels.strDSTruongTieuDe.Split(',');
                arrDSTruongDoRong = BaoHiemChiModels.strDSTruongDoRong.Split(',');
            }
            else
            {
                arrDSTruong = BaoHiemChiModels.strDSTruong_Mua.Split(',');
                arrDSTruongTieuDe = BaoHiemChiModels.strDSTruongTieuDe_Mua.Split(',');
                arrDSTruongDoRong = BaoHiemChiModels.strDSTruongDoRong_Mua.Split(',');
            }
        ...
        /// </summary>
        protected void CapNhapDanhSachMaCot_Slide(String bChi)
        {
            ...
            if (bChi == "1")
            {
                arrDSTruongTien = BaoHiemChiModels.strDSTruongTien.Split(',');
                arrDSTruongTienTieuDe = BaoHiemChiModels.strDSTruongTienTieuDe.Split(',');
                arrDSTruongTienDoRong = BaoHiemChiModels.strDSTruongTienDoRong.Split(',');
            }
            else
            {
                arrDSTruongTien = BaoHiemChiModels.strDSTruongTien_Mua.Split(',');
                arrDSTruongTienTieuDe = BaoHiemChiModels.strDSTruongTienTieuDe_Mua.Split(',');
                arrDSTruongTienDoRong = BaoHiemChiModels.strDSTruongTienDoRong_Mua.Split(',');
            }
        ...
        /// </summary>
        protected void CapNhapDanhSachMaCot_Them(String bChi)
        {
        }
