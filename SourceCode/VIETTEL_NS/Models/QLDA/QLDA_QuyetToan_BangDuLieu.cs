...
{
    public class QLDA_QuyetToan_BangDuLieu : BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public QLDA_QuyetToan_BangDuLieu(String iID_MaQuyetToan_SoPhieu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._iID_Ma = iID_MaQuyetToan_SoPhieu;
            this._MaND = MaND;
            this._IPSua = IPSua;
            ...
            _dtChiTiet = QLDA_QuyetToanModels.Get_Grid_dtHopDong(_iID_Ma, arrGiaTriTimKiem);
            ThemHangTongCong();
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaQuyetToan"]);
        ...
        {
            String[] arrDSTruong = "sTenDuAn,sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa,rSoTienCap,rSoTienQuyetToan,rSoTienDieuChinh".Split(',');
            String[] arrDSTruongTieuDe = "Thông tin dự án,LNS,L,K,M,TM,TTM,NG,TNG,Nội dung,Số tiền cấp,Số tiền quyết toán,Số tiền quyết toán năm trước".Split(',');
            String[] arrDSTruongDoRong = "450,60,30,30,30,30,30,30,30,350,150,150,250".Split(',');
        ...
        protected void CapNhap_arrCotDuocPhepNhap()
        {
            ...
            for (int j = 0; j < _arrDSMaCot.Count; j++)
            {
                ...
                if (_ChiDoc == false)
                {
                    if (_arrDSMaCot[j] == "rSoTienDauTu" || _arrDSMaCot[j] == "rNgoaiTe_DauTu" || _arrDSMaCot[j] == "sTenNgoaiTe_DauTu" || _arrDSMaCot[j] == "rSoTienCap")
                    {
        ...
        protected void CapNhap_arrEdit()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                for (int j = 0; j < _arrDSMaCot.Count; j++)
                {
                    ...
                    //Xac dinh o chi doc
                    if (_arrDSMaCot[j] == "bDongY" || _arrDSMaCot[j] == "sLyDo" || _arrDSMaCot[j] == "rSoTienCap")
                    {
                        //Cot duyet
