...
{
    public class KTCT_KhoBac_ChungTuModels
    {
        /// <summary>
        ...
        {
            SqlCommand cmd =
                new SqlCommand("SELECT COUNT(*) FROM KTKB_ChungTu WHERE iID_MaChungTu=@iID_MaChungTu AND iTrangThai=1");
        ...
        {
            String vR;
            SqlCommand cmd = new SqlCommand("SELECT iID_MaChungTu FROM KTKB_ChungTu WHERE iTrangThai=1 AND sSoChungTu=@sSoChungTu");
        ...
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTKB_ChungTu WHERE iTrangThai=1 AND iID_MaChungTu=@iID_MaChungTu");
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
        ...
        {
            int vR;
            SqlCommand cmd = new SqlCommand("SELECT MAX(Convert(int,sSoChungTu)) FROM KTKB_ChungTu WHERE iTrangThai=1 AND iNamLamViec=@iNamLamViec");
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM KTKB_ChungTu WHERE iTrangThai=1 AND sSoChungTu=@sSoChungTu AND iNamLamViec=@iNamLamViec");
            cmd.Parameters.AddWithValue("@sSoChungTu", sSoChungTu);
            cmd.Parameters.AddWithValue("@iNamLamViec", iNamLamViec);
        ...
        /// <summary>
        /// Lấy số chứng từ lớn nhất trong bảng KTKB_ChungTu
        /// </summary>
        /// <returns></returns>
        public static int GetMaxChungTu(String iNamLamViec)
        {
            int vR;
            SqlCommand cmd = new SqlCommand("SELECT MAX(Convert(int,iSoChungTu)) FROM KTKB_ChungTu WHERE iTrangThai=1 AND iNamLamViec=@iNamLamViec");
            vR = Convert.ToInt32(Connection.GetValue(cmd, 0));
            cmd.Dispose();
            return vR;
        }
        /// <summary>
        /// Thêm một hàng dữ liệu vào bảng KTKB_ChungTu
        /// </summary>
        ...
        /// <returns></returns>
        public static String InsertRecord(String iID_MaChungTu, int iLoai, NameValueCollection data, String MaND, String IPSua)
        {
            ...
            {                
                ...
                KTCT_KhoBac_ChungTuModels.InsertDuyetChungTu(MaChungTuAddNew, MessageModels.sMoiTao, MaND, IPSua);
        ...
        public static int Delete_ChungTu(String iID_MaChungTu, String sIPSua, String sID_MaNguoiDungSua)
        {
            ...
            if ((sID_MaNguoiDungSua == MaND || LuongCongViecModel.KiemTra_TroLyTongHop(sID_MaNguoiDungSua)) && LuongCongViecModel.KiemTra_TrangThaiKhoiTao(KeToanTongHopModels.iID_MaPhanHe, iID_MaTrangThaiDuyet))
            {
                ...
                SqlCommand cmd;
                cmd = new SqlCommand("UPDATE KTKB_ChungTuChiTiet SET iTrangThai=0, sIPSua=@sIPSua, sID_MaNguoiDungSua=@sID_MaNguoiDungSua WHERE iID_MaChungTu=@iID_MaChungTu");
                cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
        ...
        /// <summary>
        /// Cập nhập trường iID_MaTrangThaiDuyet của bảng KTKB_ChungTu, KTKB_ChungTuChiTiet
        /// </summary>
        /// <param name="iID_MaChungTu"></param>
        ...
        public static Boolean Update_iID_MaTrangThaiDuyet(String iID_MaChungTu, int iID_MaTrangThaiDuyet, Boolean TrangThaiTrinhDuyet, String MaND, String IPSua)
        {
            ...
            //Sửa dữ liệu trong bảng KTKB_ChungTuChiTiet            
            String SQL = "UPDATE KTKB_ChungTuChiTiet SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet WHERE iID_MaChungTu=@iID_MaChungTu";
            if (TrangThaiTrinhDuyet)
            {
                SQL = "UPDATE KTKB_ChungTuChiTiet SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet, bDongY=0, sLyDo='' WHERE iID_MaChungTu=@iID_MaChungTu";
            }
            cmd = new SqlCommand();
            cmd.Parameters.AddWithValue("@iID_MaTrangThaiDuyet", iID_MaTrangThaiDuyet);
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
        ...
        public static DataTable Get_DanhSachChungTu(String MaND, String iLoai, String SoChungTu, String TuNgay, String DenNgay, String iID_MaTrangThaiDuyet, int Trang = 1, int SoBanGhi = 0)
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand();
            String DK = LuongCongViecModel.Get_DieuKien_TrangThaiDuyet_DuocXem(KeToanTongHopModels.iID_MaPhanHe, MaND);
            DK += " AND iTrangThai = 1 AND iLoai = @iLoai";
            ...
            String SQL = String.Format("SELECT * FROM KTKB_ChungTu WHERE {0}", DK);
            cmd.CommandText = SQL;
        ...
        public static int Get_DanhSachChungTu_Count(String MaND, String iLoai, String SoChungTu, String TuNgay, String DenNgay, String iID_MaTrangThaiDuyet)
        {
            int vR;
            SqlCommand cmd = new SqlCommand();
            String DK = LuongCongViecModel.Get_DieuKien_TrangThaiDuyet_DuocXem(KeToanTongHopModels.iID_MaPhanHe, MaND);
            ...
            String SQL = String.Format("SELECT Count(*) FROM KTKB_ChungTu WHERE {0}", DK);
            cmd.CommandText = SQL;
            vR = Convert.ToInt32(Connection.GetValue(cmd, 0));
            cmd.Dispose();
            return vR;
        ...
        public static DataTable List_DanhSachChungTu(int iThang, int iNam,int iNamNganSach, int iNguonNganSach, int iLoai, Dictionary<String, String> arrGiaTriTimKiem = null)
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand();
            String DK = "iTrangThai = 1 AND iNamLamViec = @iNam AND iThang = @iThang AND iLoai = @iLoai AND iID_MaNamNganSach = @iNamNganSach AND iID_MaNguonNganSach = @iNguonNganSach";
            cmd.Parameters.AddWithValue("@iNam", iNam);
            cmd.Parameters.AddWithValue("@iThang", iThang);
            cmd.Parameters.AddWithValue("@iNamNganSach", iNamNganSach);
            cmd.Parameters.AddWithValue("@iNguonNganSach", iNguonNganSach);
            ...
            //String SQL = String.Format("SELECT * FROM KTKB_ChungTu WHERE {0} ORDER BY iNgay DESC,sSoChungTu DESC", DK);
            //String SQL = String.Format("SELECT * FROM KTKB_ChungTu WHERE {0} ORDER BY iThang,iNgay,CONVERT(int, RTrim(LTrim(sSoChungTu))) ASC", DK);
            String SQL = String.Format("SELECT iID_MaChungTu,sSoChungTu,iNgay,sNoiDung,rTongSo,iID_MaTrangThaiDuyet,convert(nvarchar(30), dNgayChungTu,103) + ' ' + convert(nvarchar(30), dNgayChungTu,108) as sNgayChungTu FROM KTKB_ChungTu WHERE {0} ORDER BY iThang,iNgay,CONVERT(int, RTrim(LTrim(sSoChungTu))) ASC", DK);
            cmd.CommandText = SQL;
            vR = Connection.GetDataTable(cmd);
            cmd.Dispose();
            return vR;
        ...
        public static Boolean TrinhDuyetChungTu(String iID_MaChungTu, String MaND, String IPSua)
        {
            ...
            iID_MaTrangThaiDuyet_TrinhDuyet = KTCT_KhoBac_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_TrinhDuyet(MaND, iID_MaChungTu);
            ...
            KTCT_KhoBac_ChungTuModels.Update_iID_MaTrangThaiDuyet(iID_MaChungTu, iID_MaTrangThaiDuyet_TrinhDuyet, true, MaND, IPSua);

            ///Thêm dữ liệu vào bảng duyệt chứng từ - Lấy mã duyệt chứng từ
            String MaDuyetChungTu = KTCT_KhoBac_ChungTuModels.InsertDuyetChungTu(iID_MaChungTu, NoiDung, MaND, IPSua);
        ...
        public static Boolean TuChoiChungTu(String iID_MaChungTu, String MaND, String IPSua)
        {
            ...
            KTCT_KhoBac_DuyetChungTuModels.CapNhapLaiTruong_sSua(iID_MaChungTu);

            ///Update trạng thái cho bảng chứng từ
            KTCT_KhoBac_ChungTuModels.Update_iID_MaTrangThaiDuyet(iID_MaChungTu, iID_MaTrangThaiDuyet_TuChoi, false, MaND, IPSua);

            ///Thêm dữ liệu vào bảng duyệt chứng từ - Lấy mã duyệt chứng từ
            String MaDuyetChungTu = KTCT_KhoBac_ChungTuModels.InsertDuyetChungTu(iID_MaChungTu, NoiDung, NoiDung, IPSua);
        ...
        public static DataTable getLichSuChungTu(String iID_MaChungTu)
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand();
            string SQL = string.Format(@"SELECT * FROM KTKB_DuyetChungTu WHERE iID_MaChungTu=@iID_MaChungTu ORDER BY dNgayTao DESC");
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
            cmd.CommandText = SQL;
            vR = Connection.GetDataTable(cmd);
            cmd.Dispose();
