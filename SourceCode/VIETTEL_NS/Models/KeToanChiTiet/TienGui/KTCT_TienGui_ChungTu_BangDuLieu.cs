...
{
    public class KTCT_TienGui_ChungTu_BangDuLieu : BangDuLieu
    {
        ...
        public KTCT_TienGui_ChungTu_BangDuLieu(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._iThang = iThang;
            this._iNam = iNam;
            this._MaND = MaND;
            ...
            _dtChiTiet = KTCT_TienGui_ChungTuModels.List_DanhSachChungTu(_iThang, _iNam, arrGiaTriTimKiem);
        ...
        protected void CapNhapDanhSachMaCot_Slide()
        {
            ...
            String strDSTruongTieuDe = "STT,Số chứng từ <span style=\"color: Red;\">*</span>,Ngày <span style=\"color: Red;\">*</span>,Nội dung,Tổng số,Trạng thái,Ngày tạo";
