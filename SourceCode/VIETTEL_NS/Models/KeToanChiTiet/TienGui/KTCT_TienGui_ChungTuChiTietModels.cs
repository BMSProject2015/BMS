...
{
    public class KTCT_TienGui_ChungTuChiTietModels
    {
        /// <summary>
        /// Thêm dữ liệu vào bảng KTTG_ChungTuChiTiet
        /// </summary>
        ...
        public static void ThemChiTiet(String iID_MaChungTu, String MaND, String IPSua)
        {
            ...
            Bang bang = new Bang("KTTG_ChungTuChiTiet");
        ...
        /// <summary>
        /// Thêm  dữ liệu vào bảng KTTG_DuyetChungTu
        /// </summary>
        /// <param name="iID_MaChungTu"></param>
        ...
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTTG_ChungTuChiTiet WHERE iTrangThai=1 AND iID_MaChungTuChiTiet=@iID_MaChungTuChiTiet");
        ...
        public static DataTable Get_dtChungTuChiTietTuChoi(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND)
        {
            ...
            SQL = String.Format("SELECT * FROM KTTG_ChungTuChiTiet WHERE {0} ORDER BY sSoChungTuGhiSo, iSTT, dNgayTao", DK);
            cmd.CommandText = SQL;
        ...
        public static int Get_iID_MaTrangThaiDuyet_TuChoi(String MaND, String iID_MaChungTu)
        {
            ...
            if (LuongCongViecModel.NguoiDung_DuocSuaChungTu(KeToanTongHopModels.iID_MaPhanHe, MaND, iID_MaTrangThaiDuyet))
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("SELECT Count(*) FROM KTTG_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu AND bDongY=0");
        ...
        /// <summary>
        /// Lấy thông tin chi tiết của bảng KTTG_ChungTuChiTiet theo Mã chứng từ
        /// </summary>
        /// <param name="iID_MaChungTu"></param>
        /// <returns></returns>
        public static DataTable Get_dtChungTuChiTiet(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND)
        {
            ...
            SQL = String.Format("SELECT * FROM KTTG_ChungTuChiTiet WHERE {0} ORDER BY iSTT, dNgayTao", DK);
            cmd.CommandText = SQL;
        ...
        /// <summary>
        /// Lấy thông tin chi tiết của bảng KTTG_ChungTuChiTiet theo Mã chứng từ chi tiết
        /// </summary>
        /// <param name="iID_MaChungTuChiTiet"></param>
        /// <returns></returns>
        ...
        {
            DataTable vR = null;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTTG_ChungTuChiTiet WHERE iID_MaChungTuChiTiet=@iID_MaChungTuChiTiet");
            cmd.Parameters.AddWithValue("@iID_MaChungTuChiTiet", iID_MaChungTuChiTiet);
            vR = Connection.GetDataTable(cmd);
            cmd.Dispose();
            return vR;
        ...
        /// <summary>
        /// Lấy danh sách chứng từ chi tiết trong bảng: KTTG_ChungTuChiTiet với các tham số
        /// </summary>
        /// <param name="MaND"></param>
            ...
            String sDonViNo, String sDonViCo, int Trang = 1, int SoBanGhi = 0)
        {
            ...
            String SQL = String.Format("SELECT * FROM KTTG_ChungTuChiTiet WHERE {0}", DK);
            cmd.CommandText = SQL;
        ...
        /// <summary>
        /// Lấy tổng số bản ghi trong bảng KTTG_ChungTuChiTiet với các tham số tìm
        /// </summary>
        /// <param name="MaND"></param>
        /// <param name="SoChungTu"></param>
        /// <param name="iNgayCT"></param>
            ...
            String sDonViNo, String sDonViCo)
        {
            ...
            String SQL = String.Format("SELECT Count(*) FROM KTTG_ChungTuChiTiet WHERE {0}", DK);
            cmd.CommandText = SQL;
        ...
        {
            DataTable vR = null;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTTG_ChungTuChiTiet WHERE iThang=@iThang ORDER BY iSTT, dNgayTao");
            cmd.Parameters.AddWithValue("@iThang", iThang);
            vR = Connection.GetDataTable(cmd);
            cmd.Dispose();
            return vR;
