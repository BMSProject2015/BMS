...
{
    public class KTTG_TinhChatCapThu_ChungTu_BangDuLieu : BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public KTTG_TinhChatCapThu_ChungTu_BangDuLieu(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            _dtChiTiet = KTTG_TinhChatCapThu_ChungTuModels.Get_Grid_dtChungTu(_iID_Ma, arrGiaTriTimKiem);
            ThemHangTongCong();
        ...
        {
            String[] arrDSTruong = "bLoai,sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa,iNgay,iThang,sTenPhongBan,sTenDonVi,sTinhChatCapThu,rSoTien,sNoiDung".Split(',');
            String[] arrDSTruongTieuDe = "Thu,LNS,L,K,M,TM,TTM,NG,TNG,Nội dung,Ngày,Tháng,Phòng ban,Đơn vị,Tính chất,Số tiền,Nội dung".Split(',');
            String[] arrDSTruongDoRong = "50,60,30,30,30,30,30,30,30,350,50,50,150,150,200,150,350".Split(',');
