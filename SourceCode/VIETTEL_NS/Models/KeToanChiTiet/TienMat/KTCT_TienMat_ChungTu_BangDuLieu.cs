...
{
    public class KTCT_TienMat_ChungTu_BangDuLieu : BangDuLieu
    {
        ...
        public KTCT_TienMat_ChungTu_BangDuLieu(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._iThang = iThang;
            this._iNam = iNam;
            this._MaND = MaND;
            ...
            _dtChiTiet = KTCT_TienMat_ChungTuModels.List_DanhSachChungTu(_iThang, _iNam, arrGiaTriTimKiem);
