...
{
    public class KTCT_TienMat_ChungTuChiTietModels
    {
        /// <summary>
        /// Thêm dữ liệu vào bảng KTTM_ChungTuChiTiet
        /// </summary>
        ...
        public static void ThemChiTiet(String iID_MaChungTu, String MaND, String IPSua)
        {
            ...
            Bang bang = new Bang("KTTM_ChungTuChiTiet");
        ...
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTTM_ChungTuChiTiet WHERE iTrangThai=1 AND iID_MaChungTuChiTiet=@iID_MaChungTuChiTiet");
        ...
        public static DataTable Get_dtChungTuChiTietTuChoi(int iThang, int iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND)
        {
            ...
            SQL = String.Format("SELECT * FROM KTTM_ChungTuChiTiet WHERE {0} ORDER BY sSoChungTuGhiSo, iSTT, dNgayTao", DK);
            cmd.CommandText = SQL;
        ...
        public static int Get_iID_MaTrangThaiDuyet_TuChoi(String MaND, String iID_MaChungTu)
        {
            ...
            if (LuongCongViecModel.NguoiDung_DuocSuaChungTu(KeToanTongHopModels.iID_MaPhanHe, MaND, iID_MaTrangThaiDuyet))
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("SELECT Count(*) FROM KTTM_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu AND bDongY=0");
        ...
        /// <summary>
        /// Lấy danh sách dữ liệu từ bảng KTTM_ChungTuChiTiet theo mã chứng từ
        /// </summary>
        /// <param name="iID_MaChungTu"></param>
        /// <returns></returns>
        public static DataTable Get_dtChungTuChiTiet(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND)
        {
            ...
            SQL = String.Format("SELECT * FROM KTTM_ChungTuChiTiet WHERE {0} ORDER BY iSTT, dNgayTao", DK);
            cmd.CommandText = SQL;
        ...
        {
            DataTable vR = null;
            SqlCommand cmd = new SqlCommand("SELECT * FROM KTTM_ChungTuChiTiet WHERE iID_MaChungTuChiTiet=@iID_MaChungTuChiTiet");
            cmd.Parameters.AddWithValue("@iID_MaChungTuChiTiet", iID_MaChungTuChiTiet);
            vR = Connection.GetDataTable(cmd);
            cmd.Dispose();
            return vR;
            ...
            String sDonViNo, String sDonViCo, int Trang = 1, int SoBanGhi = 0)
        {
            ...
            String SQL = String.Format("SELECT * FROM KTTM_ChungTuChiTiet WHERE {0}", DK);
            cmd.CommandText = SQL;
            ...
            String sDonViNo, String sDonViCo)
        {
            ...
            String SQL = String.Format("SELECT Count(*) FROM KTTM_ChungTuChiTiet WHERE {0}", DK);
            cmd.CommandText = SQL;
