...
{
    public class TCDN_DuyetChungTuModels
    {
        /// <summary>
        ...
        public static void CapNhapLaiTruong_sSua(String iID_MaChungTu)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT iID_MaDuyetChungTuCuoiCung FROM TCDN_ChungTu WHERE iID_MaChungTu=@iID_MaChungTu");
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
            iID_MaDuyetChungTu = Connection.GetValueString(cmd, "");
            cmd.Dispose();

            cmd = new SqlCommand("SELECT * FROM TCDN_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu AND bDongY=1");
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
            ...
            cmd = new SqlCommand("UPDATE TCDN_DuyetChungTu SET sSua=@sSua WHERE iID_MaDuyetChungTu=@iID_MaDuyetChungTu");
        ...
        public static DataTable GetDuyetChungTu(String iID_MaChungTu)
        {
            DataTable vR = null;
            SqlCommand cmd;
            cmd = new SqlCommand("SELECT * FROM TCDN_DuyetChungTu WHERE iID_MaChungTu=@iID_MaChungTu ORDER BY dNgayDuyet");
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
