...
{
    public class TCDN_ChiTieuTaiChinh_BangDuLieu:BangDuLieu
    {
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public TCDN_ChiTieuTaiChinh_BangDuLieu(String iID_MaDoanhNghiep, String iQuy, String iNam, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            ...
            _dtChiTiet = TCDN_ChiTieuTaiChinhModels.Get_dtChungTuChiTiet(_iID_Ma,iQuy,iNam, arrGiaTriTimKiem);
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaChiTieuTaiChinh"]);
        ...
        protected void CapNhapDanhSachMaCot_Fixed()
        {
            ...
            String strDSTruongTien = "rSoCuoiKy,rSoDauNam";
            String strDSTruongTienDoRong = "150,150";
            String strDSTruongTieuDe = "Chỉ tiêu,Mã số";
            String strDSTruong = "sTen,sMaSoBangCanDoi";
            String strDSTruongDoRong = "350,200"; 
