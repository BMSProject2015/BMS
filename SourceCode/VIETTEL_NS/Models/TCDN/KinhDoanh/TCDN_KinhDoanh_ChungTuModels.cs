...
{
    public class TCDN_KinhDoanh_ChungTuModels
    {
        /// <summary>
        ...
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand("SELECT * FROM TCDN_KinhDoanh_ChungTu WHERE iTrangThai=1 AND iID_MaChungTu=@iID_MaChungTu");
        ...
        /// <summary>
        /// Lấy số chứng từ lớn nhất trong bảng TCDN_KinhDoanh_ChungTu
        /// </summary>
        /// <returns></returns>
        public static int GetMaxChungTu()
        {
            int vR;
            SqlCommand cmd = new SqlCommand("SELECT MAX(iSoChungTu) FROM TCDN_KinhDoanh_ChungTu WHERE iTrangThai=1");
            vR = Convert.ToInt32(Connection.GetValue(cmd, 0));
            cmd.Dispose();
            return vR;
        }
        /// <summary>
        /// Thêm một hàng dữ liệu vào bảng TCDN_KinhDoanh_ChungTu
        /// </summary>
        ...
        {
            //Xóa dữ liệu trong bảng TCDN_KinhDoanh_ChungTuChiTiet
            SqlCommand cmd;
            cmd = new SqlCommand("DELETE FROM TCDN_KinhDoanh_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu");
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
            Connection.UpdateDatabase(cmd);
            cmd.Dispose();

            //Xóa dữ liệu trong bảng TCDN_KinhDoanh_ChungTu
            Bang bang = new Bang("TCDN_KinhDoanh_ChungTu");
        ...
        /// <summary>
        /// Cập nhập trường iID_MaTrangThaiDuyet của bảng TCDN_KinhDoanh_ChungTu, TCDN_KinhDoanh_ChungTuChiTiet
        /// </summary>
        /// <param name="iID_MaChungTu"></param>
        ...
        public static Boolean Update_iID_MaTrangThaiDuyet(String iID_MaChungTu, int iID_MaTrangThaiDuyet, Boolean TrangThaiTrinhDuyet, String MaND, String IPSua)
        {
            ...
            //Sửa dữ liệu trong bảng TCDN_KinhDoanh_ChungTuChiTiet            
            String SQL = "UPDATE TCDN_KinhDoanh_ChungTuChiTiet SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet WHERE iID_MaChungTu=@iID_MaChungTu";
            if (TrangThaiTrinhDuyet)
            {
                SQL = "UPDATE TCDN_KinhDoanh_ChungTuChiTiet SET iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet, bDongY=0, sLyDo='' WHERE iID_MaChungTu=@iID_MaChungTu";
            }
            cmd = new SqlCommand();
            cmd.Parameters.AddWithValue("@iID_MaTrangThaiDuyet", iID_MaTrangThaiDuyet);
            cmd.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
        ...
        public static DataTable Get_DanhSachChungTu(String MaND, String SoChungTu, String iQuy, String iID_MaDoanhNghiep, String TuNgay, String DenNgay, String iID_MaTrangThaiDuyet, int Trang = 1, int SoBanGhi = 0)
        {
            ...
            String SQL = String.Format("SELECT * FROM TCDN_KinhDoanh_ChungTu WHERE {0}", DK);
            cmd.CommandText = SQL;
        ...
        public static int Get_DanhSachChungTu_Count(String MaND, String SoChungTu, String iQuy, String iID_MaDoanhNghiep, String TuNgay, String DenNgay, String iID_MaTrangThaiDuyet)
        {
            ...
            String SQL = String.Format("SELECT Count(*) FROM TCDN_KinhDoanh_ChungTu WHERE {0}", DK);
            cmd.CommandText = SQL;
            vR = Convert.ToInt32(Connection.GetValue(cmd, 0));
            cmd.Dispose();
            return vR;
